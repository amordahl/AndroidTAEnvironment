...
public class ArrayAccess5 extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        // source
        arrayData[0] = ((TelephonyManager) getSystemService(Context.TELEPHONY_SERVICE)).getDeviceId();
        SmsManager sms = SmsManager.getDefault();
        // sink, leak
        sms.sendTextMessage("+49 1234", null, "Size is: " + arrayData.length, null, null);
    }
}
