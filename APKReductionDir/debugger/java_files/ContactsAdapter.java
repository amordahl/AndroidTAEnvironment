...
public class ContactsAdapter extends GroupingCursorAdapter {
    ...
    public static final String[] PROJECTION = new String[] { Phone._ID, Phone.LOOKUP_KEY, Phone.DISPLAY_NAME, Phone.CONTACT_STATUS, Phone.TIMES_CONTACTED, Phone.LAST_TIME_CONTACTED, Phone.STARRED };
    ...
    public View newView(Context context, Cursor cursor, ViewGroup parent) {
        if (shouldBeGrouped(cursor)) {
            // we just hide the grouped views
