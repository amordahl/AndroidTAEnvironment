...
printf 'DSARGS ?= --apicalldepth 1 --filetransforms --ignorenocontextflows --imprecisestrings --kobjsens 4 --multipassfb --noclinitcontext --noclonestatics --nofallback --nojsa --noscalaropts --preciseinfoflow --pta geo --trackallflows --transfertaintfield\n' >> Makefile
