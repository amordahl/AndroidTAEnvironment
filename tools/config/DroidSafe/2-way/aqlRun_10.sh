...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 1 --filetransforms --ignoreexceptionflows --implicitflow --imprecisestrings --kobjsens 20 --limitcontextforcomplex --multipassfb --noarrayindex --nojsa --noscalaropts --precision 5 --pta spark --trackallflows'
