...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 7 --ignoreexceptionflows --kobjsens 40 --limitcontextforcomplex --limitcontextforgui --limitcontextforstrings --noclonestatics --nojsa --noscalaropts --precision 5 --pta paddle --transfertaintfield'
