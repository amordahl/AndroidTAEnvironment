...
printf 'DSARGS ?= --apicalldepth 7 --ignoreexceptionflows --ignorenocontextflows --implicitflow --kobjsens 50 --limitcontextforcomplex --limitcontextforgui --limitcontextforstrings --multipassfb --noarrayindex --noclonestatics --precision 0 --pta paddle --trackallflows --transfertaintfield'
