...
printf 'DSARGS ?= --apicalldepth 7 --filetransforms --ignoreexceptionflows --kobjsens 100 --limitcontextforgui --limitcontextforstrings --multipassfb --noarrayindex --noclinitcontext --precision 5 --pta geo --typesforcontext'
