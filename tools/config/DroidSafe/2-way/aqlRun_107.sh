...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 8 --filetransforms --ignoreexceptionflows --implicitflow --kobjsens 3 --limitcontextforcomplex --limitcontextforgui --noclinitcontext --noclonestatics --nofallback --nojsa --nova --precision 5 --pta paddle --typesforcontext'
