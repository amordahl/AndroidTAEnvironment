...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 8 --imprecisestrings --kobjsens 4 --limitcontextforstrings --noarrayindex --noclinitcontext --precision 0 --preciseinfoflow --pta geo --trackallflows --transfertaintfield'
