...
printf 'DSARGS ?= --apicalldepth 8 --filetransforms --ignoreexceptionflows --ignorenocontextflows --implicitflow --kobjsens 5 --noclinitcontext --nova --precision 1 --preciseinfoflow --pta spark --trackallflows --typesforcontext'
