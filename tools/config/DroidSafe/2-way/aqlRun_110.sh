...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 8 --kobjsens 6 --limitcontextforstrings --multipassfb --noarrayindex --noclinitcontext --noclonestatics --noscalaropts --nova --precision 2 --pta paddle --transfertaintfield'
