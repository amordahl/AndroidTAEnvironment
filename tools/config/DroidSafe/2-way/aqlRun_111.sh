...
printf 'DSARGS ?= --apicalldepth 8 --ignoreexceptionflows --implicitflow --imprecisestrings --kobjsens 7 --noclinitcontext --noclonestatics --nofallback --nojsa --nova --precision 4 --pta spark --typesforcontext'
