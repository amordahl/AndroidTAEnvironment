...
printf 'DSARGS ?= --apicalldepth 8 --ignoreexceptionflows --implicitflow --imprecisestrings --kobjsens 8 --limitcontextforcomplex --limitcontextforstrings --multipassfb --nofallback --nova --precision 2 --pta geo --trackallflows'
