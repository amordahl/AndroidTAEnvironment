...
printf 'DSARGS ?= --apicalldepth 8 --ignorenocontextflows --implicitflow --imprecisestrings --kobjsens 10 --limitcontextforcomplex --limitcontextforstrings --noarrayindex --noclinitcontext --nojsa --noscalaropts --precision 5 --preciseinfoflow --pta paddle --typesforcontext'
