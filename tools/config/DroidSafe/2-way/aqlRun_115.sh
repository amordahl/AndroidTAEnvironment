...
printf 'DSARGS ?= --apicalldepth 8 --filetransforms --ignoreexceptionflows --ignorenocontextflows --implicitflow --imprecisestrings --kobjsens 20 --limitcontextforgui --limitcontextforstrings --noclinitcontext --noscalaropts --nova --precision 0 --preciseinfoflow --pta spark'
