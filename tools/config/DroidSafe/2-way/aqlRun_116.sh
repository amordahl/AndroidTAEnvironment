...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 8 --filetransforms --ignoreexceptionflows --kobjsens 30 --limitcontextforgui --multipassfb --noclinitcontext --nova --precision 3 --pta geo --transfertaintfield --typesforcontext'
