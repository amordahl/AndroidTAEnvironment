...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 8 --ignoreexceptionflows --implicitflow --kobjsens 40 --multipassfb --noclinitcontext --noclonestatics --noscalaropts --nova --precision 4 --preciseinfoflow --pta geo --typesforcontext'
