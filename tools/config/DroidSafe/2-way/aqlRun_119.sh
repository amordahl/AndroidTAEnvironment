...
printf 'DSARGS ?= --apicalldepth 8 --kobjsens 100 --limitcontextforcomplex --limitcontextforgui --noarrayindex --noclonestatics --nova --precision 0 --preciseinfoflow --pta spark --trackallflows --transfertaintfield'
