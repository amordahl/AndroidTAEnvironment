...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 9 --filetransforms --kobjsens 3 --limitcontextforcomplex --noarrayindex --noclinitcontext --noclonestatics --nofallback --noscalaropts --precision 5 --preciseinfoflow --pta paddle --transfertaintfield --typesforcontext'
