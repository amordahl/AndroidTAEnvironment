...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 9 --filetransforms --ignorenocontextflows --implicitflow --imprecisestrings --kobjsens 4 --limitcontextforstrings --multipassfb --nofallback --noscalaropts --nova --precision 0 --preciseinfoflow --pta paddle --transfertaintfield'
