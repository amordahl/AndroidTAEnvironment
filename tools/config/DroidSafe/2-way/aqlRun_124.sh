...
printf 'DSARGS ?= --apicalldepth 9 --kobjsens 5 --limitcontextforcomplex --limitcontextforgui --multipassfb --noclonestatics --nojsa --noscalaropts --nova --precision 1 --pta geo --typesforcontext'
