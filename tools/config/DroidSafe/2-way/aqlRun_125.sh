...
printf 'DSARGS ?= --apicalldepth 9 --ignorenocontextflows --implicitflow --kobjsens 6 --limitcontextforcomplex --limitcontextforgui --limitcontextforstrings --noarrayindex --noclinitcontext --noclonestatics --nojsa --nova --precision 2 --preciseinfoflow --pta geo --transfertaintfield'
