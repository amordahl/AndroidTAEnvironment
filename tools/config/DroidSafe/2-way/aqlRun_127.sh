...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 9 --imprecisestrings --kobjsens 8 --multipassfb --noclinitcontext --nova --precision 1 --preciseinfoflow --pta paddle --trackallflows --transfertaintfield'
