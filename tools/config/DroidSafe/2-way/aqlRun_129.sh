...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 9 --ignorenocontextflows --imprecisestrings --kobjsens 10 --limitcontextforcomplex --limitcontextforgui --limitcontextforstrings --noclinitcontext --nofallback --nojsa --nova --precision 0 --preciseinfoflow --pta geo --trackallflows --transfertaintfield'
