...
printf 'DSARGS ?= --apicalldepth 1 --kobjsens 50 --limitcontextforcomplex --limitcontextforgui --multipassfb --noscalaropts --precision 2 --preciseinfoflow --pta paddle --transfertaintfield'
