...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 1 --imprecisestrings --kobjsens 18 --limitcontextforcomplex --limitcontextforgui --limitcontextforstrings --noarrayindex --nofallback --nojsa --noscalaropts --nova --pta geo\n' >> Makefile
