...
printf 'DSARGS ?= --apicalldepth 9 --kobjsens 20 --limitcontextforcomplex --limitcontextforgui --noarrayindex --noclonestatics --nofallback --nojsa --precision 0 --preciseinfoflow --pta geo --trackallflows --transfertaintfield'
