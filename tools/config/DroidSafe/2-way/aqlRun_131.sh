...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 9 --filetransforms --ignoreexceptionflows --ignorenocontextflows --implicitflow --kobjsens 30 --limitcontextforgui --limitcontextforstrings --nofallback --nova --precision 1 --pta spark --transfertaintfield'
