...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 9 --implicitflow --kobjsens 40 --multipassfb --noclinitcontext --noclonestatics --nofallback --nojsa --nova --precision 2 --pta paddle --transfertaintfield'
