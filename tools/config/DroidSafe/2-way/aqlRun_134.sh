...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 9 --kobjsens 100 --noarrayindex --noclonestatics --nofallback --noscalaropts --nova --precision 5 --preciseinfoflow --pta paddle --trackallflows --transfertaintfield'
