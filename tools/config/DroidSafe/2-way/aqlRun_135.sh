...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 10 --ignoreexceptionflows --implicitflow --kobjsens 1 --limitcontextforstrings --noarrayindex --noclinitcontext --noclonestatics --nofallback --nojsa --nova --precision 3 --pta geo --typesforcontext'
