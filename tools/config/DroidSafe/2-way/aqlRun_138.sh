...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 10 --filetransforms --ignoreexceptionflows --kobjsens 4 --limitcontextforcomplex --noarrayindex --precision 0 --preciseinfoflow --pta spark --trackallflows --transfertaintfield'
