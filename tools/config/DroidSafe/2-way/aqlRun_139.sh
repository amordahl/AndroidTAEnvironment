...
printf 'DSARGS ?= --apicalldepth 10 --filetransforms --implicitflow --kobjsens 5 --limitcontextforcomplex --limitcontextforgui --limitcontextforstrings --multipassfb --noclinitcontext --noclonestatics --nofallback --nojsa --nova --precision 1 --pta spark --trackallflows --transfertaintfield'
