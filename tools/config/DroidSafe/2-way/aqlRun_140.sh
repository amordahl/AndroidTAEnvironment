...
printf 'DSARGS ?= --apicalldepth 10 --ignoreexceptionflows --implicitflow --kobjsens 6 --limitcontextforcomplex --limitcontextforstrings --noarrayindex --nofallback --precision 2 --preciseinfoflow --pta paddle --typesforcontext'
