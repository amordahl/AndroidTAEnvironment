...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 10 --filetransforms --kobjsens 7 --limitcontextforstrings --noclinitcontext --noclonestatics --nofallback --precision 1 --pta spark --trackallflows --transfertaintfield'
