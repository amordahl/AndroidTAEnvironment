...
printf 'DSARGS ?= --apicalldepth 10 --filetransforms --implicitflow --kobjsens 8 --limitcontextforgui --limitcontextforstrings --noarrayindex --noclinitcontext --noclonestatics --nojsa --nova --precision 1 --preciseinfoflow --pta geo --transfertaintfield --typesforcontext'
