...
printf 'DSARGS ?= --apicalldepth 10 --ignoreexceptionflows --implicitflow --imprecisestrings --kobjsens 20 --limitcontextforgui --multipassfb --noarrayindex --noclinitcontext --noscalaropts --precision 3 --preciseinfoflow --pta paddle --transfertaintfield'
