...
printf 'DSARGS ?= --apicalldepth 10 --kobjsens 30 --limitcontextforgui --multipassfb --noarrayindex --noclonestatics --nofallback --nova --precision 3 --preciseinfoflow --pta geo --trackallflows --transfertaintfield --typesforcontext'
