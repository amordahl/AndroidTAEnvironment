...
printf 'DSARGS ?= --apicalldepth 10 --ignoreexceptionflows --implicitflow --kobjsens 40 --limitcontextforcomplex --limitcontextforstrings --noclinitcontext --noscalaropts --nova --precision 1 --pta paddle --transfertaintfield --typesforcontext'
