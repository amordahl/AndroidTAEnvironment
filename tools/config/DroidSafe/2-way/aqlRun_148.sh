...
printf 'DSARGS ?= --apicalldepth 10 --filetransforms --ignoreexceptionflows --imprecisestrings --kobjsens 50 --limitcontextforcomplex --limitcontextforgui --limitcontextforstrings --multipassfb --noarrayindex --nofallback --nojsa --noscalaropts --precision 2 --preciseinfoflow --pta paddle'
