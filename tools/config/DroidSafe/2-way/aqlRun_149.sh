...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 10 --filetransforms --imprecisestrings --kobjsens 100 --limitcontextforcomplex --noarrayindex --nojsa --noscalaropts --nova --precision 1 --pta spark --trackallflows'
