...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 50 --imprecisestrings --kobjsens 2 --limitcontextforgui --limitcontextforstrings --nofallback --nojsa --noscalaropts --pta paddle\n' >> Makefile
