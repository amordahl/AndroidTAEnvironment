...
printf 'DSARGS ?= --apicalldepth 20 --ignoreexceptionflows --imprecisestrings --kobjsens 3 --limitcontextforstrings --noclinitcontext --precision 5 --pta paddle --trackallflows --transfertaintfield'
