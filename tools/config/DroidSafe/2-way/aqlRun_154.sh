...
printf 'DSARGS ?= --apicalldepth 20 --filetransforms --ignorenocontextflows --imprecisestrings --kobjsens 5 --limitcontextforstrings --multipassfb --noclinitcontext --noclonestatics --nojsa --nova --precision 1 --preciseinfoflow --pta paddle --transfertaintfield'
