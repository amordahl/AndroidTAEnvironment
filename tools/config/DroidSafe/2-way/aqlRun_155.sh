...
printf 'DSARGS ?= --apicalldepth 20 --filetransforms --ignoreexceptionflows --ignorenocontextflows --implicitflow --kobjsens 6 --multipassfb --noarrayindex --noclinitcontext --noclonestatics --noscalaropts --precision 2 --pta spark'
