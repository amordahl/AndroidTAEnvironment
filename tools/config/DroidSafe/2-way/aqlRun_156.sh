...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 20 --filetransforms --imprecisestrings --kobjsens 7 --limitcontextforcomplex --limitcontextforgui --limitcontextforstrings --multipassfb --noscalaropts --precision 3 --preciseinfoflow --pta paddle --typesforcontext'
