...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 20 --ignoreexceptionflows --ignorenocontextflows --kobjsens 8 --limitcontextforcomplex --limitcontextforgui --limitcontextforstrings --noarrayindex --noscalaropts --precision 5 --pta geo --trackallflows --typesforcontext'
