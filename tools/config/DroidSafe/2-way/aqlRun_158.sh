...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 20 --kobjsens 9 --noarrayindex --noclinitcontext --nofallback --noscalaropts --precision 2 --pta geo --transfertaintfield'
