...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 20 --ignoreexceptionflows --ignorenocontextflows --implicitflow --imprecisestrings --kobjsens 20 --limitcontextforcomplex --limitcontextforgui --noclinitcontext --nojsa --nova --precision 5 --pta geo --trackallflows --transfertaintfield'
