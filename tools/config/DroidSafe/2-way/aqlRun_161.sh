...
printf 'DSARGS ?= --apicalldepth 20 --ignoreexceptionflows --implicitflow --kobjsens 30 --limitcontextforstrings --noarrayindex --noclinitcontext --nojsa --nova --precision 0 --preciseinfoflow --pta geo --trackallflows --typesforcontext'
