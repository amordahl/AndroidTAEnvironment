...
printf 'DSARGS ?= --apicalldepth 20 --filetransforms --ignorenocontextflows --kobjsens 40 --limitcontextforgui --noscalaropts --nova --precision 5 --pta paddle --trackallflows --transfertaintfield --typesforcontext'
