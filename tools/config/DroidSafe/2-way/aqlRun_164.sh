...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 20 --imprecisestrings --kobjsens 100 --limitcontextforgui --limitcontextforstrings --noarrayindex --noclinitcontext --noclonestatics --nofallback --nojsa --precision 4 --pta paddle --trackallflows --transfertaintfield --typesforcontext'
