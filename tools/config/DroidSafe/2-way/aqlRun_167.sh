...
printf 'DSARGS ?= --apicalldepth 30 --imprecisestrings --kobjsens 3 --limitcontextforcomplex --limitcontextforstrings --multipassfb --noscalaropts --nova --precision 5 --pta paddle --trackallflows --typesforcontext'
