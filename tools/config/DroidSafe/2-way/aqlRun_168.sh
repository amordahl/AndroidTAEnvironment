...
printf 'DSARGS ?= --apicalldepth 30 --filetransforms --implicitflow --kobjsens 4 --limitcontextforcomplex --noarrayindex --nojsa --noscalaropts --precision 0 --pta geo --trackallflows'
