...
printf 'DSARGS ?= --apicalldepth 30 --filetransforms --ignorenocontextflows --implicitflow --kobjsens 5 --limitcontextforcomplex --multipassfb --nofallback --nojsa --noscalaropts --precision 1 --pta spark --trackallflows --typesforcontext'
