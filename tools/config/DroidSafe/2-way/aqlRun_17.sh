...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 2 --ignoreexceptionflows --implicitflow --kobjsens 3 --limitcontextforcomplex --limitcontextforstrings --noarrayindex --noclonestatics --nojsa --nova --precision 0 --pta geo --trackallflows'
