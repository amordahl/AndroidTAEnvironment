...
printf 'DSARGS ?= --apicalldepth 50 --implicitflow --kobjsens 4 --limitcontextforcomplex --limitcontextforgui --limitcontextforstrings --multipassfb --noarrayindex --noclinitcontext --nofallback --nova --preciseinfoflow --pta spark --typesforcontext\n' >> Makefile
