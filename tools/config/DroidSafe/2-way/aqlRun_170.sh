...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 30 --implicitflow --kobjsens 6 --limitcontextforgui --limitcontextforstrings --noscalaropts --nova --precision 2 --pta paddle --trackallflows'
