...
printf 'DSARGS ?= --apicalldepth 30 --filetransforms --ignoreexceptionflows --ignorenocontextflows --imprecisestrings --kobjsens 7 --limitcontextforgui --limitcontextforstrings --noclonestatics --noscalaropts --precision 3 --preciseinfoflow --pta geo --trackallflows --typesforcontext'
