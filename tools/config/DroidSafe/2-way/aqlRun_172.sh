...
printf 'DSARGS ?= --apicalldepth 30 --ignorenocontextflows --kobjsens 8 --limitcontextforcomplex --limitcontextforgui --limitcontextforstrings --noclonestatics --nojsa --precision 3 --preciseinfoflow --pta spark --trackallflows --transfertaintfield --typesforcontext'
