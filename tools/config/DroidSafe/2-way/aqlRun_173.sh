...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 30 --filetransforms --ignoreexceptionflows --ignorenocontextflows --implicitflow --imprecisestrings --kobjsens 9 --limitcontextforgui --multipassfb --noarrayindex --noclinitcontext --nofallback --noscalaropts --nova --precision 1 --pta paddle --transfertaintfield'
