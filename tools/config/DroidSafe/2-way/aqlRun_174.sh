...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 30 --filetransforms --ignorenocontextflows --kobjsens 10 --limitcontextforgui --limitcontextforstrings --noclinitcontext --nofallback --noscalaropts --precision 3 --pta paddle --transfertaintfield'
