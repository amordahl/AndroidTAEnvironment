...
printf 'DSARGS ?= --apicalldepth 30 --ignoreexceptionflows --imprecisestrings --kobjsens 30 --limitcontextforcomplex --limitcontextforgui --noarrayindex --noclinitcontext --nofallback --noscalaropts --nova --precision 4 --pta paddle --trackallflows --transfertaintfield'
