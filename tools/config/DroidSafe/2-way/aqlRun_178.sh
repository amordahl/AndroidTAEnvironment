...
printf 'DSARGS ?= --apicalldepth 30 --ignorenocontextflows --implicitflow --kobjsens 50 --limitcontextforstrings --multipassfb --noscalaropts --nova --precision 2 --pta paddle'
