...
printf 'DSARGS ?= --apicalldepth 2 --filetransforms --ignorenocontextflows --imprecisestrings --kobjsens 4 --limitcontextforgui --multipassfb --noclinitcontext --nofallback --noscalaropts --precision 1 --preciseinfoflow --pta spark --transfertaintfield'
