...
printf 'DSARGS ?= --apicalldepth 50 --ignoreexceptionflows --ignorenocontextflows --imprecisestrings --kobjsens 5 --limitcontextforcomplex --limitcontextforgui --nofallback --preciseinfoflow --pta paddle\n' >> Makefile
