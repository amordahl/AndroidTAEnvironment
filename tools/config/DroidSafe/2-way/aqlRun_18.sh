...
printf 'DSARGS ?= --apicalldepth 50 --filetransforms --implicitflow --imprecisestrings --kobjsens 5 --limitcontextforgui --multipassfb --noarrayindex --noscalaropts --preciseinfoflow --pta paddle\n' >> Makefile
