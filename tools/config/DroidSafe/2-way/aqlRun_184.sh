...
printf 'DSARGS ?= --apicalldepth 40 --ignorenocontextflows --kobjsens 5 --limitcontextforstrings --multipassfb --noclinitcontext --noclonestatics --nofallback --nojsa --noscalaropts --precision 1 --preciseinfoflow --pta geo'
