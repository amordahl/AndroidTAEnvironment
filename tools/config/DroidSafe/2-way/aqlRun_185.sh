...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 40 --filetransforms --ignorenocontextflows --kobjsens 6 --noclinitcontext --nofallback --precision 2 --pta spark --transfertaintfield --typesforcontext'
