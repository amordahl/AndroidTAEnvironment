...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 40 --filetransforms --ignoreexceptionflows --imprecisestrings --kobjsens 7 --limitcontextforcomplex --limitcontextforgui --limitcontextforstrings --multipassfb --noarrayindex --nojsa --noscalaropts --precision 5 --pta paddle'
