...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 40 --filetransforms --ignoreexceptionflows --ignorenocontextflows --imprecisestrings --kobjsens 9 --multipassfb --noclinitcontext --noscalaropts --precision 5 --pta spark --trackallflows'
