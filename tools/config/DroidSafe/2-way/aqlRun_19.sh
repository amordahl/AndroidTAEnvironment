...
printf 'DSARGS ?= --apicalldepth 50 --filetransforms --ignorenocontextflows --kobjsens 6 --limitcontextforstrings --noarrayindex --noclinitcontext --nojsa --pta geo --trackallflows --transfertaintfield --typesforcontext\n' >> Makefile
