...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 2 --filetransforms --ignoreexceptionflows --imprecisestrings --kobjsens 5 --limitcontextforcomplex --multipassfb --noarrayindex --nofallback --nojsa --precision 2 --preciseinfoflow --pta paddle --trackallflows'
