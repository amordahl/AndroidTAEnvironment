...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 40 --filetransforms --ignoreexceptionflows --implicitflow --imprecisestrings --kobjsens 40 --limitcontextforgui --multipassfb --noclonestatics --nofallback --precision 0 --preciseinfoflow --pta geo --trackallflows --transfertaintfield'
