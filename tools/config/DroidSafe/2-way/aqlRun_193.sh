...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 40 --ignoreexceptionflows --implicitflow --kobjsens 50 --limitcontextforstrings --noarrayindex --noclinitcontext --nofallback --noscalaropts --precision 5 --pta geo --trackallflows --transfertaintfield'
