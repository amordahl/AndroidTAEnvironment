...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 40 --ignorenocontextflows --implicitflow --kobjsens 100 --limitcontextforcomplex --limitcontextforstrings --noclinitcontext --nova --precision 1 --preciseinfoflow --pta spark --transfertaintfield --typesforcontext'
