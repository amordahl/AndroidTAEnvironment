...
printf 'DSARGS ?= --apicalldepth 50 --filetransforms --implicitflow --imprecisestrings --kobjsens 4 --limitcontextforgui --noarrayindex --nojsa --noscalaropts --precision 0 --preciseinfoflow --pta paddle --trackallflows --transfertaintfield --typesforcontext'
