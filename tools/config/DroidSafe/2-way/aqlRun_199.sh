...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 50 --ignorenocontextflows --implicitflow --imprecisestrings --kobjsens 5 --limitcontextforgui --limitcontextforstrings --noclinitcontext --nofallback --nojsa --noscalaropts --precision 1 --preciseinfoflow --pta paddle --trackallflows'
