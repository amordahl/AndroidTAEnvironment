...
printf 'DSARGS ?= --apicalldepth 0 --filetransforms --ignorenocontextflows --imprecisestrings --kobjsens 3 --limitcontextforgui --multipassfb --noclinitcontext --nofallback --noscalaropts --preciseinfoflow --pta spark --typesforcontext\n' >> Makefile
