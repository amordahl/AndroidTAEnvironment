...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 50 --filetransforms --ignoreexceptionflows --ignorenocontextflows --implicitflow --imprecisestrings --kobjsens 18 --limitcontextforgui --multipassfb --noclonestatics --pta spark\n' >> Makefile
