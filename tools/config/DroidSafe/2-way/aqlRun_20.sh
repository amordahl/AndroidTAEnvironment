...
printf 'DSARGS ?= --apicalldepth 2 --filetransforms --ignorenocontextflows --implicitflow --kobjsens 6 --limitcontextforgui --limitcontextforstrings --noclinitcontext --noclonestatics --noscalaropts --nova --precision 3 --pta geo --transfertaintfield --typesforcontext'
