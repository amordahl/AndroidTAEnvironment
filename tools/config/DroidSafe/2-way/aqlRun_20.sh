...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 50 --filetransforms --ignoreexceptionflows --implicitflow --kobjsens 18 --limitcontextforcomplex --limitcontextforstrings --pta spark --trackallflows --transfertaintfield --typesforcontext\n' >> Makefile
