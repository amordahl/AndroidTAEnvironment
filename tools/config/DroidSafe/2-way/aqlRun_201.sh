...
printf 'DSARGS ?= --apicalldepth 50 --filetransforms --kobjsens 7 --limitcontextforcomplex --limitcontextforgui --limitcontextforstrings --noarrayindex --noclinitcontext --noclonestatics --nofallback --nova --precision 1 --preciseinfoflow --pta spark --typesforcontext'
