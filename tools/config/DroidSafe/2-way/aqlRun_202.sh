...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 50 --ignoreexceptionflows --kobjsens 8 --limitcontextforcomplex --multipassfb --noclonestatics --nova --precision 3 --preciseinfoflow --pta spark --typesforcontext'
