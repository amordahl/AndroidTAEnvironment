...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 50 --implicitflow --kobjsens 10 --limitcontextforgui --multipassfb --noarrayindex --nojsa --precision 3 --pta spark --trackallflows --transfertaintfield'
