...
printf 'DSARGS ?= --apicalldepth 50 --filetransforms --kobjsens 20 --noclinitcontext --nofallback --nojsa --noscalaropts --nova --precision 2 --preciseinfoflow --pta geo --trackallflows --typesforcontext'
