...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 50 --kobjsens 30 --limitcontextforgui --multipassfb --noclinitcontext --noclonestatics --nojsa --noscalaropts --nova --precision 0 --preciseinfoflow --pta paddle --transfertaintfield'
