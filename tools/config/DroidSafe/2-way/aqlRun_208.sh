...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 50 --filetransforms --imprecisestrings --kobjsens 50 --limitcontextforstrings --noarrayindex --nofallback --noscalaropts --nova --precision 3 --pta geo --typesforcontext'
