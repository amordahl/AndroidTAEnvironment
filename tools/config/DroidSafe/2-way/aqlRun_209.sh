...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 50 --ignoreexceptionflows --ignorenocontextflows --implicitflow --imprecisestrings --kobjsens 100 --limitcontextforgui --noclonestatics --nofallback --nojsa --precision 2 --pta geo --trackallflows --typesforcontext'
