...
printf 'DSARGS ?= --apicalldepth 100 --filetransforms --ignoreexceptionflows --imprecisestrings --kobjsens 3 --limitcontextforcomplex --limitcontextforstrings --noarrayindex --noclinitcontext --noclonestatics --nova --precision 5 --pta paddle --trackallflows'
