...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 100 --filetransforms --ignoreexceptionflows --implicitflow --kobjsens 4 --limitcontextforcomplex --limitcontextforgui --multipassfb --noclonestatics --nofallback --noscalaropts --nova --precision 0 --preciseinfoflow --pta spark --typesforcontext'
