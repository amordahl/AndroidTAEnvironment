...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 100 --kobjsens 5 --limitcontextforcomplex --limitcontextforgui --noarrayindex --noclinitcontext --noscalaropts --nova --precision 1 --preciseinfoflow --pta paddle --transfertaintfield'
