...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 100 --filetransforms --implicitflow --imprecisestrings --kobjsens 6 --noclonestatics --noscalaropts --precision 2 --pta geo --trackallflows --transfertaintfield'
