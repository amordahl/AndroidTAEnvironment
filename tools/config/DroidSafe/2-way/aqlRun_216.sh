...
printf 'DSARGS ?= --apicalldepth 100 --filetransforms --ignorenocontextflows --implicitflow --kobjsens 7 --noarrayindex --nofallback --noscalaropts --precision 0 --pta spark --transfertaintfield'
