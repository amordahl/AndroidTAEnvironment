...
printf 'DSARGS ?= --apicalldepth 100 --filetransforms --ignorenocontextflows --kobjsens 8 --limitcontextforgui --noclinitcontext --nofallback --nova --precision 5 --pta spark --typesforcontext'
