...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 100 --filetransforms --ignoreexceptionflows --ignorenocontextflows --imprecisestrings --kobjsens 9 --limitcontextforcomplex --noclinitcontext --nofallback --noscalaropts --nova --precision 5 --pta spark --typesforcontext'
