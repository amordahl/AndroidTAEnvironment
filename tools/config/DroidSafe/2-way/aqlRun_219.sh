...
printf 'DSARGS ?= --apicalldepth 100 --filetransforms --ignoreexceptionflows --ignorenocontextflows --kobjsens 10 --noarrayindex --noclonestatics --nova --precision 4 --pta geo --transfertaintfield'
