...
printf 'DSARGS ?= --apicalldepth 100 --ignorenocontextflows --kobjsens 30 --limitcontextforgui --limitcontextforstrings --noarrayindex --noclonestatics --nofallback --nojsa --noscalaropts --precision 1 --preciseinfoflow --pta spark --typesforcontext'
