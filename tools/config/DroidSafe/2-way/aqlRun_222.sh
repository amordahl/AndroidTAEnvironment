...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 100 --filetransforms --implicitflow --kobjsens 40 --limitcontextforcomplex --limitcontextforstrings --nofallback --noscalaropts --precision 1 --pta geo --typesforcontext'
