...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 2 --ignoreexceptionflows --implicitflow --kobjsens 10 --limitcontextforcomplex --limitcontextforstrings --noclonestatics --noscalaropts --precision 1 --pta spark --trackallflows'
