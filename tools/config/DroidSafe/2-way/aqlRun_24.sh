...
printf 'DSARGS ?= --apicalldepth 80 --filetransforms --imprecisestrings --kobjsens 4 --limitcontextforgui --limitcontextforstrings --multipassfb --noclinitcontext --noscalaropts --pta paddle --trackallflows --transfertaintfield --typesforcontext\n' >> Makefile
