...
printf 'DSARGS ?= --apicalldepth 80 --filetransforms --ignorenocontextflows --kobjsens 4 --limitcontextforcomplex --noarrayindex --noclonestatics --nofallback --nojsa --nova --pta spark\n' >> Makefile
