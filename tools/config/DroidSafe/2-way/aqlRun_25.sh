...
printf 'DSARGS ?= --apicalldepth 2 --ignorenocontextflows --kobjsens 20 --limitcontextforgui --limitcontextforstrings --noclinitcontext --noclonestatics --nofallback --nova --precision 2 --preciseinfoflow --pta paddle --transfertaintfield --typesforcontext'
