...
printf 'DSARGS ?= --apicalldepth 80 --implicitflow --imprecisestrings --kobjsens 6 --limitcontextforcomplex --noarrayindex --noclinitcontext --noclonestatics --nofallback --nojsa --nova --pta geo --typesforcontext\n' >> Makefile
