...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 2 --ignoreexceptionflows --imprecisestrings --kobjsens 30 --limitcontextforcomplex --multipassfb --noarrayindex --nojsa --precision 3 --pta geo --trackallflows'
