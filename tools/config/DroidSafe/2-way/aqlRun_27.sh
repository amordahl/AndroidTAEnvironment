...
printf 'DSARGS ?= --apicalldepth 2 --filetransforms --implicitflow --kobjsens 40 --limitcontextforcomplex --limitcontextforgui --noscalaropts --precision 4 --preciseinfoflow --pta paddle --transfertaintfield'
