...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 80 --ignorenocontextflows --imprecisestrings --kobjsens 18 --limitcontextforcomplex --nofallback --nojsa --preciseinfoflow --pta paddle --trackallflows --transfertaintfield\n' >> Makefile
