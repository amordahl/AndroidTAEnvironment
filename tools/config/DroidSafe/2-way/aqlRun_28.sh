...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 2 --filetransforms --ignoreexceptionflows --ignorenocontextflows --implicitflow --imprecisestrings --kobjsens 50 --limitcontextforstrings --noarrayindex --noclinitcontext --noclonestatics --nofallback --nojsa --nova --precision 5 --pta geo --trackallflows --typesforcontext'
