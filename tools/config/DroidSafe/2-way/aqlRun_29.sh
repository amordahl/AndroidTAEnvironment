...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 90 --imprecisestrings --kobjsens 2 --limitcontextforgui --limitcontextforstrings --nofallback --pta geo --typesforcontext\n' >> Makefile
