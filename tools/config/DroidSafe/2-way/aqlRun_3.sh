...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 1 --ignoreexceptionflows --implicitflow --kobjsens 4 --limitcontextforcomplex --limitcontextforstrings --noarrayindex --noclonestatics --nojsa --nova --precision 4 --pta paddle --trackallflows --typesforcontext'
