...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 3 --ignoreexceptionflows --implicitflow --kobjsens 1 --limitcontextforstrings --noarrayindex --noclinitcontext --noclonestatics --nofallback --nojsa --nova --precision 2 --pta geo --typesforcontext'
