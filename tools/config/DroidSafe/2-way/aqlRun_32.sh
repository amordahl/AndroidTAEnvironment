...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 90 --kobjsens 5 --limitcontextforcomplex --limitcontextforstrings --multipassfb --nojsa --nova --preciseinfoflow --pta paddle\n' >> Makefile
