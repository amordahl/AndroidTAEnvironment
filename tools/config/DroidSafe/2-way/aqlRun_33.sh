...
printf 'DSARGS ?= --apicalldepth 90 --implicitflow --kobjsens 6 --limitcontextforcomplex --limitcontextforgui --noclonestatics --nova --pta paddle --transfertaintfield --typesforcontext\n' >> Makefile
