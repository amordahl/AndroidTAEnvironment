...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 90 --implicitflow --kobjsens 6 --limitcontextforcomplex --limitcontextforgui --noarrayindex --noclinitcontext --noclonestatics --nofallback --nova --pta paddle --transfertaintfield\n' >> Makefile
