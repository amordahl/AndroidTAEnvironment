...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 3 --filetransforms --ignoreexceptionflows --ignorenocontextflows --implicitflow --kobjsens 4 --limitcontextforcomplex --limitcontextforgui --multipassfb --noclonestatics --nofallback --noscalaropts --nova --precision 5 --preciseinfoflow --pta geo'
