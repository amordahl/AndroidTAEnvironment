...
printf 'DSARGS ?= --apicalldepth 3 --filetransforms --kobjsens 5 --limitcontextforstrings --noarrayindex --noscalaropts --precision 0 --preciseinfoflow --pta spark --trackallflows --typesforcontext'
