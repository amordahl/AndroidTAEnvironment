...
printf 'DSARGS ?= --apicalldepth 100 --filetransforms --ignoreexceptionflows --ignorenocontextflows --implicitflow --kobjsens 1 --limitcontextforcomplex --multipassfb --noarrayindex --noclinitcontext --noclonestatics --nojsa --noscalaropts --nova --preciseinfoflow --pta paddle --trackallflows --typesforcontext\n' >> Makefile
