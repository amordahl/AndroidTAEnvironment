...
printf 'DSARGS ?= --apicalldepth 3 --ignoreexceptionflows --ignorenocontextflows --implicitflow --imprecisestrings --kobjsens 7 --limitcontextforcomplex --limitcontextforstrings --multipassfb --noarrayindex --noclonestatics --precision 2 --preciseinfoflow --pta paddle --trackallflows --typesforcontext'
