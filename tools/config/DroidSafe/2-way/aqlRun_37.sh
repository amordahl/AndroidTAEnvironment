...
printf 'DSARGS ?= --apicalldepth 3 --ignoreexceptionflows --implicitflow --kobjsens 8 --limitcontextforgui --noclinitcontext --nofallback --nojsa --noscalaropts --precision 3 --preciseinfoflow --pta geo'
