...
printf 'DSARGS ?= --apicalldepth 100 --filetransforms --ignoreexceptionflows --ignorenocontextflows --implicitflow --imprecisestrings --kobjsens 3 --limitcontextforcomplex --limitcontextforgui --limitcontextforstrings --multipassfb --noclinitcontext --noclonestatics --nojsa --pta spark --typesforcontext\n' >> Makefile
