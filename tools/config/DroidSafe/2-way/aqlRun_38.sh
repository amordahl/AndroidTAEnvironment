...
printf 'DSARGS ?= --apicalldepth 100 --ignoreexceptionflows --ignorenocontextflows --implicitflow --kobjsens 4 --limitcontextforstrings --noclinitcontext --nofallback --nova --preciseinfoflow --pta paddle --transfertaintfield\n' >> Makefile
