...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 100 --filetransforms --ignoreexceptionflows --implicitflow --imprecisestrings --kobjsens 4 --limitcontextforgui --nofallback --preciseinfoflow --pta geo --transfertaintfield --typesforcontext\n' >> Makefile
