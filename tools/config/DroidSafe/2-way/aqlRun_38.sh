...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 3 --ignorenocontextflows --implicitflow --imprecisestrings --kobjsens 9 --limitcontextforcomplex --limitcontextforstrings --noscalaropts --nova --precision 4 --preciseinfoflow --pta spark --typesforcontext'
