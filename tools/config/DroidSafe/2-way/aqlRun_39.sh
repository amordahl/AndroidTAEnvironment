...
printf 'DSARGS ?= --apicalldepth 100 --ignoreexceptionflows --imprecisestrings --kobjsens 5 --limitcontextforgui --noarrayindex --noclinitcontext --nofallback --nova --preciseinfoflow --pta geo --typesforcontext\n' >> Makefile
