...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 100 --filetransforms --ignorenocontextflows --implicitflow --kobjsens 5 --limitcontextforcomplex --noarrayindex --noclonestatics --nofallback --nojsa --nova --pta geo\n' >> Makefile
