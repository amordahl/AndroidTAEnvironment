...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 3 --filetransforms --ignoreexceptionflows --ignorenocontextflows --implicitflow --kobjsens 10 --limitcontextforcomplex --limitcontextforstrings --nofallback --nojsa --noscalaropts --precision 5 --pta paddle --transfertaintfield --typesforcontext'
