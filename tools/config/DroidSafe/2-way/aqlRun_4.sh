...
printf 'DSARGS ?= --apicalldepth 1 --ignorenocontextflows --implicitflow --kobjsens 5 --limitcontextforgui --limitcontextforstrings --noclinitcontext --noclonestatics --noscalaropts --nova --precision 5 --pta geo --transfertaintfield --typesforcontext'
