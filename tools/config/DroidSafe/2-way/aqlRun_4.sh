...
printf 'DSARGS ?= --apicalldepth 0 --ignorenocontextflows --implicitflow --kobjsens 5 --limitcontextforgui --limitcontextforstrings --noclinitcontext --noclonestatics --noscalaropts --nova --pta geo --typesforcontext\n' >> Makefile
