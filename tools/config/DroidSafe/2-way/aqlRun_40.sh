...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 3 --filetransforms --ignoreexceptionflows --implicitflow --kobjsens 20 --limitcontextforstrings --noarrayindex --nofallback --noscalaropts --nova --precision 0 --pta geo'
