...
printf 'DSARGS ?= --apicalldepth 100 --filetransforms --imprecisestrings --kobjsens 6 --limitcontextforgui --limitcontextforstrings --multipassfb --noclinitcontext --preciseinfoflow --pta spark --transfertaintfield\n' >> Makefile
