...
printf 'DSARGS ?= --apicalldepth 3 --ignoreexceptionflows --ignorenocontextflows --kobjsens 30 --limitcontextforcomplex --limitcontextforgui --limitcontextforstrings --noarrayindex --noclonestatics --nofallback --nojsa --noscalaropts --precision 1 --pta spark --trackallflows --transfertaintfield --typesforcontext'
