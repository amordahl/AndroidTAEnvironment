...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 3 --kobjsens 40 --limitcontextforgui --limitcontextforstrings --noarrayindex --noclinitcontext --nofallback --nojsa --nova --precision 2 --pta geo --trackallflows --transfertaintfield'
