...
printf 'DSARGS ?= --apicalldepth 3 --filetransforms --ignoreexceptionflows --ignorenocontextflows --implicitflow --kobjsens 50 --limitcontextforcomplex --limitcontextforgui --multipassfb --noarrayindex --noclonestatics --precision 3 --pta spark --trackallflows --typesforcontext'
