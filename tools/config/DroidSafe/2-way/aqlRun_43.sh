...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 110 --imprecisestrings --kobjsens 2 --limitcontextforgui --limitcontextforstrings --nofallback --pta geo --transfertaintfield\n' >> Makefile
