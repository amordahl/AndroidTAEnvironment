...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 3 --imprecisestrings --kobjsens 100 --limitcontextforgui --limitcontextforstrings --nofallback --precision 4 --preciseinfoflow --pta paddle --transfertaintfield --typesforcontext'
