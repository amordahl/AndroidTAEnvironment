...
printf 'DSARGS ?= --apicalldepth 110 --ignoreexceptionflows --ignorenocontextflows --imprecisestrings --kobjsens 3 --limitcontextforcomplex --limitcontextforgui --limitcontextforstrings --noclonestatics --nofallback --nojsa --noscalaropts --nova --pta spark --trackallflows\n' >> Makefile
