...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 110 --implicitflow --imprecisestrings --kobjsens 3 --limitcontextforcomplex --multipassfb --noclinitcontext --nofallback --nojsa --noscalaropts --nova --preciseinfoflow --pta spark\n' >> Makefile
