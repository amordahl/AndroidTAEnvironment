...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 4 --ignoreexceptionflows --implicitflow --kobjsens 1 --limitcontextforstrings --noarrayindex --noclinitcontext --noclonestatics --nofallback --nojsa --nova --precision 5 --pta geo --typesforcontext'
