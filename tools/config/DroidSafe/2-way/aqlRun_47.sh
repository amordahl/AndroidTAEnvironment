...
printf 'DSARGS ?= --apicalldepth 110 --filetransforms --ignorenocontextflows --implicitflow --kobjsens 6 --limitcontextforstrings --noarrayindex --noclinitcontext --nojsa --preciseinfoflow --pta geo --transfertaintfield --typesforcontext\n' >> Makefile
