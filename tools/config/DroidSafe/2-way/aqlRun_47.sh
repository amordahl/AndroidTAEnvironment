...
printf 'DSARGS ?= --apicalldepth 4 --ignoreexceptionflows --ignorenocontextflows --implicitflow --imprecisestrings --kobjsens 3 --limitcontextforstrings --noclinitcontext --nojsa --noscalaropts --precision 1 --preciseinfoflow --pta paddle --trackallflows'
