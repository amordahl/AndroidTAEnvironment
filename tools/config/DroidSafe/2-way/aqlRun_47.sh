...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 110 --filetransforms --ignoreexceptionflows --ignorenocontextflows --implicitflow --imprecisestrings --kobjsens 6 --limitcontextforgui --limitcontextforstrings --multipassfb --noclinitcontext --noclonestatics --nojsa --noscalaropts --nova --preciseinfoflow --pta geo --transfertaintfield\n' >> Makefile
