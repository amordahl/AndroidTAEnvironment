...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 4 --ignoreexceptionflows --ignorenocontextflows --imprecisestrings --kobjsens 5 --noclinitcontext --noscalaropts --nova --precision 3 --preciseinfoflow --pta geo'
