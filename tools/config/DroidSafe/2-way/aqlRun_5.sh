...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 0 --ignoreexceptionflows --imprecisestrings --kobjsens 6 --limitcontextforcomplex --multipassfb --noarrayindex --nofallback --nojsa --preciseinfoflow --pta spark --transfertaintfield\n' >> Makefile
