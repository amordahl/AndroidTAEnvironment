...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 1 --ignoreexceptionflows --imprecisestrings --kobjsens 6 --limitcontextforcomplex --multipassfb --noarrayindex --nofallback --nojsa --precision 0 --preciseinfoflow --pta spark --trackallflows'
