...
printf 'DSARGS ?= --apicalldepth 4 --ignoreexceptionflows --implicitflow --kobjsens 6 --limitcontextforgui --limitcontextforstrings --noarrayindex --nofallback --nojsa --nova --precision 4 --preciseinfoflow --pta spark --transfertaintfield'
