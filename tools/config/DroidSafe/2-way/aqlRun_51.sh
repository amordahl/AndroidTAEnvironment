...
printf 'DSARGS ?= --apicalldepth 120 --ignoreexceptionflows --ignorenocontextflows --implicitflow --kobjsens 3 --limitcontextforstrings --noclonestatics --nofallback --nojsa --noscalaropts --nova --preciseinfoflow --pta spark --trackallflows --typesforcontext\n' >> Makefile
