...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 120 --filetransforms --imprecisestrings --kobjsens 4 --limitcontextforcomplex --limitcontextforgui --noclinitcontext --noscalaropts --nova --preciseinfoflow --pta paddle --transfertaintfield --typesforcontext\n' >> Makefile
