...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 120 --kobjsens 4 --limitcontextforcomplex --multipassfb --noarrayindex --noclonestatics --nofallback --noscalaropts --preciseinfoflow --pta spark --trackallflows --typesforcontext\n' >> Makefile
