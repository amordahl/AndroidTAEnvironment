...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 4 --ignorenocontextflows --implicitflow --kobjsens 8 --noarrayindex --noclinitcontext --noclonestatics --nofallback --noscalaropts --precision 0 --pta spark --transfertaintfield --typesforcontext'
