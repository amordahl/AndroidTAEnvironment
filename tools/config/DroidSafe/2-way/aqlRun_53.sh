...
printf 'DSARGS ?= --apicalldepth 120 --filetransforms --ignoreexceptionflows --ignorenocontextflows --imprecisestrings --kobjsens 5 --limitcontextforstrings --noclinitcontext --nova --pta spark --trackallflows --transfertaintfield --typesforcontext\n' >> Makefile
