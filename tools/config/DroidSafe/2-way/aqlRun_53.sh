...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 120 --ignoreexceptionflows --implicitflow --kobjsens 5 --noarrayindex --nofallback --nojsa --nova --preciseinfoflow --pta spark --typesforcontext\n' >> Makefile
