...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 120 --filetransforms --ignorenocontextflows --kobjsens 6 --limitcontextforcomplex --limitcontextforgui --limitcontextforstrings --noarrayindex --nofallback --nova --pta geo\n' >> Makefile
