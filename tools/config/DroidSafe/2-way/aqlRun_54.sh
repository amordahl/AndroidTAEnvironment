...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 120 --ignoreexceptionflows --ignorenocontextflows --implicitflow --kobjsens 6 --limitcontextforcomplex --limitcontextforstrings --nofallback --nojsa --preciseinfoflow --pta spark --trackallflows\n' >> Makefile
