...
printf 'DSARGS ?= --apicalldepth 4 --ignoreexceptionflows --ignorenocontextflows --implicitflow --imprecisestrings --kobjsens 10 --limitcontextforcomplex --limitcontextforstrings --nojsa --noscalaropts --precision 2 --preciseinfoflow --pta paddle'
