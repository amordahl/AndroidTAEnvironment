...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 4 --filetransforms --kobjsens 20 --noclinitcontext --nofallback --noscalaropts --nova --precision 3 --pta spark --typesforcontext'
