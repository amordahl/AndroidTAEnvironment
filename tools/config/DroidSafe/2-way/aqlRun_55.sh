...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 120 --ignorenocontextflows --implicitflow --imprecisestrings --kobjsens 18 --limitcontextforcomplex --multipassfb --noarrayindex --noclinitcontext --noclonestatics --nofallback --nojsa --pta geo --trackallflows\n' >> Makefile
