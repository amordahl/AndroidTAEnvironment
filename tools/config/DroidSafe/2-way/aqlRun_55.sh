...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 120 --ignoreexceptionflows --ignorenocontextflows --implicitflow --imprecisestrings --kobjsens 18 --limitcontextforcomplex --limitcontextforstrings --multipassfb --noarrayindex --noclonestatics --nojsa --pta geo --typesforcontext\n' >> Makefile
