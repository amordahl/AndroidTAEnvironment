...
printf 'DSARGS ?= --apicalldepth 4 --filetransforms --ignoreexceptionflows --implicitflow --imprecisestrings --kobjsens 40 --limitcontextforcomplex --limitcontextforgui --multipassfb --nofallback --noscalaropts --nova --precision 5 --pta spark --typesforcontext'
