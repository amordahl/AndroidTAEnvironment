...
printf 'DSARGS ?= --apicalldepth 4 --filetransforms --ignoreexceptionflows --ignorenocontextflows --implicitflow --imprecisestrings --kobjsens 100 --limitcontextforcomplex --limitcontextforgui --multipassfb --noclinitcontext --precision 1 --preciseinfoflow --pta spark --typesforcontext'
