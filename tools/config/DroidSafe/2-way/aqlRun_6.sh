...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 1 --filetransforms --implicitflow --kobjsens 7 --limitcontextforcomplex --limitcontextforgui --multipassfb --noclonestatics --nojsa --noscalaropts --precision 1 --preciseinfoflow --pta geo --typesforcontext'
