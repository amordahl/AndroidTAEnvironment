...
printf 'DSARGS ?= --apicalldepth 0 --filetransforms --ignoreexceptionflows --ignorenocontextflows --implicitflow --kobjsens 18 --multipassfb --noarrayindex --noclinitcontext --noclonestatics --preciseinfoflow --pta paddle --trackallflows --transfertaintfield --typesforcontext\n' >> Makefile
