...
printf 'DSARGS ?= --apicalldepth 150 --filetransforms --imprecisestrings --kobjsens 5 --limitcontextforstrings --multipassfb --noarrayindex --noclinitcontext --nojsa --nova --pta paddle --typesforcontext\n' >> Makefile
