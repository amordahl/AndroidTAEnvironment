...
printf 'DSARGS ?= --apicalldepth 150 --ignoreexceptionflows --ignorenocontextflows --implicitflow --imprecisestrings --kobjsens 5 --limitcontextforstrings --multipassfb --noarrayindex --noclinitcontext --nojsa --noscalaropts --pta paddle --trackallflows --transfertaintfield\n' >> Makefile
