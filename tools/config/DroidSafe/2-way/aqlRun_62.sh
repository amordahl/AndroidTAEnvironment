...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 150 --ignorenocontextflows --implicitflow --kobjsens 18 --limitcontextforgui --limitcontextforstrings --nofallback --nojsa --nova --preciseinfoflow --pta geo --typesforcontext\n' >> Makefile
