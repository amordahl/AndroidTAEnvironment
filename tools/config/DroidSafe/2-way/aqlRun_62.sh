...
printf 'DSARGS ?= --apicalldepth 150 --implicitflow --kobjsens 18 --limitcontextforstrings --multipassfb --noarrayindex --noclinitcontext --noclonestatics --nofallback --nojsa --noscalaropts --nova --pta spark\n' >> Makefile
