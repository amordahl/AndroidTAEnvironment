...
printf 'DSARGS ?= --apicalldepth 5 --filetransforms --kobjsens 4 --limitcontextforcomplex --limitcontextforstrings --multipassfb --noarrayindex --noclinitcontext --noclonestatics --nojsa --noscalaropts --nova --precision 0 --pta geo --trackallflows --typesforcontext'
