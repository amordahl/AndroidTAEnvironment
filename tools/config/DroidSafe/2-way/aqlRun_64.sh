...
printf 'DSARGS ?= --apicalldepth 5 --ignorenocontextflows --implicitflow --kobjsens 5 --limitcontextforgui --limitcontextforstrings --noclinitcontext --noclonestatics --noscalaropts --nova --precision 1 --preciseinfoflow --pta geo --trackallflows'
