...
printf 'DSARGS ?= --apicalldepth 200 --filetransforms --ignorenocontextflows --imprecisestrings --kobjsens 3 --limitcontextforstrings --multipassfb --noarrayindex --noclinitcontext --noclonestatics --nofallback --pta spark --trackallflows --transfertaintfield\n' >> Makefile
