...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 200 --ignoreexceptionflows --implicitflow --kobjsens 3 --limitcontextforgui --limitcontextforstrings --multipassfb --noclinitcontext --noclonestatics --preciseinfoflow --pta spark\n' >> Makefile
