...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 5 --ignorenocontextflows --kobjsens 7 --limitcontextforgui --noarrayindex --noclinitcontext --noclonestatics --nofallback --nova --precision 3 --pta spark --trackallflows'
