...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 200 --filetransforms --ignoreexceptionflows --ignorenocontextflows --implicitflow --imprecisestrings --kobjsens 4 --limitcontextforcomplex --limitcontextforgui --limitcontextforstrings --nojsa --nova --pta spark --transfertaintfield\n' >> Makefile
