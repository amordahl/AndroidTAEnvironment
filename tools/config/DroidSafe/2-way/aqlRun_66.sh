...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 200 --ignoreexceptionflows --kobjsens 4 --limitcontextforgui --limitcontextforstrings --noarrayindex --pta paddle --trackallflows --typesforcontext\n' >> Makefile
