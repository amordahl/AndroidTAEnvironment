...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 200 --filetransforms --ignoreexceptionflows --ignorenocontextflows --implicitflow --imprecisestrings --kobjsens 5 --noarrayindex --noclinitcontext --nofallback --nojsa --nova --pta paddle\n' >> Makefile
