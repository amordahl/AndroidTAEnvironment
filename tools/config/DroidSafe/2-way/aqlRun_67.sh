...
printf 'DSARGS ?= --apicalldepth 200 --ignoreexceptionflows --ignorenocontextflows --imprecisestrings --kobjsens 5 --limitcontextforcomplex --noarrayindex --preciseinfoflow --pta spark --transfertaintfield --typesforcontext\n' >> Makefile
