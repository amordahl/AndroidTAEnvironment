...
printf 'DSARGS ?= --apicalldepth 5 --ignoreexceptionflows --implicitflow --imprecisestrings --kobjsens 8 --limitcontextforcomplex --limitcontextforstrings --multipassfb --nofallback --nojsa --noscalaropts --nova --precision 4 --pta geo --transfertaintfield --typesforcontext'
