...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 200 --filetransforms --ignorenocontextflows --kobjsens 6 --noclinitcontext --nofallback --nojsa --preciseinfoflow --pta geo --transfertaintfield\n' >> Makefile
