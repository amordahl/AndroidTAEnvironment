...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 200 --implicitflow --kobjsens 18 --noclinitcontext --nofallback --nojsa --noscalaropts --pta spark --transfertaintfield --typesforcontext\n' >> Makefile
