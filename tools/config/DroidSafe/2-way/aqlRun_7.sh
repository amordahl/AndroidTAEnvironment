...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 1 --filetransforms --imprecisestrings --kobjsens 1 --limitcontextforcomplex --limitcontextforgui --limitcontextforstrings --nofallback --nojsa --noscalaropts --nova --pta geo\n' >> Makefile
