...
printf 'DSARGS ?= --apicalldepth 1 --ignoreexceptionflows --kobjsens 8 --limitcontextforstrings --noarrayindex --noclinitcontext --nofallback --nova --precision 2 --pta spark --trackallflows --transfertaintfield'
