...
printf 'DSARGS ?= --apicalldepth 600 --filetransforms --ignoreexceptionflows --ignorenocontextflows --implicitflow --kobjsens 1 --limitcontextforcomplex --multipassfb --noarrayindex --noclinitcontext --noclonestatics --nojsa --noscalaropts --nova --preciseinfoflow --pta paddle --transfertaintfield\n' >> Makefile
