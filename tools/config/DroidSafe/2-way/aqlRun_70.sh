...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 5 --filetransforms --ignoreexceptionflows --ignorenocontextflows --implicitflow --imprecisestrings --kobjsens 20 --noclinitcontext --nofallback --noscalaropts --precision 1 --pta geo --trackallflows --transfertaintfield --typesforcontext'
