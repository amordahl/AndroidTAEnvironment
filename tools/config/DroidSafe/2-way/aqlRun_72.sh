...
printf 'DSARGS ?= --apicalldepth 5 --kobjsens 40 --limitcontextforcomplex --limitcontextforstrings --multipassfb --noclonestatics --nofallback --noscalaropts --nova --precision 3 --pta geo --typesforcontext'
