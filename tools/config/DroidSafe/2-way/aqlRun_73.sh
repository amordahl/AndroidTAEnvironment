...
printf 'DSARGS ?= --apicalldepth 5 --imprecisestrings --kobjsens 50 --limitcontextforgui --limitcontextforstrings --multipassfb --noclonestatics --nofallback --noscalaropts --precision 4 --preciseinfoflow --pta geo --trackallflows --transfertaintfield --typesforcontext'
