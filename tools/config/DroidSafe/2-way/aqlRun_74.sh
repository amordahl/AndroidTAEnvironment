...
printf 'DSARGS ?= --apicalldepth 5 --filetransforms --implicitflow --kobjsens 100 --limitcontextforgui --limitcontextforstrings --noarrayindex --noclonestatics --noscalaropts --precision 5 --pta paddle --trackallflows --transfertaintfield'
