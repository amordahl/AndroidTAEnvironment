...
printf 'DSARGS ?= --apicalldepth 600 --filetransforms --ignoreexceptionflows --implicitflow --imprecisestrings --kobjsens 6 --limitcontextforgui --limitcontextforstrings --noarrayindex --noclinitcontext --nofallback --nojsa --pta spark --trackallflows --typesforcontext\n' >> Makefile
