...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 600 --filetransforms --ignoreexceptionflows --ignorenocontextflows --imprecisestrings --kobjsens 6 --limitcontextforcomplex --limitcontextforgui --multipassfb --noclinitcontext --noclonestatics --nojsa --noscalaropts --nova --pta spark\n' >> Makefile
