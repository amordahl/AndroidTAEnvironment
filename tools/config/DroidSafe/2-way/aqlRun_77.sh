...
printf 'DSARGS ?= --apicalldepth 6 --filetransforms --implicitflow --imprecisestrings --kobjsens 3 --limitcontextforcomplex --limitcontextforgui --noarrayindex --nojsa --noscalaropts --nova --precision 2 --pta paddle'
