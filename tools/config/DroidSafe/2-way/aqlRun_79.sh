...
printf 'DSARGS ?= --apicalldepth 6 --filetransforms --ignoreexceptionflows --implicitflow --imprecisestrings --kobjsens 5 --limitcontextforcomplex --noclonestatics --noscalaropts --nova --precision 4 --preciseinfoflow --pta paddle --transfertaintfield'
