...
printf 'DSARGS ?= --apicalldepth 1 --ignoreexceptionflows --ignorenocontextflows --implicitflow --kobjsens 2 --noclonestatics --preciseinfoflow --pta spark --transfertaintfield --typesforcontext\n' >> Makefile
