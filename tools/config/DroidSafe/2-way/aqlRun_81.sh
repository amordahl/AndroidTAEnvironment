...
printf 'DSARGS ?= --apicalldepth 6 --filetransforms --ignoreexceptionflows --kobjsens 7 --limitcontextforcomplex --limitcontextforstrings --multipassfb --noarrayindex --noclinitcontext --noclonestatics --nova --precision 0 --preciseinfoflow --pta spark --trackallflows'
