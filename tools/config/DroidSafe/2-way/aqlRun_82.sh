...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 6 --ignorenocontextflows --kobjsens 8 --multipassfb --precision 1 --preciseinfoflow --pta spark --trackallflows --typesforcontext'
