...
printf 'DSARGS ?= --apicalldepth 6 --ignorenocontextflows --implicitflow --imprecisestrings --kobjsens 10 --limitcontextforcomplex --limitcontextforstrings --multipassfb --noarrayindex --nova --precision 3 --preciseinfoflow --pta spark --typesforcontext'
