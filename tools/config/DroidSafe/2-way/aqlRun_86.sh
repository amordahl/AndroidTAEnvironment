...
printf 'DSARGS ?= --apicalldepth 6 --filetransforms --ignoreexceptionflows --imprecisestrings --kobjsens 30 --limitcontextforcomplex --noarrayindex --noclinitcontext --nofallback --noscalaropts --nova --precision 5 --preciseinfoflow --pta geo --trackallflows'
