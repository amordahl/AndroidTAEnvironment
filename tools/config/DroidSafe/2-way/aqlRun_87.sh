...
printf 'DSARGS ?= --apicalldepth 6 --ignoreexceptionflows --kobjsens 40 --limitcontextforgui --noarrayindex --noclinitcontext --noclonestatics --nojsa --noscalaropts --precision 0 --preciseinfoflow --pta geo --transfertaintfield --typesforcontext'
