...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 6 --filetransforms --ignorenocontextflows --implicitflow --imprecisestrings --kobjsens 50 --limitcontextforgui --noclinitcontext --nofallback --nova --precision 1 --preciseinfoflow --pta spark --typesforcontext'
