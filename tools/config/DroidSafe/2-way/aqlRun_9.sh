...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 1 --ignoreexceptionflows --implicitflow --imprecisestrings --kobjsens 3 --limitcontextforcomplex --limitcontextforgui --limitcontextforstrings --multipassfb --noarrayindex --noclinitcontext --nova --pta paddle --typesforcontext\n' >> Makefile
