...
printf 'DSARGS ?= --apicalldepth 7 --filetransforms --kobjsens 3 --limitcontextforcomplex --limitcontextforstrings --multipassfb --noarrayindex --noclinitcontext --noclonestatics --nofallback --noscalaropts --precision 5 --pta paddle --transfertaintfield'
