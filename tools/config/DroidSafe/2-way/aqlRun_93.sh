...
printf 'DSARGS ?= --apicalldepth 7 --filetransforms --implicitflow --kobjsens 4 --noclonestatics --nojsa --noscalaropts --nova --precision 0 --preciseinfoflow --pta geo --typesforcontext'
