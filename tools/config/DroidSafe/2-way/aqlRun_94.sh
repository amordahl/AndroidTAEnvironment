...
printf 'DSARGS ?= --apicalldepth 7 --filetransforms --ignoreexceptionflows --implicitflow --kobjsens 5 --limitcontextforgui --multipassfb --noclonestatics --nojsa --noscalaropts --nova --precision 1 --preciseinfoflow --pta paddle --trackallflows'
