...
printf 'DSARGS ?= --apicalldepth 7 --ignorenocontextflows --implicitflow --kobjsens 6 --limitcontextforcomplex --limitcontextforstrings --multipassfb --noarrayindex --nofallback --nojsa --precision 2 --preciseinfoflow --pta spark --typesforcontext'
