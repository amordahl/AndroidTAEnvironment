...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 7 --ignoreexceptionflows --implicitflow --imprecisestrings --kobjsens 8 --limitcontextforcomplex --multipassfb --noarrayindex --nofallback --nojsa --precision 3 --preciseinfoflow --pta paddle --transfertaintfield --typesforcontext'
