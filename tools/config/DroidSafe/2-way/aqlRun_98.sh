...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 7 --filetransforms --ignoreexceptionflows --kobjsens 9 --limitcontextforcomplex --limitcontextforgui --noclonestatics --nofallback --nova --precision 4 --preciseinfoflow --pta geo --typesforcontext'
