...
printf 'DSARGS ?= --apicalldepth 2 --filetransforms --ignorenocontextflows --implicitflow --imprecisestrings --kobjsens 2 --limitcontextforcomplex --limitcontextforgui --limitcontextforstrings --noclonestatics --nofallback --nova --precision 4 --pta paddle --trackallflows --transfertaintfield --typesforcontext'
