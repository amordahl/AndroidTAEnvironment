...
printf 'DSARGS ?= --apicalldepth 30 --filetransforms --ignoreexceptionflows --imprecisestrings --kobjsens 3 --limitcontextforcomplex --multipassfb --noclinitcontext --nojsa --precision 1 --pta spark --trackallflows --transfertaintfield'
