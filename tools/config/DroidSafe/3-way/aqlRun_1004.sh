...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 30 --filetransforms --ignoreexceptionflows --implicitflow --imprecisestrings --kobjsens 3 --limitcontextforstrings --multipassfb --nova --precision 2 --pta geo --trackallflows --transfertaintfield --typesforcontext'
