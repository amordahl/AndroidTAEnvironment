...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 30 --ignorenocontextflows --imprecisestrings --kobjsens 3 --limitcontextforgui --limitcontextforstrings --noclinitcontext --noscalaropts --nova --precision 4 --preciseinfoflow --pta spark --trackallflows'
