...
printf 'DSARGS ?= --apicalldepth 30 --ignoreexceptionflows --ignorenocontextflows --implicitflow --imprecisestrings --kobjsens 3 --noarrayindex --nojsa --nova --precision 5 --preciseinfoflow --pta spark --transfertaintfield --typesforcontext'
