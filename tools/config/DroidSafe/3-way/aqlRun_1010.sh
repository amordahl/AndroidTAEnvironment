...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 30 --filetransforms --ignoreexceptionflows --kobjsens 4 --limitcontextforgui --multipassfb --noarrayindex --noclonestatics --nofallback --noscalaropts --precision 2 --pta spark --transfertaintfield --typesforcontext'
