...
printf 'DSARGS ?= --apicalldepth 30 --ignorenocontextflows --implicitflow --kobjsens 4 --limitcontextforcomplex --limitcontextforgui --nojsa --noscalaropts --nova --precision 3 --preciseinfoflow --pta geo --trackallflows --typesforcontext'
