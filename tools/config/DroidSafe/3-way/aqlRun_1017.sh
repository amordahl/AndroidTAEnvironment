...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 30 --ignoreexceptionflows --imprecisestrings --kobjsens 5 --noclonestatics --nofallback --nova --precision 3 --pta paddle'
