...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 30 --filetransforms --imprecisestrings --kobjsens 5 --limitcontextforcomplex --limitcontextforgui --multipassfb --nojsa --precision 5 --pta spark --trackallflows'
