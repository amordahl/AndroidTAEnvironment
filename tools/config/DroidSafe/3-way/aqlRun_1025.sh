...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 30 --ignoreexceptionflows --implicitflow --kobjsens 6 --limitcontextforgui --limitcontextforstrings --nofallback --nojsa --nova --precision 5 --preciseinfoflow --pta spark --transfertaintfield'
