...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 30 --filetransforms --ignorenocontextflows --implicitflow --kobjsens 7 --nojsa --nova --precision 2 --pta spark --trackallflows --typesforcontext'
