...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 30 --ignorenocontextflows --implicitflow --kobjsens 7 --limitcontextforcomplex --limitcontextforgui --limitcontextforstrings --noarrayindex --noclinitcontext --nova --precision 3 --pta paddle'
