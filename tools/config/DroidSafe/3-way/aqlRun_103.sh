...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 2 --ignorenocontextflows --implicitflow --kobjsens 3 --limitcontextforcomplex --limitcontextforstrings --noarrayindex --noclinitcontext --noclonestatics --noscalaropts --precision 1 --pta geo --transfertaintfield'
