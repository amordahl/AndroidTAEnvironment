...
printf 'DSARGS ?= --apicalldepth 30 --ignorenocontextflows --implicitflow --imprecisestrings --kobjsens 7 --limitcontextforcomplex --limitcontextforgui --limitcontextforstrings --multipassfb --noarrayindex --noclonestatics --nofallback --nojsa --noscalaropts --precision 4 --pta paddle --trackallflows --transfertaintfield'
