...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 30 --ignoreexceptionflows --ignorenocontextflows --implicitflow --imprecisestrings --kobjsens 8 --noarrayindex --noclonestatics --nofallback --nojsa --precision 2 --pta spark --typesforcontext'
