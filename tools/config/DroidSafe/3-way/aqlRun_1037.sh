...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 30 --filetransforms --imprecisestrings --kobjsens 8 --limitcontextforstrings --multipassfb --noclinitcontext --noclonestatics --nofallback --nojsa --noscalaropts --nova --precision 5 --pta paddle --transfertaintfield'
