...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 30 --filetransforms --ignoreexceptionflows --implicitflow --imprecisestrings --kobjsens 9 --limitcontextforgui --noclinitcontext --nojsa --noscalaropts --nova --precision 3 --pta paddle --trackallflows'
