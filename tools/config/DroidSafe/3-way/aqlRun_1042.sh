...
printf 'DSARGS ?= --apicalldepth 30 --filetransforms --ignoreexceptionflows --implicitflow --imprecisestrings --kobjsens 9 --limitcontextforgui --multipassfb --noclonestatics --nofallback --precision 4 --pta geo --trackallflows --transfertaintfield --typesforcontext'
