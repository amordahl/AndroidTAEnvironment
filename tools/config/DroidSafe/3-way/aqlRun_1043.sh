...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 30 --filetransforms --implicitflow --kobjsens 9 --limitcontextforstrings --noarrayindex --noclinitcontext --nofallback --noscalaropts --nova --precision 5 --preciseinfoflow --pta spark'
