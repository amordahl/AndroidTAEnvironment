...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 30 --ignorenocontextflows --imprecisestrings --kobjsens 10 --limitcontextforstrings --noarrayindex --noclonestatics --nofallback --nojsa --noscalaropts --precision 2 --preciseinfoflow --pta spark'
