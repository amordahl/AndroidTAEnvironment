...
printf 'DSARGS ?= --apicalldepth 30 --ignoreexceptionflows --implicitflow --kobjsens 10 --limitcontextforcomplex --noclonestatics --noscalaropts --nova --precision 3 --pta spark --trackallflows'
