...
printf 'DSARGS ?= --apicalldepth 30 --implicitflow --imprecisestrings --kobjsens 10 --limitcontextforcomplex --limitcontextforgui --multipassfb --nofallback --noscalaropts --nova --precision 5 --pta paddle --trackallflows'
