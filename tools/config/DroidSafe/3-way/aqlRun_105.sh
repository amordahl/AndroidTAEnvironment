...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 2 --filetransforms --imprecisestrings --kobjsens 3 --limitcontextforcomplex --limitcontextforstrings --noclinitcontext --nofallback --nojsa --noscalaropts --nova --precision 3 --pta spark --transfertaintfield'
