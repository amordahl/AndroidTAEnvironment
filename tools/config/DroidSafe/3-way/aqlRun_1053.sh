...
printf 'DSARGS ?= --apicalldepth 30 --filetransforms --ignoreexceptionflows --ignorenocontextflows --implicitflow --kobjsens 20 --limitcontextforstrings --noarrayindex --noscalaropts --precision 3 --pta geo --trackallflows --transfertaintfield'
