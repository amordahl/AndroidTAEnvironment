...
printf 'DSARGS ?= --apicalldepth 30 --ignoreexceptionflows --implicitflow --kobjsens 20 --multipassfb --noclonestatics --nojsa --noscalaropts --precision 4 --pta geo --trackallflows --transfertaintfield --typesforcontext'
