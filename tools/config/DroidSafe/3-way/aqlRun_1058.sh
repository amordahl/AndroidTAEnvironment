...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 30 --ignoreexceptionflows --ignorenocontextflows --imprecisestrings --kobjsens 30 --limitcontextforstrings --nojsa --precision 2 --pta spark --trackallflows --transfertaintfield --typesforcontext'
