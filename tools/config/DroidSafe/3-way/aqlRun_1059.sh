...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 30 --ignoreexceptionflows --ignorenocontextflows --implicitflow --kobjsens 30 --multipassfb --noclinitcontext --noclonestatics --nofallback --nojsa --noscalaropts --precision 3 --pta paddle --trackallflows --transfertaintfield'
