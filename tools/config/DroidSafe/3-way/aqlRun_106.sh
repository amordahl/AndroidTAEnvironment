...
printf 'DSARGS ?= --apicalldepth 2 --filetransforms --implicitflow --kobjsens 3 --limitcontextforstrings --multipassfb --noarrayindex --noclinitcontext --precision 4 --pta paddle'
