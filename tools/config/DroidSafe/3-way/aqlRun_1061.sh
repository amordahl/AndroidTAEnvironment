...
printf 'DSARGS ?= --apicalldepth 30 --ignoreexceptionflows --ignorenocontextflows --implicitflow --imprecisestrings --kobjsens 30 --multipassfb --noclinitcontext --noclonestatics --nofallback --nova --precision 5 --preciseinfoflow --pta paddle --trackallflows --typesforcontext'
