...
printf 'DSARGS ?= --apicalldepth 30 --ignoreexceptionflows --kobjsens 40 --limitcontextforgui --multipassfb --noclinitcontext --noclonestatics --precision 3 --preciseinfoflow --pta paddle --typesforcontext'
