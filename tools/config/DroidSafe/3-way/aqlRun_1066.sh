...
printf 'DSARGS ?= --apicalldepth 30 --kobjsens 40 --limitcontextforgui --noclinitcontext --nojsa --noscalaropts --precision 4 --preciseinfoflow --pta spark --transfertaintfield --typesforcontext'
