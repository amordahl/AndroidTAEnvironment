...
printf 'DSARGS ?= --apicalldepth 30 --ignoreexceptionflows --ignorenocontextflows --implicitflow --imprecisestrings --kobjsens 40 --limitcontextforgui --multipassfb --noarrayindex --noclinitcontext --noclonestatics --nofallback --precision 5 --pta paddle --trackallflows --transfertaintfield --typesforcontext'
