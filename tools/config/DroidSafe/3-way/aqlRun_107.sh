...
printf 'DSARGS ?= --apicalldepth 2 --filetransforms --ignoreexceptionflows --implicitflow --kobjsens 3 --limitcontextforgui --nofallback --nojsa --precision 5 --preciseinfoflow --pta geo --trackallflows --transfertaintfield --typesforcontext'
