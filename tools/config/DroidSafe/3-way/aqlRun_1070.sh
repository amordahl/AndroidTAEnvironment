...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 30 --ignorenocontextflows --kobjsens 50 --noarrayindex --noclinitcontext --nojsa --noscalaropts --precision 2 --preciseinfoflow --pta spark --transfertaintfield'
