...
printf 'DSARGS ?= --apicalldepth 30 --implicitflow --imprecisestrings --kobjsens 50 --noarrayindex --nojsa --noscalaropts --precision 3 --preciseinfoflow --pta paddle --trackallflows'
