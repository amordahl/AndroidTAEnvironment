...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 30 --filetransforms --ignorenocontextflows --kobjsens 50 --limitcontextforcomplex --multipassfb --noclinitcontext --noclonestatics --precision 4 --preciseinfoflow --pta spark --trackallflows --typesforcontext'
