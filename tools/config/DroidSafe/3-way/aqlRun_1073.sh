...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 30 --filetransforms --ignoreexceptionflows --kobjsens 50 --limitcontextforcomplex --noarrayindex --noclinitcontext --nofallback --nojsa --precision 5 --pta geo'
