...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 30 --filetransforms --ignoreexceptionflows --ignorenocontextflows --kobjsens 100 --limitcontextforcomplex --multipassfb --noclinitcontext --noclonestatics --nofallback --nova --precision 4 --preciseinfoflow --pta paddle --trackallflows --transfertaintfield'
