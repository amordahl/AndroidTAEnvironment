...
printf 'DSARGS ?= --apicalldepth 30 --implicitflow --imprecisestrings --kobjsens 100 --limitcontextforcomplex --noclinitcontext --noclonestatics --nofallback --noscalaropts --precision 5 --preciseinfoflow --pta geo --trackallflows --transfertaintfield'
