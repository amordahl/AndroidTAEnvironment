...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 2 --ignoreexceptionflows --imprecisestrings --kobjsens 4 --noarrayindex --noclonestatics --nofallback --precision 0 --preciseinfoflow --pta paddle --trackallflows --transfertaintfield'
