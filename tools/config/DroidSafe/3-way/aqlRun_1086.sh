...
printf 'DSARGS ?= --apicalldepth 40 --filetransforms --ignoreexceptionflows --ignorenocontextflows --imprecisestrings --kobjsens 2 --limitcontextforcomplex --multipassfb --noclinitcontext --nojsa --precision 0 --pta spark --trackallflows --transfertaintfield'
