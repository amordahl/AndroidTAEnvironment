...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 40 --ignorenocontextflows --implicitflow --kobjsens 2 --limitcontextforcomplex --limitcontextforgui --multipassfb --precision 3 --preciseinfoflow --pta spark --typesforcontext'
