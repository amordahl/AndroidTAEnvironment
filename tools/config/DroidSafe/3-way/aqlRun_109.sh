...
printf 'DSARGS ?= --apicalldepth 2 --ignorenocontextflows --kobjsens 4 --limitcontextforcomplex --limitcontextforgui --limitcontextforstrings --multipassfb --noclonestatics --nojsa --noscalaropts --nova --precision 1 --pta spark'
