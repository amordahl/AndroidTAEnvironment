...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 40 --ignoreexceptionflows --kobjsens 3 --limitcontextforcomplex --limitcontextforstrings --multipassfb --nofallback --precision 2 --preciseinfoflow --pta geo --trackallflows'
