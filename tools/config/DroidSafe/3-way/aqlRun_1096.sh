...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 40 --ignoreexceptionflows --kobjsens 3 --limitcontextforgui --limitcontextforstrings --noarrayindex --noclonestatics --nova --precision 4 --preciseinfoflow --pta spark --transfertaintfield'
