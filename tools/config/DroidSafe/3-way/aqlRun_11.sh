...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 1 --filetransforms --implicitflow --kobjsens 2 --noarrayindex --nojsa --nova --precision 5 --preciseinfoflow --pta spark --trackallflows --transfertaintfield --typesforcontext'
