...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 2 --filetransforms --ignorenocontextflows --implicitflow --kobjsens 4 --limitcontextforstrings --noarrayindex --noclinitcontext --noclonestatics --noscalaropts --nova --precision 2 --pta geo --typesforcontext'
