...
printf 'DSARGS ?= --apicalldepth 40 --kobjsens 4 --limitcontextforgui --multipassfb --noclinitcontext --noclonestatics --nofallback --noscalaropts --precision 2 --pta spark --trackallflows --transfertaintfield --typesforcontext'
