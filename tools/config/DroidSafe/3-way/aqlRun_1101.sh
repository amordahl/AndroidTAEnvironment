...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 40 --ignoreexceptionflows --ignorenocontextflows --implicitflow --kobjsens 4 --limitcontextforgui --multipassfb --noarrayindex --noclinitcontext --noclonestatics --precision 3 --pta geo --trackallflows'
