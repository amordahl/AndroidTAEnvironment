...
printf 'DSARGS ?= --apicalldepth 40 --ignoreexceptionflows --ignorenocontextflows --kobjsens 4 --limitcontextforcomplex --limitcontextforgui --limitcontextforstrings --multipassfb --nofallback --nojsa --noscalaropts --nova --precision 5 --pta spark --trackallflows'
