...
printf 'DSARGS ?= --apicalldepth 40 --implicitflow --imprecisestrings --kobjsens 5 --limitcontextforcomplex --limitcontextforgui --limitcontextforstrings --noclonestatics --nofallback --noscalaropts --precision 2 --preciseinfoflow --pta spark --typesforcontext'
