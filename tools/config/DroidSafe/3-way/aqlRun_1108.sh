...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 40 --ignorenocontextflows --kobjsens 5 --limitcontextforcomplex --limitcontextforgui --limitcontextforstrings --noscalaropts --nova --precision 4 --pta paddle --trackallflows --typesforcontext'
