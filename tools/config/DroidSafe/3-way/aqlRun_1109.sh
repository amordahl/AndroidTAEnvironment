...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 40 --implicitflow --imprecisestrings --kobjsens 5 --limitcontextforcomplex --limitcontextforstrings --multipassfb --noarrayindex --noclinitcontext --nojsa --noscalaropts --nova --precision 5 --preciseinfoflow --pta paddle --transfertaintfield'
