...
printf 'DSARGS ?= --apicalldepth 40 --ignoreexceptionflows --imprecisestrings --kobjsens 6 --noarrayindex --noclonestatics --nojsa --nova --precision 2 --preciseinfoflow --pta spark --trackallflows'
