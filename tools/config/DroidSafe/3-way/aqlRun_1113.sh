...
printf 'DSARGS ?= --apicalldepth 40 --filetransforms --ignoreexceptionflows --imprecisestrings --kobjsens 6 --limitcontextforcomplex --limitcontextforgui --limitcontextforstrings --multipassfb --noarrayindex --nofallback --precision 3 --preciseinfoflow --pta geo --typesforcontext'
