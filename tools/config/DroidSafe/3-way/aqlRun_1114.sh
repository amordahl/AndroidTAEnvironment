...
printf 'DSARGS ?= --apicalldepth 40 --imprecisestrings --kobjsens 6 --limitcontextforcomplex --limitcontextforgui --multipassfb --noarrayindex --noclinitcontext --nojsa --noscalaropts --nova --precision 4 --pta geo --transfertaintfield --typesforcontext'
