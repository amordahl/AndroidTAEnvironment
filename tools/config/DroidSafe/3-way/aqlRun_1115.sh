...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 40 --filetransforms --kobjsens 6 --limitcontextforcomplex --limitcontextforstrings --multipassfb --noclinitcontext --noclonestatics --nofallback --nojsa --noscalaropts --nova --precision 5 --pta paddle --trackallflows --transfertaintfield'
