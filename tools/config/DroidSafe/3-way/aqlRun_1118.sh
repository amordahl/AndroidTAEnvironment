...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 40 --filetransforms --ignoreexceptionflows --imprecisestrings --kobjsens 7 --limitcontextforgui --noarrayindex --noclinitcontext --noclonestatics --precision 2 --pta spark'
