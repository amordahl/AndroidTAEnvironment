...
printf 'DSARGS ?= --apicalldepth 40 --filetransforms --ignoreexceptionflows --ignorenocontextflows --implicitflow --imprecisestrings --kobjsens 7 --limitcontextforcomplex --limitcontextforgui --noarrayindex --nojsa --precision 3 --preciseinfoflow --pta geo --trackallflows --transfertaintfield'
