...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 2 --imprecisestrings --kobjsens 4 --limitcontextforcomplex --limitcontextforstrings --multipassfb --noclinitcontext --noclonestatics --nofallback --nojsa --noscalaropts --precision 4 --pta geo --trackallflows'
