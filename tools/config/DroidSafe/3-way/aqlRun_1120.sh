...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 40 --filetransforms --ignoreexceptionflows --implicitflow --kobjsens 7 --limitcontextforcomplex --noarrayindex --nofallback --nojsa --nova --precision 4 --pta spark --trackallflows'
