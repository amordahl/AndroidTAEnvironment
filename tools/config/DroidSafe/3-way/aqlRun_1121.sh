...
printf 'DSARGS ?= --apicalldepth 40 --imprecisestrings --kobjsens 7 --limitcontextforgui --limitcontextforstrings --multipassfb --noarrayindex --noclonestatics --nofallback --nojsa --noscalaropts --nova --precision 5 --pta spark --trackallflows --typesforcontext'
