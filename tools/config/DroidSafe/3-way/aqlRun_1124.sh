...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 40 --ignoreexceptionflows --implicitflow --kobjsens 8 --limitcontextforcomplex --limitcontextforstrings --noclinitcontext --noscalaropts --precision 2 --preciseinfoflow --pta spark --trackallflows'
