...
printf 'DSARGS ?= --apicalldepth 2 --filetransforms --ignoreexceptionflows --ignorenocontextflows --kobjsens 4 --noarrayindex --nofallback --nojsa --nova --precision 5 --preciseinfoflow --pta paddle --transfertaintfield --typesforcontext'
