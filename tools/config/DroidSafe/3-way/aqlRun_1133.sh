...
printf 'DSARGS ?= --apicalldepth 40 --ignorenocontextflows --imprecisestrings --kobjsens 9 --limitcontextforcomplex --limitcontextforgui --limitcontextforstrings --noarrayindex --noclinitcontext --noscalaropts --precision 5 --preciseinfoflow --pta paddle --trackallflows --typesforcontext'
