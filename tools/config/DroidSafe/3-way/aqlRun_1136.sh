...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 40 --filetransforms --ignoreexceptionflows --implicitflow --kobjsens 10 --limitcontextforgui --multipassfb --noclonestatics --nojsa --nova --precision 2 --pta spark'
