...
printf 'DSARGS ?= --apicalldepth 40 --ignoreexceptionflows --imprecisestrings --kobjsens 10 --limitcontextforcomplex --limitcontextforstrings --multipassfb --noarrayindex --noclonestatics --nofallback --precision 3 --pta spark --trackallflows --typesforcontext'
