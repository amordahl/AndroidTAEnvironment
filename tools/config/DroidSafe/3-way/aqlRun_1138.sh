...
printf 'DSARGS ?= --apicalldepth 40 --ignoreexceptionflows --ignorenocontextflows --imprecisestrings --kobjsens 10 --limitcontextforcomplex --noclinitcontext --noclonestatics --precision 4 --preciseinfoflow --pta geo'
