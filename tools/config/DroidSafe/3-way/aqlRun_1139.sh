...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 40 --ignoreexceptionflows --ignorenocontextflows --implicitflow --imprecisestrings --kobjsens 10 --multipassfb --noarrayindex --noclinitcontext --nofallback --nova --precision 5 --preciseinfoflow --pta geo --transfertaintfield'
