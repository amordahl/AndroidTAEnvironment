...
printf 'DSARGS ?= --apicalldepth 40 --filetransforms --ignoreexceptionflows --ignorenocontextflows --kobjsens 20 --limitcontextforcomplex --limitcontextforstrings --noclinitcontext --noclonestatics --nojsa --nova --precision 2 --preciseinfoflow --pta spark --trackallflows'
