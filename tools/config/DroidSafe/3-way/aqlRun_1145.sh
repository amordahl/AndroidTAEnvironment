...
printf 'DSARGS ?= --apicalldepth 40 --filetransforms --ignorenocontextflows --kobjsens 20 --limitcontextforcomplex --limitcontextforgui --limitcontextforstrings --noarrayindex --noclinitcontext --nojsa --noscalaropts --precision 5 --pta geo'
