...
printf 'DSARGS ?= --apicalldepth 40 --filetransforms --implicitflow --kobjsens 30 --limitcontextforcomplex --multipassfb --noarrayindex --nojsa --noscalaropts --nova --precision 2 --pta spark --trackallflows --transfertaintfield'
