...
printf 'DSARGS ?= --apicalldepth 40 --ignorenocontextflows --kobjsens 30 --limitcontextforgui --limitcontextforstrings --multipassfb --nofallback --noscalaropts --precision 3 --preciseinfoflow --pta geo --trackallflows'
