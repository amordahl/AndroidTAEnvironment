...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 2 --imprecisestrings --kobjsens 5 --limitcontextforgui --noscalaropts --precision 1 --pta spark --transfertaintfield --typesforcontext'
