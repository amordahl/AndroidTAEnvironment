...
printf 'DSARGS ?= --apicalldepth 40 --kobjsens 30 --limitcontextforcomplex --multipassfb --noarrayindex --noclonestatics --nofallback --nojsa --noscalaropts --precision 4 --preciseinfoflow --pta paddle --trackallflows --transfertaintfield --typesforcontext'
