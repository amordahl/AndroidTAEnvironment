...
printf 'DSARGS ?= --apicalldepth 40 --ignoreexceptionflows --implicitflow --imprecisestrings --kobjsens 30 --limitcontextforcomplex --limitcontextforstrings --multipassfb --noarrayindex --noclinitcontext --noclonestatics --nofallback --nova --precision 5 --preciseinfoflow --pta geo --trackallflows --transfertaintfield --typesforcontext'
