...
printf 'DSARGS ?= --apicalldepth 40 --filetransforms --kobjsens 40 --limitcontextforstrings --noarrayindex --noclinitcontext --noclonestatics --nova --precision 2 --pta spark --transfertaintfield'
