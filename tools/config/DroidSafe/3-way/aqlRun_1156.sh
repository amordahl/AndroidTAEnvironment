...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 40 --ignorenocontextflows --implicitflow --kobjsens 40 --limitcontextforcomplex --limitcontextforstrings --multipassfb --noarrayindex --noclinitcontext --nojsa --noscalaropts --nova --precision 4 --preciseinfoflow --pta geo --transfertaintfield'
