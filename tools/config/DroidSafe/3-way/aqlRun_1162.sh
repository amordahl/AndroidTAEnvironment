...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 40 --ignorenocontextflows --imprecisestrings --kobjsens 50 --limitcontextforgui --limitcontextforstrings --noclonestatics --nojsa --nova --precision 4 --preciseinfoflow --pta geo --trackallflows'
