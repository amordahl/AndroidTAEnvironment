...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 40 --filetransforms --ignorenocontextflows --imprecisestrings --kobjsens 50 --limitcontextforcomplex --limitcontextforstrings --multipassfb --noclonestatics --nofallback --nojsa --precision 5 --pta paddle --trackallflows --transfertaintfield'
