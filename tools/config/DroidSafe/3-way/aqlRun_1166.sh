...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 40 --ignorenocontextflows --kobjsens 100 --limitcontextforcomplex --limitcontextforgui --multipassfb --noarrayindex --nofallback --nojsa --noscalaropts --precision 2 --preciseinfoflow --pta spark'
