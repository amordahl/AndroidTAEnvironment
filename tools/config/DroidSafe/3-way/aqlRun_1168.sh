...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 40 --ignorenocontextflows --implicitflow --imprecisestrings --kobjsens 100 --limitcontextforgui --multipassfb --nofallback --precision 4 --pta paddle --transfertaintfield --typesforcontext'
