...
printf 'DSARGS ?= --apicalldepth 40 --kobjsens 100 --limitcontextforgui --limitcontextforstrings --multipassfb --noarrayindex --noclinitcontext --nofallback --precision 5 --preciseinfoflow --pta geo --trackallflows --transfertaintfield --typesforcontext'
