...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 2 --ignorenocontextflows --imprecisestrings --kobjsens 5 --limitcontextforgui --limitcontextforstrings --noarrayindex --noclinitcontext --noscalaropts --precision 3 --preciseinfoflow --pta geo --transfertaintfield'
