...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 50 --filetransforms --ignorenocontextflows --implicitflow --kobjsens 1 --limitcontextforcomplex --limitcontextforstrings --multipassfb --noarrayindex --nofallback --nojsa --nova --precision 4 --pta paddle --transfertaintfield --typesforcontext'
