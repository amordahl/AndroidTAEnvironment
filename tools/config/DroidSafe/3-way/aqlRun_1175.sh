...
printf 'DSARGS ?= --apicalldepth 50 --imprecisestrings --kobjsens 1 --limitcontextforgui --noclinitcontext --noclonestatics --noscalaropts --precision 5 --preciseinfoflow --pta geo --trackallflows'
