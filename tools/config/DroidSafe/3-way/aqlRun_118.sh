...
printf 'DSARGS ?= --apicalldepth 2 --filetransforms --ignoreexceptionflows --ignorenocontextflows --implicitflow --imprecisestrings --kobjsens 5 --multipassfb --noclinitcontext --noclonestatics --precision 4 --preciseinfoflow --pta spark --typesforcontext'
