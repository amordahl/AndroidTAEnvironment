...
printf 'DSARGS ?= --apicalldepth 50 --ignoreexceptionflows --imprecisestrings --kobjsens 2 --noclinitcontext --noclonestatics --nofallback --noscalaropts --precision 4 --pta geo --trackallflows --transfertaintfield'
