...
printf 'DSARGS ?= --apicalldepth 50 --ignoreexceptionflows --ignorenocontextflows --implicitflow --kobjsens 3 --limitcontextforgui --limitcontextforstrings --noclinitcontext --nojsa --nova --precision 4 --preciseinfoflow --pta spark --trackallflows'
