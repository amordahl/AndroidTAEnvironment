...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 50 --filetransforms --ignoreexceptionflows --ignorenocontextflows --kobjsens 3 --nofallback --nojsa --noscalaropts --nova --precision 5 --pta spark --typesforcontext'
