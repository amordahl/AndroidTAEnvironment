...
printf 'DSARGS ?= --apicalldepth 50 --ignoreexceptionflows --ignorenocontextflows --kobjsens 4 --limitcontextforgui --limitcontextforstrings --multipassfb --noclinitcontext --nofallback --noscalaropts --nova --precision 1 --pta paddle --trackallflows --transfertaintfield'
