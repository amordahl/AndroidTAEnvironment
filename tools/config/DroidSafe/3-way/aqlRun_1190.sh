...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 50 --filetransforms --kobjsens 4 --limitcontextforstrings --multipassfb --noclinitcontext --nofallback --nojsa --precision 2 --preciseinfoflow --pta spark'
