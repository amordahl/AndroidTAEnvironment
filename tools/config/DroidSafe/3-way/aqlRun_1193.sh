...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 50 --ignoreexceptionflows --kobjsens 4 --limitcontextforcomplex --noclonestatics --nofallback --noscalaropts --precision 5 --preciseinfoflow --pta paddle'
