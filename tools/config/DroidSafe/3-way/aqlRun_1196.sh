...
printf 'DSARGS ?= --apicalldepth 50 --ignorenocontextflows --implicitflow --kobjsens 5 --limitcontextforgui --limitcontextforstrings --nofallback --noscalaropts --precision 2 --preciseinfoflow --pta spark --trackallflows --transfertaintfield'
