...
printf 'DSARGS ?= --apicalldepth 50 --ignoreexceptionflows --ignorenocontextflows --implicitflow --kobjsens 5 --limitcontextforgui --multipassfb --precision 3 --pta spark --transfertaintfield'
