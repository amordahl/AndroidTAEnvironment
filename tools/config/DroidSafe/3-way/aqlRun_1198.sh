...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 50 --implicitflow --kobjsens 5 --limitcontextforgui --noarrayindex --noclonestatics --noscalaropts --precision 4 --pta spark --trackallflows --transfertaintfield --typesforcontext'
