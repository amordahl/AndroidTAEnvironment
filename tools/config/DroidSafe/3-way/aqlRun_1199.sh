...
printf 'DSARGS ?= --apicalldepth 50 --filetransforms --ignoreexceptionflows --ignorenocontextflows --implicitflow --kobjsens 5 --multipassfb --noarrayindex --nofallback --nojsa --noscalaropts --nova --precision 5 --pta geo --typesforcontext'
