...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 1 --filetransforms --kobjsens 3 --limitcontextforstrings --multipassfb --noclinitcontext --nofallback --precision 0 --preciseinfoflow --pta geo --trackallflows'
