...
printf 'DSARGS ?= --apicalldepth 2 --ignoreexceptionflows --ignorenocontextflows --implicitflow --kobjsens 6 --limitcontextforgui --limitcontextforstrings --nofallback --nojsa --precision 0 --preciseinfoflow --pta paddle --trackallflows --transfertaintfield --typesforcontext'
