...
printf 'DSARGS ?= --apicalldepth 50 --ignorenocontextflows --kobjsens 6 --limitcontextforcomplex --limitcontextforstrings --multipassfb --noarrayindex --noclinitcontext --nofallback --noscalaropts --nova --precision 2 --pta spark'
