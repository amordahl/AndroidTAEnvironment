...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 50 --ignorenocontextflows --imprecisestrings --kobjsens 6 --limitcontextforcomplex --limitcontextforgui --limitcontextforstrings --multipassfb --noarrayindex --noclonestatics --nofallback --nojsa --precision 3 --preciseinfoflow --pta paddle --transfertaintfield --typesforcontext'
