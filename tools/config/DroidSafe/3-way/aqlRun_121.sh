...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 2 --filetransforms --imprecisestrings --kobjsens 6 --limitcontextforcomplex --limitcontextforgui --multipassfb --noclonestatics --nofallback --nojsa --nova --precision 1 --pta spark --typesforcontext'
