...
printf 'DSARGS ?= --apicalldepth 50 --implicitflow --imprecisestrings --kobjsens 7 --limitcontextforcomplex --limitcontextforgui --limitcontextforstrings --noclinitcontext --noclonestatics --nova --precision 4 --pta spark --trackallflows --transfertaintfield'
