...
printf 'DSARGS ?= --apicalldepth 50 --filetransforms --ignorenocontextflows --kobjsens 7 --limitcontextforgui --limitcontextforstrings --noarrayindex --noclinitcontext --noclonestatics --nofallback --nojsa --precision 5 --preciseinfoflow --pta paddle --typesforcontext'
