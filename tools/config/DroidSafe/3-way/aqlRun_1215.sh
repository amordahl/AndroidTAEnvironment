...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 50 --filetransforms --ignorenocontextflows --kobjsens 8 --limitcontextforgui --noarrayindex --noclonestatics --nojsa --noscalaropts --precision 3 --pta spark --typesforcontext'
