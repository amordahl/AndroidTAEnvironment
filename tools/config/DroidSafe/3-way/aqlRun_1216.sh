...
printf 'DSARGS ?= --apicalldepth 50 --filetransforms --ignoreexceptionflows --kobjsens 8 --noarrayindex --noclinitcontext --nofallback --nojsa --nova --precision 4 --pta geo --transfertaintfield'
