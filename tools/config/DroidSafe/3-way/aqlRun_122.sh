...
printf 'DSARGS ?= --apicalldepth 2 --filetransforms --implicitflow --kobjsens 6 --limitcontextforcomplex --noarrayindex --noclinitcontext --nojsa --noscalaropts --nova --precision 2 --pta geo --transfertaintfield'
