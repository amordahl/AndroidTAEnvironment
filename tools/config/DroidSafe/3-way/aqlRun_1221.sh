...
printf 'DSARGS ?= --apicalldepth 50 --filetransforms --ignorenocontextflows --kobjsens 9 --limitcontextforstrings --multipassfb --noarrayindex --noscalaropts --nova --precision 3 --preciseinfoflow --pta paddle --transfertaintfield'
