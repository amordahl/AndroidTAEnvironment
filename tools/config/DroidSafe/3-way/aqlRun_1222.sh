...
printf 'DSARGS ?= --apicalldepth 50 --filetransforms --ignoreexceptionflows --ignorenocontextflows --implicitflow --kobjsens 9 --noclonestatics --nofallback --nojsa --nova --precision 4 --pta spark --transfertaintfield --typesforcontext'
