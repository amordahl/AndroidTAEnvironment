...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 50 --ignorenocontextflows --implicitflow --kobjsens 10 --limitcontextforcomplex --limitcontextforgui --noarrayindex --noclinitcontext --nojsa --nova --precision 2 --preciseinfoflow --pta spark --typesforcontext'
