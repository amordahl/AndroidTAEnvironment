...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 50 --filetransforms --ignoreexceptionflows --ignorenocontextflows --imprecisestrings --kobjsens 10 --limitcontextforstrings --noarrayindex --noclinitcontext --nofallback --noscalaropts --precision 3 --pta geo --typesforcontext'
