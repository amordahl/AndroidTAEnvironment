...
printf 'DSARGS ?= --apicalldepth 50 --ignoreexceptionflows --implicitflow --kobjsens 10 --limitcontextforgui --limitcontextforstrings --nofallback --precision 4 --preciseinfoflow --pta geo --trackallflows'
