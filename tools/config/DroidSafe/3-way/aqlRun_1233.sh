...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 50 --imprecisestrings --kobjsens 20 --limitcontextforcomplex --limitcontextforgui --limitcontextforstrings --noclonestatics --nojsa --precision 3 --pta geo --trackallflows'
