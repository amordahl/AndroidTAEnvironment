...
printf 'DSARGS ?= --apicalldepth 50 --filetransforms --ignoreexceptionflows --implicitflow --kobjsens 20 --limitcontextforcomplex --limitcontextforgui --limitcontextforstrings --multipassfb --noarrayindex --noclinitcontext --precision 4 --pta geo --trackallflows --typesforcontext'
