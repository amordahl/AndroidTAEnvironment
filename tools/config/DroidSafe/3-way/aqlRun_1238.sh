...
printf 'DSARGS ?= --apicalldepth 50 --implicitflow --imprecisestrings --kobjsens 30 --limitcontextforcomplex --limitcontextforstrings --noarrayindex --noclinitcontext --nojsa --nova --precision 2 --preciseinfoflow --pta spark --transfertaintfield --typesforcontext'
