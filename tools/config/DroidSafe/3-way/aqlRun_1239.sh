...
printf 'DSARGS ?= --apicalldepth 50 --filetransforms --ignoreexceptionflows --ignorenocontextflows --implicitflow --kobjsens 30 --limitcontextforcomplex --noarrayindex --noclinitcontext --nofallback --nojsa --precision 3 --preciseinfoflow --pta spark --trackallflows'
