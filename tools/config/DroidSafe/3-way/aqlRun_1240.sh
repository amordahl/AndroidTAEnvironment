...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 50 --filetransforms --implicitflow --imprecisestrings --kobjsens 30 --limitcontextforgui --noclonestatics --noscalaropts --precision 4 --pta spark --trackallflows --transfertaintfield'
