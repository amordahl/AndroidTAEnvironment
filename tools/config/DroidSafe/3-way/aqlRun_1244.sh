...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 50 --filetransforms --ignoreexceptionflows --imprecisestrings --kobjsens 40 --limitcontextforstrings --noarrayindex --noclinitcontext --noclonestatics --nojsa --noscalaropts --nova --precision 2 --preciseinfoflow --pta spark --trackallflows --transfertaintfield --typesforcontext'
