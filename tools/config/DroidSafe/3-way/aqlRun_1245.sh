...
printf 'DSARGS ?= --apicalldepth 50 --implicitflow --imprecisestrings --kobjsens 40 --limitcontextforcomplex --limitcontextforstrings --multipassfb --noarrayindex --noclinitcontext --noclonestatics --nofallback --nova --precision 3 --pta paddle --trackallflows --transfertaintfield --typesforcontext'
