...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 50 --ignoreexceptionflows --implicitflow --imprecisestrings --kobjsens 40 --limitcontextforgui --limitcontextforstrings --multipassfb --noarrayindex --nofallback --nojsa --precision 4 --pta spark'
