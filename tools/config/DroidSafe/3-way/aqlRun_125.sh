...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 2 --ignoreexceptionflows --implicitflow --imprecisestrings --kobjsens 6 --limitcontextforcomplex --limitcontextforstrings --multipassfb --noarrayindex --nojsa --noscalaropts --precision 5 --pta spark --trackallflows --transfertaintfield'
