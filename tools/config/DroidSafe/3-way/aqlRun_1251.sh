...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 50 --filetransforms --ignoreexceptionflows --ignorenocontextflows --imprecisestrings --kobjsens 50 --limitcontextforstrings --noclinitcontext --noclonestatics --nova --precision 3 --pta geo --transfertaintfield'
