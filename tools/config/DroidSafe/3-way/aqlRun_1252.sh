...
printf 'DSARGS ?= --apicalldepth 50 --ignoreexceptionflows --ignorenocontextflows --imprecisestrings --kobjsens 50 --limitcontextforcomplex --limitcontextforstrings --multipassfb --noscalaropts --precision 4 --preciseinfoflow --pta geo --trackallflows'
