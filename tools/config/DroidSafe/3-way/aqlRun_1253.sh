...
printf 'DSARGS ?= --apicalldepth 50 --kobjsens 50 --limitcontextforstrings --multipassfb --noclinitcontext --noclonestatics --nojsa --noscalaropts --nova --precision 5 --pta geo --typesforcontext'
