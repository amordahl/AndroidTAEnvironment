...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 50 --filetransforms --implicitflow --imprecisestrings --kobjsens 100 --limitcontextforcomplex --noarrayindex --noclonestatics --nojsa --precision 0 --preciseinfoflow --pta geo --typesforcontext'
