...
printf 'DSARGS ?= --apicalldepth 50 --filetransforms --ignoreexceptionflows --ignorenocontextflows --imprecisestrings --kobjsens 100 --limitcontextforgui --multipassfb --noarrayindex --noclinitcontext --noclonestatics --precision 2 --pta spark --trackallflows --typesforcontext'
