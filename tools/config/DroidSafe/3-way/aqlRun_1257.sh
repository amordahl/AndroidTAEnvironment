...
printf 'DSARGS ?= --apicalldepth 50 --filetransforms --ignoreexceptionflows --ignorenocontextflows --implicitflow --kobjsens 100 --limitcontextforcomplex --limitcontextforstrings --noclinitcontext --nofallback --nojsa --precision 3 --preciseinfoflow --pta geo --typesforcontext'
