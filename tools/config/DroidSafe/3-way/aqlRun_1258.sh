...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 50 --implicitflow --kobjsens 100 --limitcontextforcomplex --nofallback --nojsa --noscalaropts --nova --precision 4 --pta spark'
