...
printf 'DSARGS ?= --apicalldepth 50 --filetransforms --ignoreexceptionflows --ignorenocontextflows --implicitflow --kobjsens 100 --multipassfb --noarrayindex --noclonestatics --noscalaropts --precision 5 --pta paddle --trackallflows'
