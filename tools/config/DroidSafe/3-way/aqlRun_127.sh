...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 2 --filetransforms --implicitflow --kobjsens 7 --limitcontextforgui --limitcontextforstrings --noclinitcontext --nova --precision 1 --pta spark'
