...
printf 'DSARGS ?= --apicalldepth 100 --filetransforms --ignoreexceptionflows --ignorenocontextflows --implicitflow --imprecisestrings --kobjsens 3 --limitcontextforcomplex --multipassfb --noclinitcontext --nojsa --precision 1 --pta spark --trackallflows --typesforcontext'
