...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 100 --kobjsens 3 --limitcontextforgui --limitcontextforstrings --multipassfb --precision 2 --pta geo --trackallflows --typesforcontext'
