...
printf 'DSARGS ?= --apicalldepth 100 --ignoreexceptionflows --imprecisestrings --kobjsens 3 --limitcontextforcomplex --limitcontextforstrings --multipassfb --noarrayindex --noclinitcontext --noclonestatics --nofallback --nojsa --noscalaropts --precision 3 --pta paddle --transfertaintfield'
