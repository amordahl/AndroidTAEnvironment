...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 100 --ignoreexceptionflows --imprecisestrings --kobjsens 3 --limitcontextforstrings --noarrayindex --noscalaropts --nova --precision 5 --preciseinfoflow --pta spark'
