...
printf 'DSARGS ?= --apicalldepth 2 --filetransforms --ignorenocontextflows --imprecisestrings --kobjsens 7 --limitcontextforcomplex --limitcontextforgui --limitcontextforstrings --noarrayindex --noclonestatics --nofallback --nojsa --precision 2 --pta paddle --trackallflows'
