...
printf 'DSARGS ?= --apicalldepth 100 --filetransforms --imprecisestrings --kobjsens 4 --limitcontextforgui --multipassfb --noarrayindex --noclinitcontext --noclonestatics --nofallback --noscalaropts --precision 3 --pta spark --typesforcontext'
