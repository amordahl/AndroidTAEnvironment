...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 100 --filetransforms --ignoreexceptionflows --ignorenocontextflows --kobjsens 4 --noclinitcontext --nova --precision 4 --pta paddle'
