...
printf 'DSARGS ?= --apicalldepth 100 --ignorenocontextflows --kobjsens 5 --multipassfb --nojsa --noscalaropts --nova --precision 2 --preciseinfoflow --pta spark --transfertaintfield --typesforcontext'
