...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 100 --filetransforms --ignorenocontextflows --kobjsens 5 --limitcontextforgui --nofallback --nojsa --noscalaropts --precision 3 --pta paddle --trackallflows'
