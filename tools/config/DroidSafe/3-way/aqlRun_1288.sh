...
printf 'DSARGS ?= --apicalldepth 100 --filetransforms --ignoreexceptionflows --implicitflow --imprecisestrings --kobjsens 5 --limitcontextforgui --multipassfb --nojsa --noscalaropts --precision 4 --preciseinfoflow --pta paddle --trackallflows'
