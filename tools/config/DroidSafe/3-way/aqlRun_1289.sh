...
printf 'DSARGS ?= --apicalldepth 100 --filetransforms --ignoreexceptionflows --ignorenocontextflows --implicitflow --imprecisestrings --kobjsens 5 --limitcontextforstrings --multipassfb --noarrayindex --noclonestatics --nofallback --precision 5 --pta spark --trackallflows --typesforcontext'
