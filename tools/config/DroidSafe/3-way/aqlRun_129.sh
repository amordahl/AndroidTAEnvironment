...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 2 --ignoreexceptionflows --implicitflow --imprecisestrings --kobjsens 7 --multipassfb --nofallback --noscalaropts --nova --precision 3 --pta geo --typesforcontext'
