...
printf 'DSARGS ?= --apicalldepth 100 --ignoreexceptionflows --ignorenocontextflows --kobjsens 6 --limitcontextforcomplex --limitcontextforgui --noclinitcontext --nofallback --noscalaropts --nova --precision 3 --preciseinfoflow --pta geo --transfertaintfield'
