...
printf 'DSARGS ?= --apicalldepth 100 --ignoreexceptionflows --imprecisestrings --kobjsens 6 --limitcontextforcomplex --noclinitcontext --noclonestatics --nofallback --nova --precision 4 --pta geo --typesforcontext'
