...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 100 --filetransforms --implicitflow --kobjsens 6 --limitcontextforgui --multipassfb --noarrayindex --noclinitcontext --noscalaropts --precision 5 --pta spark'
