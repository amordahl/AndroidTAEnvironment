...
printf 'DSARGS ?= --apicalldepth 100 --ignoreexceptionflows --implicitflow --imprecisestrings --kobjsens 7 --limitcontextforcomplex --limitcontextforgui --limitcontextforstrings --noclonestatics --nofallback --nojsa --precision 3 --pta paddle --trackallflows --transfertaintfield'
