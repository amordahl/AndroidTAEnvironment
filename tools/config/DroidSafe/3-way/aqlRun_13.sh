...
printf 'DSARGS ?= --apicalldepth 1 --filetransforms --ignoreexceptionflows --ignorenocontextflows --implicitflow --imprecisestrings --kobjsens 3 --limitcontextforcomplex --limitcontextforstrings --noclonestatics --nofallback --nojsa --noscalaropts --nova --precision 1 --pta paddle --transfertaintfield --typesforcontext'
