...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 100 --filetransforms --ignoreexceptionflows --ignorenocontextflows --imprecisestrings --kobjsens 7 --limitcontextforgui --multipassfb --noclinitcontext --noscalaropts --nova --precision 5 --pta geo --trackallflows --transfertaintfield --typesforcontext'
