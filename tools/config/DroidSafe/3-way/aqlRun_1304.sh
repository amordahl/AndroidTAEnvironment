...
printf 'DSARGS ?= --apicalldepth 100 --ignoreexceptionflows --ignorenocontextflows --imprecisestrings --kobjsens 8 --limitcontextforcomplex --limitcontextforgui --multipassfb --noclonestatics --nojsa --noscalaropts --nova --precision 2 --pta spark --typesforcontext'
