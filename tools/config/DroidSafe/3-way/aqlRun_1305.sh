...
printf 'DSARGS ?= --apicalldepth 100 --ignoreexceptionflows --kobjsens 8 --limitcontextforcomplex --noarrayindex --noclinitcontext --noclonestatics --noscalaropts --precision 3 --pta geo --trackallflows --typesforcontext'
