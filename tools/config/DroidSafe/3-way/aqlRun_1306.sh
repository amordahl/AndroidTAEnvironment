...
printf 'DSARGS ?= --apicalldepth 100 --ignoreexceptionflows --ignorenocontextflows --imprecisestrings --kobjsens 8 --limitcontextforgui --noarrayindex --noclonestatics --nojsa --noscalaropts --nova --precision 4 --pta paddle --trackallflows'
