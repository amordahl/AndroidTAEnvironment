...
printf 'DSARGS ?= --apicalldepth 100 --filetransforms --ignoreexceptionflows --ignorenocontextflows --implicitflow --kobjsens 8 --limitcontextforcomplex --limitcontextforstrings --noclinitcontext --nofallback --precision 5 --pta geo --transfertaintfield'
