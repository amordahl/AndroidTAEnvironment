...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 2 --ignoreexceptionflows --implicitflow --kobjsens 7 --limitcontextforgui --multipassfb --noclinitcontext --nojsa --precision 5 --pta paddle --transfertaintfield'
