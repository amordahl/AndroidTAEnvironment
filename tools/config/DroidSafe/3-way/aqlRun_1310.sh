...
printf 'DSARGS ?= --apicalldepth 100 --filetransforms --implicitflow --kobjsens 9 --limitcontextforgui --multipassfb --noarrayindex --noclonestatics --nojsa --noscalaropts --nova --precision 2 --pta spark'
