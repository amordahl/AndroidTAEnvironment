...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 100 --ignoreexceptionflows --imprecisestrings --kobjsens 9 --limitcontextforgui --limitcontextforstrings --nofallback --nova --precision 3 --preciseinfoflow --pta paddle --transfertaintfield'
