...
printf 'DSARGS ?= --apicalldepth 100 --filetransforms --ignorenocontextflows --imprecisestrings --kobjsens 9 --limitcontextforstrings --noarrayindex --nofallback --nojsa --nova --precision 5 --pta geo --transfertaintfield'
