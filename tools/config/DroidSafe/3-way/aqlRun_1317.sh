...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 100 --filetransforms --ignorenocontextflows --kobjsens 10 --multipassfb --noarrayindex --noclinitcontext --noclonestatics --nofallback --nova --precision 3 --preciseinfoflow --pta spark --typesforcontext'
