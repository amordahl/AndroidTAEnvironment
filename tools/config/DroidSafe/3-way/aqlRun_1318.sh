...
printf 'DSARGS ?= --apicalldepth 100 --implicitflow --imprecisestrings --kobjsens 10 --limitcontextforcomplex --limitcontextforgui --limitcontextforstrings --noclinitcontext --nofallback --nova --precision 4 --pta geo --trackallflows --transfertaintfield --typesforcontext'
