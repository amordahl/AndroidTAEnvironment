...
printf 'DSARGS ?= --apicalldepth 2 --filetransforms --ignorenocontextflows --kobjsens 8 --limitcontextforcomplex --limitcontextforgui --limitcontextforstrings --noclinitcontext --noclonestatics --nofallback --nojsa --noscalaropts --precision 0 --preciseinfoflow --pta paddle --trackallflows'
