...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 100 --filetransforms --ignoreexceptionflows --implicitflow --kobjsens 20 --multipassfb --nofallback --nojsa --noscalaropts --precision 2 --preciseinfoflow --pta spark --trackallflows --typesforcontext'
