...
printf 'DSARGS ?= --apicalldepth 100 --filetransforms --ignoreexceptionflows --kobjsens 30 --noclinitcontext --noclonestatics --precision 2 --pta spark --trackallflows --transfertaintfield --typesforcontext'
