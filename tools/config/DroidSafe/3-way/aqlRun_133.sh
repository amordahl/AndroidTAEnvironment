...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 2 --ignoreexceptionflows --imprecisestrings --kobjsens 8 --multipassfb --noarrayindex --nofallback --noscalaropts --nova --precision 1 --pta spark --transfertaintfield --typesforcontext'
