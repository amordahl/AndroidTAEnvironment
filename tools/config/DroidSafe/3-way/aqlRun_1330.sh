...
printf 'DSARGS ?= --apicalldepth 100 --ignorenocontextflows --implicitflow --imprecisestrings --kobjsens 30 --limitcontextforcomplex --multipassfb --noclinitcontext --nofallback --nojsa --precision 4 --preciseinfoflow --pta spark --transfertaintfield --typesforcontext'
