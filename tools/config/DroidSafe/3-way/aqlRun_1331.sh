...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 100 --ignoreexceptionflows --implicitflow --kobjsens 30 --limitcontextforcomplex --limitcontextforgui --multipassfb --noscalaropts --nova --precision 5 --preciseinfoflow --pta geo --transfertaintfield'
