...
printf 'DSARGS ?= --apicalldepth 100 --filetransforms --implicitflow --kobjsens 40 --limitcontextforgui --multipassfb --noarrayindex --noclonestatics --nojsa --nova --precision 2 --pta spark --trackallflows --transfertaintfield'
