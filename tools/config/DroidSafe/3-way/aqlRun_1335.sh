...
printf 'DSARGS ?= --apicalldepth 100 --implicitflow --kobjsens 40 --multipassfb --noarrayindex --noclinitcontext --noclonestatics --nofallback --noscalaropts --nova --precision 3 --preciseinfoflow --pta spark --transfertaintfield'
