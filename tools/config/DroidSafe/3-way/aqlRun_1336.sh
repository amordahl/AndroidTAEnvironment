...
printf 'DSARGS ?= --apicalldepth 100 --filetransforms --implicitflow --kobjsens 40 --limitcontextforstrings --noarrayindex --noscalaropts --nova --precision 4 --preciseinfoflow --pta paddle --transfertaintfield --typesforcontext'
