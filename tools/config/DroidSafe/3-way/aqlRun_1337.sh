...
printf 'DSARGS ?= --apicalldepth 100 --ignoreexceptionflows --implicitflow --kobjsens 40 --limitcontextforgui --noclonestatics --nova --precision 5 --preciseinfoflow --pta paddle --transfertaintfield --typesforcontext'
