...
printf 'DSARGS ?= --apicalldepth 2 --ignorenocontextflows --implicitflow --kobjsens 8 --limitcontextforcomplex --multipassfb --noclinitcontext --nofallback --nojsa --nova --precision 2 --pta geo --typesforcontext'
