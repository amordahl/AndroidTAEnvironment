...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 100 --filetransforms --ignoreexceptionflows --ignorenocontextflows --imprecisestrings --kobjsens 50 --limitcontextforstrings --noclinitcontext --noscalaropts --nova --precision 2 --pta spark --trackallflows --transfertaintfield'
