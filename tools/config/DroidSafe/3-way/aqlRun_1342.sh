...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 100 --ignoreexceptionflows --implicitflow --imprecisestrings --kobjsens 50 --limitcontextforgui --multipassfb --noarrayindex --noclinitcontext --nofallback --noscalaropts --nova --precision 4 --pta paddle --transfertaintfield --typesforcontext'
