...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 100 --filetransforms --imprecisestrings --kobjsens 50 --limitcontextforstrings --noarrayindex --noclonestatics --nofallback --nojsa --noscalaropts --nova --precision 5 --preciseinfoflow --pta paddle --trackallflows --transfertaintfield --typesforcontext'
