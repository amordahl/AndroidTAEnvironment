...
printf 'DSARGS ?= --apicalldepth 100 --implicitflow --imprecisestrings --kobjsens 100 --limitcontextforcomplex --limitcontextforgui --limitcontextforstrings --noclinitcontext --nojsa --noscalaropts --precision 3 --preciseinfoflow --pta spark'
