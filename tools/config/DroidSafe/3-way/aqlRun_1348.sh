...
printf 'DSARGS ?= --apicalldepth 100 --ignoreexceptionflows --ignorenocontextflows --imprecisestrings --kobjsens 100 --limitcontextforcomplex --limitcontextforgui --multipassfb --noclonestatics --noscalaropts --nova --precision 4 --preciseinfoflow --pta paddle --trackallflows --typesforcontext'
