...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 100 --filetransforms --implicitflow --kobjsens 100 --limitcontextforcomplex --noarrayindex --noclonestatics --nofallback --nojsa --noscalaropts --precision 5 --preciseinfoflow --pta geo --trackallflows'
