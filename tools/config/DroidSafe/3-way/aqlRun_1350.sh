...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 5 --filetransforms --ignoreexceptionflows --implicitflow --imprecisestrings --kobjsens 6 --limitcontextforcomplex --noclinitcontext --nojsa --precision 1 --pta geo --trackallflows --typesforcontext'
