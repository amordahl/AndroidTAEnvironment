...
printf 'DSARGS ?= --apicalldepth 40 --ignorenocontextflows --implicitflow --kobjsens 8 --limitcontextforstrings --multipassfb --noarrayindex --nova --precision 1 --pta geo --trackallflows --transfertaintfield --typesforcontext'
