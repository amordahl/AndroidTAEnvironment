...
printf 'DSARGS ?= --apicalldepth 40 --filetransforms --ignoreexceptionflows --implicitflow --kobjsens 10 --limitcontextforcomplex --limitcontextforstrings --noclinitcontext --noclonestatics --precision 1 --pta geo --trackallflows --typesforcontext'
