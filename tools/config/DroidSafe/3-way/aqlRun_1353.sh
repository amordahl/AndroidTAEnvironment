...
printf 'DSARGS ?= --apicalldepth 40 --filetransforms --ignoreexceptionflows --imprecisestrings --kobjsens 30 --limitcontextforgui --multipassfb --nofallback --precision 1 --preciseinfoflow --pta geo'
