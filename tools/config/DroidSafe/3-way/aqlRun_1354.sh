...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 30 --filetransforms --ignorenocontextflows --implicitflow --kobjsens 50 --limitcontextforcomplex --limitcontextforstrings --noarrayindex --noclonestatics --nofallback --nova --precision 1 --pta geo --trackallflows --transfertaintfield'
