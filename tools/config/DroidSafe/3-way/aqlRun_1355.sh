...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 2 --filetransforms --ignoreexceptionflows --ignorenocontextflows --kobjsens 5 --limitcontextforstrings --multipassfb --noarrayindex --noclonestatics --nofallback --nojsa --noscalaropts --nova --precision 1 --preciseinfoflow --pta geo --trackallflows'
