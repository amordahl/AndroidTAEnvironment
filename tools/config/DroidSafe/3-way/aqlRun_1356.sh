...
printf 'DSARGS ?= --apicalldepth 50 --ignoreexceptionflows --implicitflow --kobjsens 3 --limitcontextforcomplex --limitcontextforgui --noclonestatics --nojsa --precision 1 --pta spark --trackallflows --transfertaintfield --typesforcontext'
