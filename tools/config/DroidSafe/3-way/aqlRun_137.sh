...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 2 --filetransforms --ignorenocontextflows --imprecisestrings --kobjsens 8 --limitcontextforstrings --multipassfb --noarrayindex --nofallback --nojsa --noscalaropts --precision 5 --preciseinfoflow --pta spark --trackallflows'
