...
printf 'DSARGS ?= --apicalldepth 2 --ignoreexceptionflows --ignorenocontextflows --kobjsens 9 --limitcontextforgui --limitcontextforstrings --multipassfb --noclonestatics --nojsa --noscalaropts --nova --precision 0 --preciseinfoflow --pta geo --typesforcontext'
