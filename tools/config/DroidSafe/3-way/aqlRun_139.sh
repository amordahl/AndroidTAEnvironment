...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 2 --filetransforms --implicitflow --imprecisestrings --kobjsens 9 --limitcontextforcomplex --limitcontextforstrings --noarrayindex --noclinitcontext --nofallback --precision 1 --pta spark --trackallflows'
