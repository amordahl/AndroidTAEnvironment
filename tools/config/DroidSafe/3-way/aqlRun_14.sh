...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 1 --ignorenocontextflows --implicitflow --imprecisestrings --kobjsens 3 --limitcontextforgui --noarrayindex --nofallback --noscalaropts --precision 2 --pta spark --typesforcontext'
