...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 2 --ignoreexceptionflows --kobjsens 9 --limitcontextforcomplex --limitcontextforstrings --noclonestatics --nojsa --precision 3 --pta geo --transfertaintfield'
