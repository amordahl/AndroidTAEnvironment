...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 2 --ignoreexceptionflows --ignorenocontextflows --kobjsens 9 --limitcontextforstrings --noarrayindex --noclinitcontext --precision 5 --preciseinfoflow --pta paddle --trackallflows'
