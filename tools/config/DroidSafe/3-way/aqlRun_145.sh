...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 2 --kobjsens 10 --limitcontextforcomplex --limitcontextforgui --multipassfb --noclinitcontext --noclonestatics --precision 1 --pta spark --transfertaintfield'
