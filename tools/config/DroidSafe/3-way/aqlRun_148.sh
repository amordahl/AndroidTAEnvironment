...
printf 'DSARGS ?= --apicalldepth 2 --filetransforms --imprecisestrings --kobjsens 10 --limitcontextforstrings --multipassfb --noclinitcontext --nofallback --nojsa --noscalaropts --nova --precision 4 --pta spark --typesforcontext'
