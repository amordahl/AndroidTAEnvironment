...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 2 --filetransforms --imprecisestrings --kobjsens 20 --limitcontextforcomplex --limitcontextforstrings --noclinitcontext --nojsa --precision 1 --pta spark'
