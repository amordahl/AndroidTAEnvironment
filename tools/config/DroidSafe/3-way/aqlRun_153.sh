...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 2 --ignoreexceptionflows --kobjsens 20 --noarrayindex --nojsa --precision 3 --preciseinfoflow --pta geo --trackallflows --transfertaintfield --typesforcontext'
