...
printf 'DSARGS ?= --apicalldepth 2 --imprecisestrings --kobjsens 20 --limitcontextforgui --limitcontextforstrings --multipassfb --noclinitcontext --noclonestatics --nofallback --nojsa --noscalaropts --nova --precision 4 --pta geo --trackallflows --typesforcontext'
