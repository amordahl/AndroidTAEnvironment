...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 2 --ignoreexceptionflows --ignorenocontextflows --implicitflow --kobjsens 20 --limitcontextforcomplex --noarrayindex --noclinitcontext --precision 5 --pta paddle --transfertaintfield'
