...
printf 'DSARGS ?= --apicalldepth 2 --filetransforms --ignoreexceptionflows --ignorenocontextflows --implicitflow --imprecisestrings --kobjsens 30 --limitcontextforstrings --multipassfb --noarrayindex --noclonestatics --noscalaropts --nova --precision 0 --pta paddle --typesforcontext'
