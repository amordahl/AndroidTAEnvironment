...
printf 'DSARGS ?= --apicalldepth 2 --ignorenocontextflows --implicitflow --imprecisestrings --kobjsens 30 --limitcontextforcomplex --limitcontextforgui --multipassfb --noarrayindex --noclinitcontext --noclonestatics --nofallback --precision 2 --preciseinfoflow --pta geo'
