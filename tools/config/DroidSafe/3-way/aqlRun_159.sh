...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 2 --filetransforms --ignoreexceptionflows --kobjsens 30 --limitcontextforstrings --noarrayindex --noclinitcontext --nofallback --nojsa --noscalaropts --nova --precision 3 --pta paddle'
