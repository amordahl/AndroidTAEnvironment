...
printf 'DSARGS ?= --apicalldepth 2 --filetransforms --imprecisestrings --kobjsens 30 --limitcontextforstrings --multipassfb --noclonestatics --nojsa --noscalaropts --nova --precision 4 --pta spark --trackallflows --transfertaintfield --typesforcontext'
