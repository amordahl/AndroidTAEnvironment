...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 2 --filetransforms --ignoreexceptionflows --ignorenocontextflows --implicitflow --kobjsens 30 --limitcontextforcomplex --limitcontextforgui --noarrayindex --noscalaropts --precision 5 --preciseinfoflow --pta spark --trackallflows'
