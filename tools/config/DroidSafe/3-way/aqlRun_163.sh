...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 2 --filetransforms --imprecisestrings --kobjsens 40 --limitcontextforcomplex --limitcontextforstrings --noclinitcontext --nojsa --noscalaropts --precision 1 --preciseinfoflow --pta spark'
