...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 2 --ignoreexceptionflows --kobjsens 40 --noclinitcontext --nojsa --precision 3 --preciseinfoflow --pta geo --trackallflows --typesforcontext'
