...
printf 'DSARGS ?= --apicalldepth 2 --imprecisestrings --kobjsens 40 --limitcontextforgui --limitcontextforstrings --multipassfb --noclonestatics --nofallback --nojsa --nova --precision 4 --pta geo --trackallflows --transfertaintfield --typesforcontext'
