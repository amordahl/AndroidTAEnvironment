...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 2 --kobjsens 50 --limitcontextforcomplex --limitcontextforgui --noclinitcontext --nofallback --nojsa --precision 1 --pta spark'
