...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 1 --ignorenocontextflows --imprecisestrings --kobjsens 3 --limitcontextforcomplex --limitcontextforstrings --multipassfb --noarrayindex --noclinitcontext --noclonestatics --noscalaropts --nova --precision 5 --pta paddle --trackallflows'
