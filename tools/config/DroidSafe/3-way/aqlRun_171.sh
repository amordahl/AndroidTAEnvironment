...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 2 --filetransforms --ignoreexceptionflows --kobjsens 50 --limitcontextforstrings --noclinitcontext --nofallback --nojsa --noscalaropts --nova --precision 3 --preciseinfoflow --pta paddle --trackallflows'
