...
printf 'DSARGS ?= --apicalldepth 2 --filetransforms --imprecisestrings --kobjsens 50 --limitcontextforstrings --multipassfb --noclonestatics --nojsa --nova --precision 4 --preciseinfoflow --pta spark --trackallflows --transfertaintfield --typesforcontext'
