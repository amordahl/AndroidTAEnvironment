...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 2 --filetransforms --ignoreexceptionflows --ignorenocontextflows --implicitflow --kobjsens 50 --limitcontextforcomplex --limitcontextforgui --noarrayindex --noscalaropts --precision 5 --pta spark'
