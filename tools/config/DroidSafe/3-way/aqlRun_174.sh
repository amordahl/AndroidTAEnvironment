...
printf 'DSARGS ?= --apicalldepth 2 --ignoreexceptionflows --ignorenocontextflows --implicitflow --kobjsens 100 --limitcontextforgui --multipassfb --noarrayindex --noclonestatics --nofallback --noscalaropts --nova --precision 0 --pta geo --trackallflows --typesforcontext'
