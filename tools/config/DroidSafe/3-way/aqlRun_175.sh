...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 2 --filetransforms --imprecisestrings --kobjsens 100 --limitcontextforcomplex --limitcontextforstrings --noclinitcontext --nojsa --precision 1 --preciseinfoflow --pta spark --transfertaintfield'
