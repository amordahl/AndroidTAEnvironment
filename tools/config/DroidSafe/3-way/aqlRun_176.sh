...
printf 'DSARGS ?= --apicalldepth 2 --filetransforms --ignorenocontextflows --implicitflow --imprecisestrings --kobjsens 100 --limitcontextforcomplex --limitcontextforgui --limitcontextforstrings --multipassfb --noarrayindex --noclinitcontext --noclonestatics --nofallback --nova --precision 2 --preciseinfoflow --pta paddle --transfertaintfield'
