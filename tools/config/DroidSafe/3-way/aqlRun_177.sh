...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 2 --ignoreexceptionflows --kobjsens 100 --noclinitcontext --nojsa --noscalaropts --precision 3 --preciseinfoflow --pta geo --trackallflows --typesforcontext'
