...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 2 --ignoreexceptionflows --ignorenocontextflows --implicitflow --kobjsens 100 --limitcontextforcomplex --noarrayindex --noclinitcontext --noscalaropts --precision 5 --pta paddle --transfertaintfield'
