...
printf 'DSARGS ?= --apicalldepth 1 --filetransforms --implicitflow --kobjsens 4 --limitcontextforcomplex --limitcontextforgui --noclonestatics --precision 0 --pta spark --typesforcontext'
