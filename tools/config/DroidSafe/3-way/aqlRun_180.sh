...
printf 'DSARGS ?= --apicalldepth 3 --filetransforms --ignoreexceptionflows --implicitflow --kobjsens 1 --limitcontextforgui --noclonestatics --nofallback --noscalaropts --precision 0 --preciseinfoflow --pta geo --typesforcontext'
