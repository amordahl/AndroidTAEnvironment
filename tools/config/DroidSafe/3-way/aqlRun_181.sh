...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 3 --ignorenocontextflows --imprecisestrings --kobjsens 1 --limitcontextforcomplex --limitcontextforstrings --multipassfb --noarrayindex --noclinitcontext --nojsa --nova --precision 1 --pta spark --trackallflows --transfertaintfield'
