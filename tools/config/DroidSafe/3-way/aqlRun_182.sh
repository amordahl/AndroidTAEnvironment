...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 3 --filetransforms --ignoreexceptionflows --ignorenocontextflows --kobjsens 1 --limitcontextforcomplex --limitcontextforgui --multipassfb --noarrayindex --noclonestatics --nojsa --noscalaropts --precision 2 --pta paddle --trackallflows --typesforcontext'
