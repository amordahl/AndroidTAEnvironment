...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 3 --implicitflow --imprecisestrings --kobjsens 1 --limitcontextforstrings --noclinitcontext --nofallback --nova --precision 3 --preciseinfoflow --pta geo --transfertaintfield'
