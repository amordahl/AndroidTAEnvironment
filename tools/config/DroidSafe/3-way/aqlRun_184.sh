...
printf 'DSARGS ?= --apicalldepth 3 --ignoreexceptionflows --ignorenocontextflows --kobjsens 1 --limitcontextforcomplex --limitcontextforstrings --noarrayindex --noclinitcontext --noclonestatics --nofallback --nojsa --noscalaropts --nova --precision 4 --preciseinfoflow --pta geo --trackallflows'
