...
printf 'DSARGS ?= --apicalldepth 3 --filetransforms --ignoreexceptionflows --kobjsens 2 --limitcontextforgui --limitcontextforstrings --noscalaropts --precision 1 --preciseinfoflow --pta geo --trackallflows --transfertaintfield'
