...
printf 'DSARGS ?= --apicalldepth 3 --implicitflow --kobjsens 2 --limitcontextforstrings --noarrayindex --nofallback --nojsa --nova --precision 2 --preciseinfoflow --pta paddle --typesforcontext'
