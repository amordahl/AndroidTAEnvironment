...
printf 'DSARGS ?= --apicalldepth 3 --filetransforms --ignoreexceptionflows --ignorenocontextflows --kobjsens 2 --limitcontextforcomplex --limitcontextforgui --multipassfb --noclonestatics --nojsa --noscalaropts --precision 3 --preciseinfoflow --pta spark --trackallflows'
