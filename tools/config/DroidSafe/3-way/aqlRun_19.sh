...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 1 --filetransforms --ignoreexceptionflows --imprecisestrings --kobjsens 4 --limitcontextforgui --multipassfb --noarrayindex --noclinitcontext --nofallback --nojsa --noscalaropts --nova --precision 1 --preciseinfoflow --pta geo --trackallflows'
