...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 3 --filetransforms --implicitflow --imprecisestrings --kobjsens 2 --limitcontextforgui --multipassfb --noscalaropts --nova --precision 4 --pta spark --trackallflows --transfertaintfield --typesforcontext'
