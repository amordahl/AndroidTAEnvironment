...
printf 'DSARGS ?= --apicalldepth 3 --ignorenocontextflows --imprecisestrings --kobjsens 3 --limitcontextforcomplex --limitcontextforstrings --multipassfb --noclinitcontext --nova --precision 2 --pta geo --transfertaintfield'
