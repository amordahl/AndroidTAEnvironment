...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 3 --ignorenocontextflows --implicitflow --imprecisestrings --kobjsens 3 --noarrayindex --noclonestatics --noscalaropts --precision 3 --pta paddle --trackallflows --transfertaintfield --typesforcontext'
