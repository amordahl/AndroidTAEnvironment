...
printf 'DSARGS ?= --apicalldepth 3 --filetransforms --ignoreexceptionflows --kobjsens 3 --limitcontextforgui --nojsa --noscalaropts --nova --precision 5 --preciseinfoflow --pta spark --transfertaintfield'
