...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 3 --filetransforms --implicitflow --imprecisestrings --kobjsens 4 --noclonestatics --nofallback --precision 1 --pta paddle'
