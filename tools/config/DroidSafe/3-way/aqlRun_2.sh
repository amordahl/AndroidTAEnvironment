...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 1 --ignoreexceptionflows --implicitflow --kobjsens 1 --limitcontextforcomplex --limitcontextforstrings --noarrayindex --noclonestatics --nojsa --nova --precision 2 --pta geo --trackallflows --typesforcontext'
