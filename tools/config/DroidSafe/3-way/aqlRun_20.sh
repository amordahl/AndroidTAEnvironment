...
printf 'DSARGS ?= --apicalldepth 1 --ignoreexceptionflows --ignorenocontextflows --kobjsens 4 --limitcontextforcomplex --limitcontextforstrings --multipassfb --noclinitcontext --nofallback --nojsa --precision 2 --preciseinfoflow --pta paddle --transfertaintfield'
