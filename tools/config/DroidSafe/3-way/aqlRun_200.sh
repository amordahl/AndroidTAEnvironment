...
printf 'DSARGS ?= --apicalldepth 3 --filetransforms --ignoreexceptionflows --imprecisestrings --kobjsens 4 --limitcontextforgui --nofallback --nojsa --noscalaropts --nova --precision 2 --preciseinfoflow --pta spark --trackallflows --typesforcontext'
