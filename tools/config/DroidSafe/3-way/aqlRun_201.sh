...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 3 --filetransforms --ignoreexceptionflows --implicitflow --kobjsens 4 --limitcontextforcomplex --multipassfb --noarrayindex --noclinitcontext --noclonestatics --nofallback --nojsa --precision 3 --preciseinfoflow --pta geo --typesforcontext'
