...
printf 'DSARGS ?= --apicalldepth 3 --filetransforms --kobjsens 4 --noclonestatics --nofallback --nojsa --precision 4 --preciseinfoflow --pta paddle --transfertaintfield --typesforcontext'
