...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 3 --ignoreexceptionflows --ignorenocontextflows --implicitflow --kobjsens 4 --limitcontextforcomplex --limitcontextforgui --noclinitcontext --noclonestatics --noscalaropts --nova --precision 5 --pta geo --trackallflows --transfertaintfield'
