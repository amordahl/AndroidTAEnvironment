...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 3 --filetransforms --ignorenocontextflows --implicitflow --kobjsens 5 --limitcontextforgui --noclinitcontext --noclonestatics --nojsa --nova --precision 0 --preciseinfoflow --pta paddle --typesforcontext'
