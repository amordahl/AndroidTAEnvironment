...
printf 'DSARGS ?= --apicalldepth 3 --ignoreexceptionflows --implicitflow --imprecisestrings --kobjsens 5 --limitcontextforcomplex --limitcontextforstrings --multipassfb --noarrayindex --nofallback --noscalaropts --precision 1 --pta geo --trackallflows --transfertaintfield'
