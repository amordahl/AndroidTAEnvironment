...
printf 'DSARGS ?= --apicalldepth 3 --ignoreexceptionflows --kobjsens 5 --limitcontextforgui --limitcontextforstrings --multipassfb --noclinitcontext --noclonestatics --noscalaropts --precision 2 --pta spark'
