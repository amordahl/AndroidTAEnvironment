...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 3 --kobjsens 5 --multipassfb --noarrayindex --noclonestatics --nofallback --noscalaropts --nova --precision 4 --preciseinfoflow --pta geo --trackallflows --transfertaintfield --typesforcontext'
