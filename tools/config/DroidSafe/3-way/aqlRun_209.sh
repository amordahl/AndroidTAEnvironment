...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 3 --filetransforms --ignorenocontextflows --imprecisestrings --kobjsens 5 --noarrayindex --noclinitcontext --noclonestatics --nova --precision 5 --preciseinfoflow --pta paddle --trackallflows --transfertaintfield --typesforcontext'
