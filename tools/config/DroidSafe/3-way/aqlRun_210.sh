...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 3 --ignorenocontextflows --implicitflow --imprecisestrings --kobjsens 6 --limitcontextforcomplex --multipassfb --noclinitcontext --noclonestatics --noscalaropts --nova --precision 0 --pta geo --trackallflows --typesforcontext'
