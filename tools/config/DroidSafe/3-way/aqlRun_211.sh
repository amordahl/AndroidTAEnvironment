...
printf 'DSARGS ?= --apicalldepth 3 --filetransforms --ignoreexceptionflows --kobjsens 6 --limitcontextforgui --limitcontextforstrings --noarrayindex --nofallback --nojsa --precision 1 --preciseinfoflow --pta spark --transfertaintfield'
