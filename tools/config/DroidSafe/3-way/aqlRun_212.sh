...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 3 --ignoreexceptionflows --kobjsens 6 --limitcontextforcomplex --limitcontextforstrings --noclinitcontext --nofallback --nova --precision 2 --preciseinfoflow --pta paddle'
