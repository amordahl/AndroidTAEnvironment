...
printf 'DSARGS ?= --apicalldepth 3 --imprecisestrings --kobjsens 6 --limitcontextforcomplex --limitcontextforgui --noarrayindex --noclinitcontext --noclonestatics --nojsa --noscalaropts --precision 3 --pta geo --trackallflows --transfertaintfield'
