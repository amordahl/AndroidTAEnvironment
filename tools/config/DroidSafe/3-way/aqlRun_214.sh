...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 3 --filetransforms --implicitflow --imprecisestrings --kobjsens 6 --limitcontextforcomplex --limitcontextforgui --nojsa --noscalaropts --nova --precision 4 --pta geo --trackallflows --transfertaintfield'
