...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 3 --ignorenocontextflows --implicitflow --kobjsens 7 --limitcontextforstrings --multipassfb --noarrayindex --noclonestatics --noscalaropts --nova --precision 0 --pta paddle --typesforcontext'
