...
printf 'DSARGS ?= --apicalldepth 3 --filetransforms --ignoreexceptionflows --imprecisestrings --kobjsens 7 --limitcontextforcomplex --limitcontextforgui --noclinitcontext --nofallback --nojsa --precision 1 --preciseinfoflow --pta geo --trackallflows --transfertaintfield --typesforcontext'
