...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 3 --ignorenocontextflows --kobjsens 7 --multipassfb --noclonestatics --nofallback --noscalaropts --nova --precision 2 --preciseinfoflow --pta spark --trackallflows --transfertaintfield --typesforcontext'
