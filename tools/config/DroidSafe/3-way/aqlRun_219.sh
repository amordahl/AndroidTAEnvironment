...
printf 'DSARGS ?= --apicalldepth 3 --ignorenocontextflows --imprecisestrings --kobjsens 7 --limitcontextforgui --limitcontextforstrings --noarrayindex --noscalaropts --precision 3 --preciseinfoflow --pta paddle'
