...
printf 'DSARGS ?= --apicalldepth 1 --filetransforms --ignoreexceptionflows --ignorenocontextflows --implicitflow --kobjsens 4 --limitcontextforcomplex --limitcontextforgui --multipassfb --noarrayindex --noscalaropts --nova --precision 4 --pta paddle --trackallflows --transfertaintfield --typesforcontext'
