...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 3 --ignorenocontextflows --implicitflow --kobjsens 7 --limitcontextforgui --limitcontextforstrings --multipassfb --noarrayindex --nofallback --precision 4 --preciseinfoflow --pta spark'
