...
printf 'DSARGS ?= --apicalldepth 3 --ignoreexceptionflows --ignorenocontextflows --imprecisestrings --kobjsens 7 --limitcontextforgui --limitcontextforstrings --noarrayindex --noclonestatics --noscalaropts --nova --precision 5 --pta spark --trackallflows --transfertaintfield'
