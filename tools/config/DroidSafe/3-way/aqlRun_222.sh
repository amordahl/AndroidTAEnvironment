...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 3 --filetransforms --implicitflow --imprecisestrings --kobjsens 8 --limitcontextforcomplex --multipassfb --noarrayindex --nojsa --noscalaropts --nova --precision 0 --pta geo --trackallflows'
