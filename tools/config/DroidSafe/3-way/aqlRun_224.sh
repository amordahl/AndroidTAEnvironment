...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 3 --filetransforms --ignorenocontextflows --imprecisestrings --kobjsens 8 --limitcontextforcomplex --limitcontextforstrings --multipassfb --noarrayindex --noclonestatics --nofallback --nojsa --noscalaropts --nova --precision 2 --preciseinfoflow --pta paddle --trackallflows'
