...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 3 --filetransforms --ignorenocontextflows --kobjsens 8 --multipassfb --nojsa --noscalaropts --precision 3 --preciseinfoflow --pta geo --trackallflows'
