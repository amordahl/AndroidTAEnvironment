...
printf 'DSARGS ?= --apicalldepth 3 --filetransforms --implicitflow --kobjsens 8 --limitcontextforcomplex --multipassfb --noarrayindex --nofallback --nova --precision 4 --preciseinfoflow --pta geo --trackallflows --typesforcontext'
