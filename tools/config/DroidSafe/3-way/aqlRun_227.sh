...
printf 'DSARGS ?= --apicalldepth 3 --filetransforms --ignoreexceptionflows --implicitflow --kobjsens 8 --limitcontextforstrings --noarrayindex --noclinitcontext --noclonestatics --nojsa --precision 5 --pta paddle --transfertaintfield'
