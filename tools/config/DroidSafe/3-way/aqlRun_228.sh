...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 3 --filetransforms --implicitflow --kobjsens 9 --limitcontextforcomplex --noclinitcontext --noscalaropts --precision 0 --pta paddle --trackallflows'
