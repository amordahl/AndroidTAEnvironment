...
printf 'DSARGS ?= --apicalldepth 3 --ignoreexceptionflows --ignorenocontextflows --imprecisestrings --kobjsens 9 --limitcontextforgui --limitcontextforstrings --multipassfb --noarrayindex --noclonestatics --nofallback --nojsa --nova --precision 1 --preciseinfoflow --pta geo --transfertaintfield --typesforcontext'
