...
printf 'DSARGS ?= --apicalldepth 1 --implicitflow --imprecisestrings --kobjsens 4 --limitcontextforgui --limitcontextforstrings --multipassfb --nofallback --precision 5 --preciseinfoflow --pta geo --typesforcontext'
