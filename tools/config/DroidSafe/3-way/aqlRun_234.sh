...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 3 --filetransforms --implicitflow --kobjsens 10 --limitcontextforcomplex --multipassfb --precision 0 --pta geo --trackallflows'
