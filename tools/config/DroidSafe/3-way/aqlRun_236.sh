...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 3 --kobjsens 10 --limitcontextforgui --limitcontextforstrings --noarrayindex --precision 2 --pta paddle --transfertaintfield --typesforcontext'
