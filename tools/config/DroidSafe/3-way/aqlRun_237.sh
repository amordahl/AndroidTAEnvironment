...
printf 'DSARGS ?= --apicalldepth 3 --kobjsens 10 --limitcontextforcomplex --noarrayindex --noclonestatics --nojsa --noscalaropts --nova --precision 3 --preciseinfoflow --pta geo --trackallflows'
