...
printf 'DSARGS ?= --apicalldepth 3 --ignoreexceptionflows --implicitflow --imprecisestrings --kobjsens 10 --limitcontextforstrings --noclinitcontext --noclonestatics --nofallback --precision 4 --pta geo --trackallflows --transfertaintfield'
