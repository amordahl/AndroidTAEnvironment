...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 1 --imprecisestrings --kobjsens 5 --limitcontextforcomplex --multipassfb --noarrayindex --nojsa --noscalaropts --nova --precision 0 --pta spark --transfertaintfield'
