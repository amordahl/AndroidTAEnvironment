...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 3 --filetransforms --imprecisestrings --kobjsens 20 --limitcontextforcomplex --noclonestatics --nojsa --precision 0 --pta paddle --typesforcontext'
