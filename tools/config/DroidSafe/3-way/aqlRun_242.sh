...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 3 --kobjsens 20 --limitcontextforgui --noclinitcontext --noclonestatics --noscalaropts --precision 2 --pta spark --trackallflows --transfertaintfield --typesforcontext'
