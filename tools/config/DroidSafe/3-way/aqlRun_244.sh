...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 3 --filetransforms --imprecisestrings --kobjsens 20 --noarrayindex --noclinitcontext --nofallback --noscalaropts --nova --precision 4 --preciseinfoflow --pta spark --transfertaintfield --typesforcontext'
