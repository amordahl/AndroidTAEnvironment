...
printf 'DSARGS ?= --apicalldepth 3 --filetransforms --ignorenocontextflows --kobjsens 20 --limitcontextforgui --noarrayindex --noclonestatics --nojsa --noscalaropts --nova --precision 5 --pta spark --trackallflows --transfertaintfield --typesforcontext'
