...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 3 --filetransforms --implicitflow --kobjsens 30 --limitcontextforcomplex --multipassfb --noclonestatics --nojsa --precision 0 --preciseinfoflow --pta geo --trackallflows --transfertaintfield'
