...
printf 'DSARGS ?= --apicalldepth 3 --ignoreexceptionflows --ignorenocontextflows --imprecisestrings --kobjsens 30 --limitcontextforgui --limitcontextforstrings --noarrayindex --noclinitcontext --nofallback --nova --precision 1 --pta spark --typesforcontext'
