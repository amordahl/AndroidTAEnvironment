...
printf 'DSARGS ?= --apicalldepth 3 --filetransforms --ignorenocontextflows --implicitflow --kobjsens 30 --limitcontextforgui --noclinitcontext --noclonestatics --nofallback --noscalaropts --nova --precision 2 --pta paddle --transfertaintfield --typesforcontext'
