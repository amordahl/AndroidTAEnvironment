...
printf 'DSARGS ?= --apicalldepth 3 --filetransforms --implicitflow --kobjsens 30 --limitcontextforcomplex --noarrayindex --nojsa --noscalaropts --nova --precision 3 --preciseinfoflow --pta geo --trackallflows --transfertaintfield --typesforcontext'
