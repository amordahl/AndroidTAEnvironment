...
printf 'DSARGS ?= --apicalldepth 1 --filetransforms --ignoreexceptionflows --ignorenocontextflows --kobjsens 5 --limitcontextforgui --limitcontextforstrings --noarrayindex --noclinitcontext --noclonestatics --precision 1 --preciseinfoflow --pta paddle --trackallflows --typesforcontext'
