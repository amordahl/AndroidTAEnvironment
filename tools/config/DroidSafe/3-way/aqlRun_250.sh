...
printf 'DSARGS ?= --apicalldepth 3 --filetransforms --ignoreexceptionflows --ignorenocontextflows --imprecisestrings --kobjsens 30 --limitcontextforgui --nofallback --noscalaropts --nova --precision 4 --pta geo --transfertaintfield --typesforcontext'
