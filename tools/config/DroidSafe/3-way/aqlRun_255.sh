...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 3 --filetransforms --ignorenocontextflows --implicitflow --imprecisestrings --kobjsens 40 --limitcontextforcomplex --limitcontextforstrings --noarrayindex --noclonestatics --nova --precision 3 --pta paddle --trackallflows --typesforcontext'
