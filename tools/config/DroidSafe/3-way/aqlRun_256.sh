...
printf 'DSARGS ?= --apicalldepth 3 --filetransforms --ignoreexceptionflows --ignorenocontextflows --implicitflow --kobjsens 40 --limitcontextforstrings --noarrayindex --noscalaropts --precision 4 --preciseinfoflow --pta spark'
