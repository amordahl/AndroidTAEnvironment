...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 3 --ignoreexceptionflows --ignorenocontextflows --implicitflow --kobjsens 40 --limitcontextforcomplex --limitcontextforgui --limitcontextforstrings --noclonestatics --nofallback --nojsa --noscalaropts --nova --precision 5 --preciseinfoflow --pta spark --trackallflows'
