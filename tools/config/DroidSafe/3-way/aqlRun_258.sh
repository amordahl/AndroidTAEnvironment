...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 3 --filetransforms --implicitflow --kobjsens 50 --limitcontextforcomplex --multipassfb --noclinitcontext --noclonestatics --nojsa --precision 0 --pta geo'
