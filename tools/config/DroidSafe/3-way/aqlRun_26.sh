...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 1 --filetransforms --ignoreexceptionflows --ignorenocontextflows --implicitflow --imprecisestrings --kobjsens 5 --noclinitcontext --nofallback --nova --precision 2 --preciseinfoflow --pta geo --transfertaintfield'
