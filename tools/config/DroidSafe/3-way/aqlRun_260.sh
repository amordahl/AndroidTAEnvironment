...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 3 --filetransforms --ignoreexceptionflows --ignorenocontextflows --kobjsens 50 --limitcontextforgui --limitcontextforstrings --noclonestatics --nofallback --precision 2 --preciseinfoflow --pta paddle --transfertaintfield'
