...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 3 --ignoreexceptionflows --ignorenocontextflows --imprecisestrings --kobjsens 50 --limitcontextforcomplex --limitcontextforgui --multipassfb --noarrayindex --nojsa --precision 3 --pta geo --transfertaintfield --typesforcontext'
