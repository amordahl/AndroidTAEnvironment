...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 3 --filetransforms --ignorenocontextflows --implicitflow --kobjsens 50 --multipassfb --nofallback --nova --precision 4 --preciseinfoflow --pta geo --typesforcontext'
