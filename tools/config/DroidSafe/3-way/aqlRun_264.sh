...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 3 --filetransforms --imprecisestrings --kobjsens 100 --limitcontextforcomplex --noclinitcontext --noclonestatics --nojsa --precision 0 --pta paddle'
