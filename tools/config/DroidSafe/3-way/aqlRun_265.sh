...
printf 'DSARGS ?= --apicalldepth 3 --ignoreexceptionflows --ignorenocontextflows --implicitflow --kobjsens 100 --limitcontextforgui --limitcontextforstrings --multipassfb --noarrayindex --nofallback --noscalaropts --nova --precision 1 --preciseinfoflow --pta geo --trackallflows --transfertaintfield --typesforcontext'
