...
printf 'DSARGS ?= --apicalldepth 3 --ignorenocontextflows --implicitflow --kobjsens 100 --limitcontextforgui --multipassfb --noclonestatics --nofallback --noscalaropts --precision 2 --pta spark'
