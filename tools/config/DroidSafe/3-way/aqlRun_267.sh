...
printf 'DSARGS ?= --apicalldepth 3 --filetransforms --ignoreexceptionflows --implicitflow --imprecisestrings --kobjsens 100 --limitcontextforcomplex --limitcontextforstrings --multipassfb --noarrayindex --nova --precision 3 --pta paddle --transfertaintfield --typesforcontext'
