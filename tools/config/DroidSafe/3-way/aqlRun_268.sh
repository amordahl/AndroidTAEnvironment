...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 3 --ignoreexceptionflows --kobjsens 100 --noclinitcontext --noscalaropts --nova --precision 4 --preciseinfoflow --pta spark'
