...
printf 'DSARGS ?= --apicalldepth 3 --filetransforms --ignoreexceptionflows --implicitflow --imprecisestrings --kobjsens 100 --limitcontextforgui --noarrayindex --noclonestatics --nojsa --precision 5 --pta spark --trackallflows --typesforcontext'
