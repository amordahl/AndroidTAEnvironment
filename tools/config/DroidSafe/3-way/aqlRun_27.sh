...
printf 'DSARGS ?= --apicalldepth 1 --filetransforms --ignoreexceptionflows --implicitflow --kobjsens 5 --limitcontextforcomplex --noclonestatics --nofallback --nojsa --noscalaropts --precision 3 --pta spark --trackallflows --typesforcontext'
