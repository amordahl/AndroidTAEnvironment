...
printf 'DSARGS ?= --apicalldepth 4 --filetransforms --ignoreexceptionflows --imprecisestrings --kobjsens 1 --limitcontextforstrings --multipassfb --noclinitcontext --nova --precision 2 --pta spark --transfertaintfield --typesforcontext'
