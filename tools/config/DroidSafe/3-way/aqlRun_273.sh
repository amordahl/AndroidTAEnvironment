...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 4 --ignorenocontextflows --implicitflow --kobjsens 1 --limitcontextforcomplex --limitcontextforgui --noarrayindex --noclonestatics --nofallback --nojsa --noscalaropts --precision 3 --preciseinfoflow --pta paddle --trackallflows'
