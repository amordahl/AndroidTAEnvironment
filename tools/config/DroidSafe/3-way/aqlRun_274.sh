...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 4 --ignoreexceptionflows --implicitflow --kobjsens 1 --noclinitcontext --noclonestatics --nofallback --precision 4 --pta spark'
