...
printf 'DSARGS ?= --apicalldepth 4 --filetransforms --ignoreexceptionflows --kobjsens 2 --limitcontextforcomplex --limitcontextforgui --multipassfb --noclinitcontext --nojsa --noscalaropts --precision 0 --pta paddle --transfertaintfield --typesforcontext'
