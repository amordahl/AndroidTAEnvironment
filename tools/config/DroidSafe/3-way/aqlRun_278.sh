...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 4 --implicitflow --imprecisestrings --kobjsens 2 --limitcontextforcomplex --limitcontextforgui --multipassfb --noarrayindex --noclonestatics --nofallback --nojsa --precision 2 --pta geo --transfertaintfield'
