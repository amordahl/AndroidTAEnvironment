...
printf 'DSARGS ?= --apicalldepth 4 --filetransforms --ignoreexceptionflows --implicitflow --imprecisestrings --kobjsens 2 --limitcontextforstrings --multipassfb --noarrayindex --noclinitcontext --noscalaropts --precision 3 --preciseinfoflow --pta spark --trackallflows'
