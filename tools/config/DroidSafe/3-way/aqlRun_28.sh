...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 1 --ignorenocontextflows --implicitflow --kobjsens 5 --limitcontextforcomplex --limitcontextforgui --limitcontextforstrings --noclinitcontext --nofallback --nojsa --noscalaropts --nova --precision 4 --preciseinfoflow --pta paddle --trackallflows'
