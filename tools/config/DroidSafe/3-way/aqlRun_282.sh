...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 4 --ignorenocontextflows --implicitflow --kobjsens 3 --limitcontextforgui --limitcontextforstrings --noarrayindex --nofallback --nojsa --nova --precision 0 --pta geo --transfertaintfield --typesforcontext'
