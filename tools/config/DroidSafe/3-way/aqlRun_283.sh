...
printf 'DSARGS ?= --apicalldepth 4 --filetransforms --ignoreexceptionflows --imprecisestrings --kobjsens 3 --limitcontextforcomplex --multipassfb --noclinitcontext --noclonestatics --noscalaropts --precision 1 --preciseinfoflow --pta paddle --trackallflows'
