...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 4 --filetransforms --ignoreexceptionflows --kobjsens 3 --limitcontextforcomplex --multipassfb --nofallback --nojsa --nova --precision 3 --pta geo --transfertaintfield --typesforcontext'
