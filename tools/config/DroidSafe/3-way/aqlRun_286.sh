...
printf 'DSARGS ?= --apicalldepth 4 --filetransforms --ignorenocontextflows --kobjsens 3 --limitcontextforcomplex --limitcontextforstrings --noarrayindex --nofallback --nojsa --precision 4 --preciseinfoflow --pta paddle --typesforcontext'
