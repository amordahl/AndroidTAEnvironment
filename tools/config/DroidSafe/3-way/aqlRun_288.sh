...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 4 --filetransforms --ignorenocontextflows --implicitflow --imprecisestrings --kobjsens 4 --limitcontextforcomplex --noarrayindex --noclinitcontext --precision 0 --preciseinfoflow --pta spark --trackallflows'
