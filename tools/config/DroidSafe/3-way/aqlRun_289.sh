...
printf 'DSARGS ?= --apicalldepth 4 --ignoreexceptionflows --kobjsens 4 --limitcontextforgui --limitcontextforstrings --multipassfb --noclonestatics --nofallback --nojsa --noscalaropts --nova --precision 1 --pta paddle --transfertaintfield --typesforcontext'
