...
printf 'DSARGS ?= --apicalldepth 1 --kobjsens 5 --limitcontextforstrings --multipassfb --noclinitcontext --noclonestatics --nofallback --nojsa --precision 5 --pta geo --transfertaintfield --typesforcontext'
