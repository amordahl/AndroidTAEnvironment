...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 4 --filetransforms --ignorenocontextflows --implicitflow --kobjsens 4 --limitcontextforstrings --noarrayindex --noclinitcontext --noclonestatics --nofallback --nojsa --precision 5 --pta spark --trackallflows --transfertaintfield --typesforcontext'
