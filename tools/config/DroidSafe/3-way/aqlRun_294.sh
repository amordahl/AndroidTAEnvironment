...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 4 --filetransforms --ignorenocontextflows --implicitflow --imprecisestrings --kobjsens 5 --limitcontextforcomplex --noarrayindex --noclinitcontext --nojsa --precision 0 --pta paddle --trackallflows --transfertaintfield'
