...
printf 'DSARGS ?= --apicalldepth 4 --ignoreexceptionflows --kobjsens 5 --limitcontextforgui --limitcontextforstrings --multipassfb --noclonestatics --nofallback --noscalaropts --nova --precision 1 --preciseinfoflow --pta geo --typesforcontext'
