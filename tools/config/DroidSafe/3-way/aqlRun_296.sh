...
printf 'DSARGS ?= --apicalldepth 4 --ignoreexceptionflows --ignorenocontextflows --kobjsens 5 --limitcontextforcomplex --noclonestatics --precision 2 --pta paddle --typesforcontext'
