...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 4 --ignoreexceptionflows --ignorenocontextflows --implicitflow --imprecisestrings --kobjsens 5 --limitcontextforcomplex --limitcontextforgui --limitcontextforstrings --multipassfb --noarrayindex --nofallback --nova --precision 3 --preciseinfoflow --pta spark --typesforcontext'
