...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 4 --filetransforms --ignoreexceptionflows --ignorenocontextflows --kobjsens 5 --limitcontextforgui --limitcontextforstrings --multipassfb --noarrayindex --noclonestatics --nofallback --nojsa --precision 4 --pta geo'
