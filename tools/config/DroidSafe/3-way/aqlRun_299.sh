...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 4 --ignorenocontextflows --imprecisestrings --kobjsens 5 --multipassfb --noclinitcontext --nofallback --noscalaropts --nova --precision 5 --preciseinfoflow --pta spark --trackallflows --transfertaintfield'
