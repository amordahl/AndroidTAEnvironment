...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 1 --filetransforms --ignoreexceptionflows --kobjsens 6 --limitcontextforgui --noarrayindex --nofallback --nojsa --nova --precision 0 --pta spark --transfertaintfield'
