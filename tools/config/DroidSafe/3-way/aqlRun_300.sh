...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 4 --filetransforms --ignorenocontextflows --implicitflow --imprecisestrings --kobjsens 6 --limitcontextforcomplex --noarrayindex --noclinitcontext --nojsa --precision 0 --preciseinfoflow --pta geo --trackallflows --transfertaintfield'
