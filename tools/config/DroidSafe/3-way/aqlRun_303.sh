...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 4 --filetransforms --ignoreexceptionflows --kobjsens 6 --limitcontextforstrings --nofallback --nova --precision 3 --preciseinfoflow --pta geo --trackallflows --typesforcontext'
