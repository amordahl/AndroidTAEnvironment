...
printf 'DSARGS ?= --apicalldepth 4 --filetransforms --ignorenocontextflows --implicitflow --imprecisestrings --kobjsens 6 --limitcontextforcomplex --limitcontextforgui --multipassfb --noarrayindex --noclinitcontext --nofallback --precision 4 --preciseinfoflow --pta spark --transfertaintfield'
