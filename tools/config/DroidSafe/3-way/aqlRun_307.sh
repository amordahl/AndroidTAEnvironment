...
printf 'DSARGS ?= --apicalldepth 4 --ignoreexceptionflows --kobjsens 7 --limitcontextforgui --limitcontextforstrings --multipassfb --noclonestatics --nofallback --noscalaropts --nova --precision 1 --pta paddle --typesforcontext'
