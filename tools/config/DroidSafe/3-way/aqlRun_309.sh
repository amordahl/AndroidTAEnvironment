...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 4 --implicitflow --kobjsens 7 --limitcontextforstrings --noclinitcontext --precision 3 --pta geo --transfertaintfield'
