...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 4 --filetransforms --ignoreexceptionflows --imprecisestrings --kobjsens 7 --limitcontextforcomplex --limitcontextforstrings --multipassfb --noclinitcontext --nojsa --nova --precision 4 --pta spark --transfertaintfield'
