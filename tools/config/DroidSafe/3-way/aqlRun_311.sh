...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 4 --filetransforms --ignoreexceptionflows --ignorenocontextflows --kobjsens 7 --noarrayindex --noclinitcontext --nofallback --noscalaropts --nova --precision 5 --preciseinfoflow --pta paddle --typesforcontext'
