...
printf 'DSARGS ?= --apicalldepth 4 --ignoreexceptionflows --kobjsens 8 --limitcontextforcomplex --limitcontextforgui --limitcontextforstrings --multipassfb --noclonestatics --nofallback --noscalaropts --nova --precision 1 --pta paddle --typesforcontext'
