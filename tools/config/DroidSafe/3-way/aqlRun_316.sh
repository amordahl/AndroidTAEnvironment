...
printf 'DSARGS ?= --apicalldepth 4 --filetransforms --ignoreexceptionflows --imprecisestrings --kobjsens 8 --limitcontextforgui --limitcontextforstrings --noclinitcontext --noclonestatics --nofallback --precision 4 --preciseinfoflow --pta paddle --trackallflows'
