...
printf 'DSARGS ?= --apicalldepth 4 --filetransforms --ignoreexceptionflows --imprecisestrings --kobjsens 8 --limitcontextforcomplex --multipassfb --noclonestatics --nofallback --noscalaropts --nova --precision 5 --preciseinfoflow --pta geo --transfertaintfield'
