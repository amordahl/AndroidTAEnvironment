...
printf 'DSARGS ?= --apicalldepth 4 --filetransforms --ignoreexceptionflows --ignorenocontextflows --implicitflow --kobjsens 9 --limitcontextforcomplex --multipassfb --noclinitcontext --noscalaropts --precision 2 --preciseinfoflow --pta spark --trackallflows --transfertaintfield'
