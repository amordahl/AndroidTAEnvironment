...
printf 'DSARGS ?= --apicalldepth 4 --ignoreexceptionflows --ignorenocontextflows --implicitflow --imprecisestrings --kobjsens 9 --limitcontextforcomplex --limitcontextforstrings --multipassfb --noarrayindex --noclinitcontext --noclonestatics --nojsa --noscalaropts --precision 3 --pta spark'
