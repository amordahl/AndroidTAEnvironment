...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 4 --ignoreexceptionflows --ignorenocontextflows --implicitflow --imprecisestrings --kobjsens 9 --limitcontextforcomplex --noclinitcontext --noclonestatics --nofallback --nojsa --noscalaropts --precision 4 --preciseinfoflow --pta spark --transfertaintfield'
