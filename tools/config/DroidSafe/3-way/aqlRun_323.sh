...
printf 'DSARGS ?= --apicalldepth 4 --filetransforms --ignoreexceptionflows --ignorenocontextflows --kobjsens 9 --limitcontextforgui --multipassfb --noarrayindex --nojsa --nova --precision 5 --pta spark --typesforcontext'
