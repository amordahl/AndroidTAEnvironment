...
printf 'DSARGS ?= --apicalldepth 4 --ignoreexceptionflows --kobjsens 10 --limitcontextforgui --limitcontextforstrings --multipassfb --noscalaropts --nova --precision 1 --pta paddle --trackallflows --typesforcontext'
