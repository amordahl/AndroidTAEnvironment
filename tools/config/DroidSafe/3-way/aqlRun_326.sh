...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 4 --filetransforms --ignorenocontextflows --implicitflow --imprecisestrings --kobjsens 10 --limitcontextforcomplex --limitcontextforgui --multipassfb --noscalaropts --nova --precision 2 --pta spark --transfertaintfield'
