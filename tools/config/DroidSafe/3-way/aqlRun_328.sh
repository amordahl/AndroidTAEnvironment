...
printf 'DSARGS ?= --apicalldepth 4 --filetransforms --ignorenocontextflows --implicitflow --kobjsens 10 --limitcontextforstrings --multipassfb --noarrayindex --noclinitcontext --nofallback --precision 4 --preciseinfoflow --pta spark --transfertaintfield'
