...
printf 'DSARGS ?= --apicalldepth 4 --ignoreexceptionflows --imprecisestrings --kobjsens 10 --limitcontextforgui --limitcontextforstrings --nojsa --noscalaropts --nova --precision 5 --pta paddle --typesforcontext'
