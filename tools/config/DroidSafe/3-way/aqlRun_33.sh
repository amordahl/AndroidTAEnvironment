...
printf 'DSARGS ?= --apicalldepth 1 --filetransforms --implicitflow --kobjsens 6 --limitcontextforcomplex --limitcontextforstrings --multipassfb --noclinitcontext --nova --precision 3 --pta spark --typesforcontext'
