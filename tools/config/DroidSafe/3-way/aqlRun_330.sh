...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 4 --filetransforms --ignorenocontextflows --implicitflow --imprecisestrings --kobjsens 20 --limitcontextforcomplex --noarrayindex --noclinitcontext --nofallback --nojsa --precision 0 --preciseinfoflow --pta geo --trackallflows --transfertaintfield'
