...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 4 --filetransforms --ignoreexceptionflows --kobjsens 20 --multipassfb --nojsa --noscalaropts --nova --precision 2 --pta spark --trackallflows --typesforcontext'
