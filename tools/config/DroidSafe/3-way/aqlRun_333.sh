...
printf 'DSARGS ?= --apicalldepth 4 --kobjsens 20 --limitcontextforcomplex --limitcontextforgui --limitcontextforstrings --multipassfb --noarrayindex --nofallback --nojsa --precision 3 --preciseinfoflow --pta spark --typesforcontext'
