...
printf 'DSARGS ?= --apicalldepth 4 --filetransforms --ignorenocontextflows --implicitflow --kobjsens 20 --noarrayindex --noclinitcontext --noclonestatics --nofallback --noscalaropts --precision 4 --pta spark --transfertaintfield --typesforcontext'
