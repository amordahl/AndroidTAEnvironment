...
printf 'DSARGS ?= --apicalldepth 4 --ignoreexceptionflows --implicitflow --imprecisestrings --kobjsens 20 --limitcontextforcomplex --limitcontextforstrings --multipassfb --nofallback --nova --precision 5 --pta geo --trackallflows'
