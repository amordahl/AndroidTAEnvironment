...
printf 'DSARGS ?= --apicalldepth 4 --ignoreexceptionflows --kobjsens 30 --limitcontextforgui --limitcontextforstrings --multipassfb --noclonestatics --nofallback --noscalaropts --precision 1 --pta paddle --typesforcontext'
