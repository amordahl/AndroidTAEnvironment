...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 4 --implicitflow --imprecisestrings --kobjsens 30 --multipassfb --noarrayindex --noclinitcontext --noclonestatics --nojsa --precision 2 --pta spark --trackallflows'
