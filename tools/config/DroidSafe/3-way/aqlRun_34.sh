...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 1 --filetransforms --ignoreexceptionflows --imprecisestrings --kobjsens 6 --limitcontextforcomplex --noarrayindex --noclinitcontext --nofallback --noscalaropts --precision 4 --pta paddle --trackallflows'
