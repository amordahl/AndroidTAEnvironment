...
printf 'DSARGS ?= --apicalldepth 4 --filetransforms --ignoreexceptionflows --imprecisestrings --kobjsens 30 --limitcontextforcomplex --limitcontextforgui --limitcontextforstrings --multipassfb --noclinitcontext --noclonestatics --noscalaropts --precision 4 --pta geo --transfertaintfield --typesforcontext'
