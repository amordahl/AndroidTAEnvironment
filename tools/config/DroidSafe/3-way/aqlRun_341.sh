...
printf 'DSARGS ?= --apicalldepth 4 --implicitflow --imprecisestrings --kobjsens 30 --limitcontextforcomplex --limitcontextforgui --noclonestatics --nojsa --nova --precision 5 --pta spark'
