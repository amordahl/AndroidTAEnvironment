...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 4 --ignorenocontextflows --implicitflow --imprecisestrings --kobjsens 40 --limitcontextforgui --multipassfb --noclinitcontext --noscalaropts --precision 2 --preciseinfoflow --pta spark --transfertaintfield --typesforcontext'
