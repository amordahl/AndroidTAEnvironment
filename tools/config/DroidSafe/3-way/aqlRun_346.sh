...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 4 --filetransforms --ignoreexceptionflows --implicitflow --imprecisestrings --kobjsens 40 --limitcontextforcomplex --multipassfb --nova --precision 4 --preciseinfoflow --pta spark --typesforcontext'
