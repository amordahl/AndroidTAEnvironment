...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 4 --implicitflow --imprecisestrings --kobjsens 40 --limitcontextforcomplex --limitcontextforgui --multipassfb --noarrayindex --noscalaropts --precision 5 --pta spark --transfertaintfield --typesforcontext'
