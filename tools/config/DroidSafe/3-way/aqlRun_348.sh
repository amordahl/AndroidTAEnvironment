...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 4 --filetransforms --ignorenocontextflows --implicitflow --imprecisestrings --kobjsens 50 --limitcontextforcomplex --noarrayindex --noclinitcontext --nojsa --nova --precision 0 --preciseinfoflow --pta geo --trackallflows --transfertaintfield'
