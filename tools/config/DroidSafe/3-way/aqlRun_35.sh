...
printf 'DSARGS ?= --apicalldepth 1 --filetransforms --ignorenocontextflows --kobjsens 6 --limitcontextforgui --noclinitcontext --noclonestatics --nofallback --nova --precision 5 --preciseinfoflow --pta geo'
