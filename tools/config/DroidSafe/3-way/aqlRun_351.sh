...
printf 'DSARGS ?= --apicalldepth 4 --filetransforms --ignorenocontextflows --implicitflow --imprecisestrings --kobjsens 50 --limitcontextforgui --nova --precision 3 --preciseinfoflow --pta paddle --transfertaintfield'
