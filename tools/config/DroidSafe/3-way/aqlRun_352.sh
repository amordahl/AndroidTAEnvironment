...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 4 --ignoreexceptionflows --ignorenocontextflows --implicitflow --kobjsens 50 --limitcontextforstrings --multipassfb --nofallback --nojsa --nova --precision 4 --preciseinfoflow --pta geo --trackallflows --typesforcontext'
