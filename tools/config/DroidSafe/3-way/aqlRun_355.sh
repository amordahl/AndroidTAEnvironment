...
printf 'DSARGS ?= --apicalldepth 4 --ignoreexceptionflows --kobjsens 100 --limitcontextforgui --limitcontextforstrings --multipassfb --noclonestatics --noscalaropts --nova --precision 1 --pta paddle --typesforcontext'
