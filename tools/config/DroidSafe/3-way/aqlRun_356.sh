...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 4 --filetransforms --ignorenocontextflows --implicitflow --kobjsens 100 --noclonestatics --nofallback --precision 2 --pta spark --trackallflows'
