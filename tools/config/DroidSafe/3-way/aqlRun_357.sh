...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 4 --ignoreexceptionflows --kobjsens 100 --limitcontextforgui --limitcontextforstrings --multipassfb --noarrayindex --noclonestatics --nofallback --nova --precision 3 --preciseinfoflow --pta geo --trackallflows --transfertaintfield --typesforcontext'
