...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 4 --filetransforms --ignoreexceptionflows --ignorenocontextflows --kobjsens 100 --limitcontextforcomplex --limitcontextforstrings --multipassfb --noclinitcontext --noclonestatics --nojsa --noscalaropts --precision 4 --pta geo --trackallflows --typesforcontext'
