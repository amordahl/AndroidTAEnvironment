...
printf 'DSARGS ?= --apicalldepth 5 --ignoreexceptionflows --kobjsens 1 --limitcontextforgui --limitcontextforstrings --multipassfb --noclonestatics --nofallback --noscalaropts --nova --precision 1 --pta paddle --typesforcontext'
