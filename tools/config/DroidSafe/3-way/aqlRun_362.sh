...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 5 --implicitflow --kobjsens 1 --limitcontextforcomplex --limitcontextforgui --multipassfb --noarrayindex --nofallback --nojsa --noscalaropts --precision 2 --pta spark --trackallflows'
