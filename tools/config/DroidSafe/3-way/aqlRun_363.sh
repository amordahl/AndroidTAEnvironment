...
printf 'DSARGS ?= --apicalldepth 5 --filetransforms --ignoreexceptionflows --ignorenocontextflows --imprecisestrings --kobjsens 1 --limitcontextforstrings --noclinitcontext --noclonestatics --nova --precision 3 --preciseinfoflow --pta geo --transfertaintfield --typesforcontext'
