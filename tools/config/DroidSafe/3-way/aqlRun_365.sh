...
printf 'DSARGS ?= --apicalldepth 5 --ignorenocontextflows --implicitflow --imprecisestrings --kobjsens 1 --limitcontextforgui --noscalaropts --precision 5 --preciseinfoflow --pta geo'
