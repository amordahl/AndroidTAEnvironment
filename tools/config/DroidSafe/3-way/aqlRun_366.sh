...
printf 'DSARGS ?= --apicalldepth 5 --filetransforms --ignoreexceptionflows --imprecisestrings --kobjsens 2 --limitcontextforcomplex --noclonestatics --nofallback --nojsa --precision 0 --preciseinfoflow --pta spark --typesforcontext'
