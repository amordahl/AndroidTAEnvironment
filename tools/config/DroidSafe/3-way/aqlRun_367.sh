...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 5 --filetransforms --ignorenocontextflows --implicitflow --kobjsens 2 --limitcontextforgui --limitcontextforstrings --multipassfb --noarrayindex --noclinitcontext --noscalaropts --nova --precision 1 --pta geo --trackallflows --transfertaintfield'
