...
printf 'DSARGS ?= --apicalldepth 5 --filetransforms --ignoreexceptionflows --ignorenocontextflows --implicitflow --imprecisestrings --kobjsens 2 --noarrayindex --noclinitcontext --nojsa --nova --precision 2 --preciseinfoflow --pta paddle --trackallflows --transfertaintfield --typesforcontext'
