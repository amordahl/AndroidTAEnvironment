...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 5 --ignoreexceptionflows --implicitflow --kobjsens 2 --limitcontextforcomplex --multipassfb --noarrayindex --noclinitcontext --noclonestatics --noscalaropts --precision 3 --preciseinfoflow --pta spark --transfertaintfield'
