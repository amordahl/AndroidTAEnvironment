...
printf 'DSARGS ?= --apicalldepth 1 --ignorenocontextflows --kobjsens 7 --multipassfb --noarrayindex --noclonestatics --nofallback --noscalaropts --precision 1 --preciseinfoflow --pta paddle --transfertaintfield --typesforcontext'
