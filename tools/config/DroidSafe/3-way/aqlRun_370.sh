...
printf 'DSARGS ?= --apicalldepth 5 --ignoreexceptionflows --implicitflow --imprecisestrings --kobjsens 2 --limitcontextforgui --nofallback --precision 4 --pta geo --trackallflows'
