...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 5 --ignorenocontextflows --implicitflow --kobjsens 3 --limitcontextforgui --limitcontextforstrings --noscalaropts --nova --precision 0 --pta paddle --transfertaintfield --typesforcontext'
