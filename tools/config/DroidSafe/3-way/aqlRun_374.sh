...
printf 'DSARGS ?= --apicalldepth 5 --filetransforms --ignoreexceptionflows --kobjsens 3 --limitcontextforgui --limitcontextforstrings --noclinitcontext --nofallback --noscalaropts --precision 2 --pta geo --transfertaintfield --typesforcontext'
