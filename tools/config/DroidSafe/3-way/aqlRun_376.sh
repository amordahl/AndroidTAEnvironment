...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 5 --imprecisestrings --kobjsens 3 --limitcontextforstrings --noarrayindex --nojsa --noscalaropts --nova --precision 4 --preciseinfoflow --pta spark'
