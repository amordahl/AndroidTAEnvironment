...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 5 --filetransforms --imprecisestrings --kobjsens 3 --noarrayindex --noclonestatics --nofallback --nojsa --noscalaropts --nova --precision 5 --pta spark --trackallflows --transfertaintfield --typesforcontext'
