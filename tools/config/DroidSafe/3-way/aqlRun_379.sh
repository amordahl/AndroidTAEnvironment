...
printf 'DSARGS ?= --apicalldepth 5 --ignoreexceptionflows --kobjsens 4 --limitcontextforgui --limitcontextforstrings --noclinitcontext --nofallback --noscalaropts --nova --precision 1 --pta paddle --trackallflows --typesforcontext'
