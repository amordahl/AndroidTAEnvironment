...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 1 --ignoreexceptionflows --ignorenocontextflows --implicitflow --kobjsens 7 --limitcontextforgui --noarrayindex --noclinitcontext --noscalaropts --nova --precision 2 --preciseinfoflow --pta geo'
