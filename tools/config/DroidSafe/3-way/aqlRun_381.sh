...
printf 'DSARGS ?= --apicalldepth 5 --ignoreexceptionflows --imprecisestrings --kobjsens 4 --limitcontextforgui --limitcontextforstrings --precision 3 --pta paddle --trackallflows --typesforcontext'
