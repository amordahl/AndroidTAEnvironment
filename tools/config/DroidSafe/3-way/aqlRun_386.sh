...
printf 'DSARGS ?= --apicalldepth 5 --ignorenocontextflows --implicitflow --imprecisestrings --kobjsens 5 --multipassfb --noclonestatics --nojsa --noscalaropts --nova --precision 2 --preciseinfoflow --pta spark --transfertaintfield --typesforcontext'
