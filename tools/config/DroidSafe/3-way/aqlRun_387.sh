...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 5 --ignoreexceptionflows --implicitflow --imprecisestrings --kobjsens 5 --noarrayindex --noclonestatics --nojsa --nova --precision 3 --pta paddle --trackallflows'
