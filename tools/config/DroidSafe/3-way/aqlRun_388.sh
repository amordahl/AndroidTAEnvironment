...
printf 'DSARGS ?= --apicalldepth 5 --ignorenocontextflows --kobjsens 5 --limitcontextforcomplex --limitcontextforstrings --multipassfb --noarrayindex --precision 4 --preciseinfoflow --pta geo --typesforcontext'
