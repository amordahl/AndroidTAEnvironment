...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 5 --imprecisestrings --kobjsens 5 --limitcontextforcomplex --multipassfb --noclinitcontext --nojsa --precision 5 --preciseinfoflow --pta geo --trackallflows --typesforcontext'
