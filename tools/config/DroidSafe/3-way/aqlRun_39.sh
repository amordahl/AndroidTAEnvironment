...
printf 'DSARGS ?= --apicalldepth 1 --filetransforms --kobjsens 7 --limitcontextforcomplex --limitcontextforstrings --multipassfb --noarrayindex --noclinitcontext --noclonestatics --nojsa --precision 3 --pta spark --trackallflows --transfertaintfield'
