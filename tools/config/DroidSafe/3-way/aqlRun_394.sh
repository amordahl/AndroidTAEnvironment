...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 5 --filetransforms --ignoreexceptionflows --implicitflow --imprecisestrings --kobjsens 6 --limitcontextforgui --limitcontextforstrings --noclinitcontext --noclonestatics --nova --precision 4 --pta spark --trackallflows --transfertaintfield'
