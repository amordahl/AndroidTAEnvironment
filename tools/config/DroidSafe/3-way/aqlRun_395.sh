...
printf 'DSARGS ?= --apicalldepth 5 --filetransforms --ignoreexceptionflows --ignorenocontextflows --kobjsens 6 --limitcontextforgui --multipassfb --noclinitcontext --precision 5 --pta spark'
