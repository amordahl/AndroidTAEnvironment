...
printf 'DSARGS ?= --apicalldepth 5 --filetransforms --ignorenocontextflows --implicitflow --kobjsens 7 --limitcontextforcomplex --limitcontextforgui --noarrayindex --noclinitcontext --noclonestatics --nofallback --nojsa --noscalaropts --precision 2 --pta spark --transfertaintfield'
