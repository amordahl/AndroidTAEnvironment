...
printf 'DSARGS ?= --apicalldepth 5 --filetransforms --ignorenocontextflows --kobjsens 7 --limitcontextforcomplex --noarrayindex --noclinitcontext --nojsa --noscalaropts --nova --precision 3 --preciseinfoflow --pta spark --transfertaintfield --typesforcontext'
