...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 1 --filetransforms --implicitflow --imprecisestrings --kobjsens 1 --limitcontextforstrings --multipassfb --noclonestatics --nofallback --nova --precision 4 --preciseinfoflow --pta paddle --typesforcontext'
