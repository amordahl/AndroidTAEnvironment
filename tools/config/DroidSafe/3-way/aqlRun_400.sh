...
printf 'DSARGS ?= --apicalldepth 5 --filetransforms --ignoreexceptionflows --ignorenocontextflows --implicitflow --imprecisestrings --kobjsens 7 --limitcontextforcomplex --multipassfb --noarrayindex --noclinitcontext --nofallback --precision 4 --preciseinfoflow --pta paddle --trackallflows --transfertaintfield --typesforcontext'
