...
printf 'DSARGS ?= --apicalldepth 5 --ignoreexceptionflows --ignorenocontextflows --kobjsens 7 --limitcontextforgui --noclinitcontext --noclonestatics --nofallback --noscalaropts --precision 5 --pta geo --typesforcontext'
