...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 5 --kobjsens 8 --noarrayindex --nofallback --nojsa --noscalaropts --nova --precision 3 --preciseinfoflow --pta geo --typesforcontext'
