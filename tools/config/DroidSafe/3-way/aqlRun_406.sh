...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 5 --ignoreexceptionflows --imprecisestrings --kobjsens 8 --limitcontextforcomplex --limitcontextforstrings --multipassfb --noclinitcontext --nofallback --nojsa --nova --precision 4 --pta paddle --typesforcontext'
