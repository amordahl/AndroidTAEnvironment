...
printf 'DSARGS ?= --apicalldepth 1 --filetransforms --implicitflow --imprecisestrings --kobjsens 7 --limitcontextforcomplex --limitcontextforstrings --noclonestatics --nofallback --noscalaropts --precision 5 --preciseinfoflow --pta geo --typesforcontext'
