...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 5 --implicitflow --imprecisestrings --kobjsens 9 --limitcontextforcomplex --limitcontextforgui --limitcontextforstrings --nojsa --nova --precision 2 --pta spark --transfertaintfield'
