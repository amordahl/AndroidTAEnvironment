...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 5 --ignoreexceptionflows --ignorenocontextflows --kobjsens 9 --limitcontextforcomplex --limitcontextforgui --limitcontextforstrings --noarrayindex --noscalaropts --precision 3 --pta geo --trackallflows --typesforcontext'
