...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 5 --filetransforms --implicitflow --kobjsens 10 --limitcontextforcomplex --limitcontextforgui --limitcontextforstrings --multipassfb --noarrayindex --noclinitcontext --noscalaropts --precision 2 --pta spark --trackallflows --typesforcontext'
