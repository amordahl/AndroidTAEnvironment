...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 5 --filetransforms --implicitflow --kobjsens 10 --limitcontextforgui --multipassfb --nofallback --noscalaropts --nova --precision 3 --pta spark --transfertaintfield'
