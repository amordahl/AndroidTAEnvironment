...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 5 --filetransforms --ignorenocontextflows --kobjsens 10 --limitcontextforgui --multipassfb --nofallback --precision 4 --pta paddle'
