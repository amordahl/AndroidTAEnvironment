...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 5 --ignoreexceptionflows --ignorenocontextflows --implicitflow --kobjsens 10 --limitcontextforstrings --multipassfb --noarrayindex --nofallback --nojsa --nova --precision 5 --pta paddle --trackallflows --typesforcontext'
