...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 5 --filetransforms --imprecisestrings --kobjsens 20 --limitcontextforcomplex --limitcontextforgui --nofallback --nojsa --nova --precision 3 --preciseinfoflow --pta spark'
