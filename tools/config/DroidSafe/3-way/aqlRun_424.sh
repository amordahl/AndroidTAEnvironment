...
printf 'DSARGS ?= --apicalldepth 5 --filetransforms --ignoreexceptionflows --implicitflow --kobjsens 20 --limitcontextforcomplex --limitcontextforgui --multipassfb --noclonestatics --nojsa --precision 4 --pta spark --trackallflows'
