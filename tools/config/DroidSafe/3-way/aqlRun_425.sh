...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 5 --filetransforms --implicitflow --kobjsens 20 --limitcontextforgui --multipassfb --noclinitcontext --noclonestatics --nojsa --precision 5 --preciseinfoflow --pta paddle'
