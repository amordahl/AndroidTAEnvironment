...
printf 'DSARGS ?= --apicalldepth 5 --ignoreexceptionflows --kobjsens 30 --limitcontextforgui --limitcontextforstrings --multipassfb --noclinitcontext --nofallback --noscalaropts --nova --precision 1 --pta paddle --trackallflows --typesforcontext'
