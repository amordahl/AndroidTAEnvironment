...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 5 --filetransforms --ignoreexceptionflows --imprecisestrings --kobjsens 30 --limitcontextforgui --multipassfb --nofallback --nova --precision 2 --preciseinfoflow --pta spark'
