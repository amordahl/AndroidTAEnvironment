...
printf 'DSARGS ?= --apicalldepth 5 --ignoreexceptionflows --ignorenocontextflows --imprecisestrings --kobjsens 30 --limitcontextforstrings --multipassfb --noclinitcontext --noclonestatics --nofallback --noscalaropts --precision 3 --preciseinfoflow --pta spark --trackallflows'
