...
printf 'DSARGS ?= --apicalldepth 1 --filetransforms --implicitflow --imprecisestrings --kobjsens 8 --noarrayindex --noclinitcontext --noclonestatics --nojsa --precision 1 --pta paddle --trackallflows'
