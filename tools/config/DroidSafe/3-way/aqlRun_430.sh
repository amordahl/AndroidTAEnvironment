...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 5 --ignorenocontextflows --imprecisestrings --kobjsens 30 --limitcontextforcomplex --limitcontextforstrings --nojsa --precision 4 --preciseinfoflow --pta geo --trackallflows --transfertaintfield'
