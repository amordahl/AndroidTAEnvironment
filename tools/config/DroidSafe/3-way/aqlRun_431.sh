...
printf 'DSARGS ?= --apicalldepth 5 --filetransforms --ignorenocontextflows --kobjsens 30 --limitcontextforcomplex --limitcontextforgui --limitcontextforstrings --multipassfb --noarrayindex --noclinitcontext --noclonestatics --nofallback --nojsa --noscalaropts --nova --precision 5 --preciseinfoflow --pta geo --transfertaintfield'
