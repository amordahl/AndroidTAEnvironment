...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 5 --filetransforms --ignoreexceptionflows --implicitflow --kobjsens 40 --limitcontextforcomplex --limitcontextforgui --noarrayindex --nofallback --nojsa --noscalaropts --precision 2 --preciseinfoflow --pta spark'
