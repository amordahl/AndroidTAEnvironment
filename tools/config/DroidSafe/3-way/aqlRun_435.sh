...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 5 --ignorenocontextflows --imprecisestrings --kobjsens 40 --limitcontextforgui --noclinitcontext --nofallback --nojsa --noscalaropts --precision 3 --preciseinfoflow --pta paddle --trackallflows --transfertaintfield --typesforcontext'
