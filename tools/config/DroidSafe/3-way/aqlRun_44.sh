...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 1 --filetransforms --ignoreexceptionflows --imprecisestrings --kobjsens 8 --limitcontextforgui --limitcontextforstrings --noarrayindex --noscalaropts --precision 2 --preciseinfoflow --pta geo --trackallflows --transfertaintfield --typesforcontext'
