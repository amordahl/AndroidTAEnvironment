...
printf 'DSARGS ?= --apicalldepth 5 --ignorenocontextflows --implicitflow --kobjsens 50 --limitcontextforcomplex --multipassfb --noarrayindex --nojsa --noscalaropts --precision 2 --pta spark'
