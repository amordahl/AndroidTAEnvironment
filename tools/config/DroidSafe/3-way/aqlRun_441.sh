...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 5 --filetransforms --imprecisestrings --kobjsens 50 --limitcontextforcomplex --noclonestatics --nofallback --precision 3 --pta spark --trackallflows --transfertaintfield --typesforcontext'
