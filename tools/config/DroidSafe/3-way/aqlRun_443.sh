...
printf 'DSARGS ?= --apicalldepth 5 --implicitflow --imprecisestrings --kobjsens 50 --limitcontextforgui --nofallback --nojsa --noscalaropts --nova --precision 5 --pta geo --transfertaintfield'
