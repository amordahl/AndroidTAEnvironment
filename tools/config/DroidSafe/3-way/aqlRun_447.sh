...
printf 'DSARGS ?= --apicalldepth 5 --filetransforms --kobjsens 100 --limitcontextforcomplex --limitcontextforgui --multipassfb --noarrayindex --noclinitcontext --noclonestatics --nofallback --noscalaropts --precision 3 --pta paddle --transfertaintfield --typesforcontext'
