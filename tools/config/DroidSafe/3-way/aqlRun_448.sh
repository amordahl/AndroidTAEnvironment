...
printf 'DSARGS ?= --apicalldepth 5 --filetransforms --kobjsens 100 --multipassfb --noclinitcontext --precision 4 --preciseinfoflow --pta geo --trackallflows --transfertaintfield --typesforcontext'
