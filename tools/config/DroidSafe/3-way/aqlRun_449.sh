...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 5 --filetransforms --implicitflow --imprecisestrings --kobjsens 100 --limitcontextforcomplex --limitcontextforgui --limitcontextforstrings --multipassfb --nofallback --nojsa --precision 5 --pta paddle'
