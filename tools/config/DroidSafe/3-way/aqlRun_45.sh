...
printf 'DSARGS ?= --apicalldepth 1 --ignorenocontextflows --implicitflow --kobjsens 8 --limitcontextforcomplex --multipassfb --noarrayindex --noclonestatics --nojsa --noscalaropts --nova --precision 3 --pta spark'
