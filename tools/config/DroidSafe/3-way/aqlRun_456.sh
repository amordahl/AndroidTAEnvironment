...
printf 'DSARGS ?= --apicalldepth 6 --filetransforms --ignoreexceptionflows --imprecisestrings --kobjsens 2 --limitcontextforcomplex --multipassfb --noclinitcontext --nojsa --precision 0 --pta spark --trackallflows --typesforcontext'
