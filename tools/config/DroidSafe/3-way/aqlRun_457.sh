...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 6 --ignorenocontextflows --implicitflow --kobjsens 2 --limitcontextforgui --limitcontextforstrings --noarrayindex --noclonestatics --nofallback --noscalaropts --nova --precision 1 --preciseinfoflow --pta geo --transfertaintfield'
