...
printf 'DSARGS ?= --apicalldepth 6 --filetransforms --ignoreexceptionflows --ignorenocontextflows --implicitflow --imprecisestrings --kobjsens 2 --noarrayindex --noclonestatics --nojsa --noscalaropts --nova --precision 2 --preciseinfoflow --pta paddle --typesforcontext'
