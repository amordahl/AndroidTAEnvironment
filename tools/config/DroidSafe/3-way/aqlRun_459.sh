...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 6 --implicitflow --kobjsens 2 --limitcontextforcomplex --limitcontextforgui --multipassfb --precision 3 --preciseinfoflow --pta spark --transfertaintfield'
