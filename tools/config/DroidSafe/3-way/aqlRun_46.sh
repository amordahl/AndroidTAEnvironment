...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 1 --ignoreexceptionflows --ignorenocontextflows --implicitflow --imprecisestrings --kobjsens 8 --limitcontextforstrings --multipassfb --noclinitcontext --nofallback --nojsa --noscalaropts --precision 4 --pta paddle --transfertaintfield'
