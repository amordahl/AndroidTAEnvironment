...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 6 --ignorenocontextflows --kobjsens 3 --limitcontextforgui --limitcontextforstrings --noarrayindex --noclonestatics --nofallback --noscalaropts --nova --precision 0 --preciseinfoflow --pta paddle --typesforcontext'
