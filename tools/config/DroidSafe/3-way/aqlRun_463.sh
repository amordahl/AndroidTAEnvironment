...
printf 'DSARGS ?= --apicalldepth 6 --filetransforms --ignoreexceptionflows --implicitflow --imprecisestrings --kobjsens 3 --limitcontextforcomplex --multipassfb --noclinitcontext --nojsa --precision 1 --pta spark --trackallflows --transfertaintfield'
