...
printf 'DSARGS ?= --apicalldepth 6 --ignoreexceptionflows --kobjsens 3 --limitcontextforcomplex --limitcontextforstrings --multipassfb --nofallback --precision 2 --pta geo --trackallflows --transfertaintfield'
