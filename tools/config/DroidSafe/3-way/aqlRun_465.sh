...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 6 --filetransforms --ignoreexceptionflows --ignorenocontextflows --implicitflow --kobjsens 3 --limitcontextforstrings --noarrayindex --noclinitcontext --noclonestatics --nofallback --nojsa --noscalaropts --precision 3 --pta paddle --trackallflows --typesforcontext'
