...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 6 --filetransforms --ignoreexceptionflows --ignorenocontextflows --imprecisestrings --kobjsens 3 --limitcontextforgui --limitcontextforstrings --nojsa --nova --precision 4 --preciseinfoflow --pta spark --trackallflows'
