...
printf 'DSARGS ?= --apicalldepth 6 --filetransforms --ignoreexceptionflows --ignorenocontextflows --implicitflow --kobjsens 4 --limitcontextforgui --noarrayindex --noclinitcontext --nofallback --nojsa --precision 3 --pta spark --typesforcontext'
