...
printf 'DSARGS ?= --apicalldepth 6 --filetransforms --ignoreexceptionflows --implicitflow --kobjsens 4 --limitcontextforcomplex --multipassfb --noarrayindex --nojsa --noscalaropts --nova --precision 5 --pta geo --transfertaintfield --typesforcontext'
