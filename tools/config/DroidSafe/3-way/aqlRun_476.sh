...
printf 'DSARGS ?= --apicalldepth 6 --filetransforms --ignorenocontextflows --kobjsens 5 --limitcontextforgui --multipassfb --noarrayindex --noclonestatics --nojsa --precision 2 --preciseinfoflow --pta spark --trackallflows'
