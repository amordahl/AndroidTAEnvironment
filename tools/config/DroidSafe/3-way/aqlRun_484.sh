...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 6 --ignoreexceptionflows --kobjsens 6 --limitcontextforgui --limitcontextforstrings --multipassfb --noclinitcontext --noclonestatics --nofallback --nojsa --precision 4 --preciseinfoflow --pta paddle --trackallflows'
