...
printf 'DSARGS ?= --apicalldepth 6 --ignoreexceptionflows --implicitflow --kobjsens 6 --limitcontextforstrings --noclinitcontext --nojsa --precision 5 --pta paddle --trackallflows --transfertaintfield'
