...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 6 --ignoreexceptionflows --implicitflow --imprecisestrings --kobjsens 7 --multipassfb --noclonestatics --nojsa --noscalaropts --precision 3 --pta geo --transfertaintfield'
