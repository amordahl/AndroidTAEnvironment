...
printf 'DSARGS ?= --apicalldepth 1 --ignoreexceptionflows --implicitflow --kobjsens 9 --noclinitcontext --noscalaropts --nova --precision 1 --preciseinfoflow --pta paddle --transfertaintfield'
