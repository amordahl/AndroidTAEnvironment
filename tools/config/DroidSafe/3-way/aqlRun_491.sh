...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 6 --filetransforms --ignoreexceptionflows --implicitflow --kobjsens 7 --limitcontextforgui --nojsa --nova --precision 5 --pta paddle --trackallflows --transfertaintfield'
