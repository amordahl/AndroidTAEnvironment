...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 6 --ignoreexceptionflows --ignorenocontextflows --implicitflow --kobjsens 8 --limitcontextforgui --multipassfb --noarrayindex --noclinitcontext --noscalaropts --precision 3 --pta geo --trackallflows --typesforcontext'
