...
printf 'DSARGS ?= --apicalldepth 6 --filetransforms --ignorenocontextflows --implicitflow --kobjsens 8 --limitcontextforstrings --multipassfb --noclinitcontext --nofallback --nojsa --noscalaropts --nova --precision 4 --pta geo --trackallflows'
