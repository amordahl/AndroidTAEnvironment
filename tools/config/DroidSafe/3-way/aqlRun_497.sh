...
printf 'DSARGS ?= --apicalldepth 6 --filetransforms --ignoreexceptionflows --ignorenocontextflows --kobjsens 8 --limitcontextforgui --multipassfb --noclinitcontext --noclonestatics --noscalaropts --nova --precision 5 --pta spark --trackallflows --typesforcontext'
