...
printf 'DSARGS ?= --apicalldepth 1 --filetransforms --ignoreexceptionflows --ignorenocontextflows --kobjsens 1 --limitcontextforcomplex --limitcontextforgui --noarrayindex --nofallback --nojsa --noscalaropts --precision 5 --pta geo --trackallflows --transfertaintfield'
