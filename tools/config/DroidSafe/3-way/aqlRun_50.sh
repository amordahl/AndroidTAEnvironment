...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 1 --kobjsens 9 --limitcontextforcomplex --limitcontextforstrings --noarrayindex --noclinitcontext --nofallback --nojsa --noscalaropts --nova --precision 2 --pta geo --trackallflows --typesforcontext'
