...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 6 --filetransforms --imprecisestrings --kobjsens 9 --limitcontextforgui --noarrayindex --noclinitcontext --noclonestatics --nofallback --noscalaropts --precision 2 --preciseinfoflow --pta spark --trackallflows --typesforcontext'
