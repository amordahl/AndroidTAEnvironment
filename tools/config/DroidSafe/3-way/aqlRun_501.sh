...
printf 'DSARGS ?= --apicalldepth 6 --filetransforms --ignoreexceptionflows --implicitflow --imprecisestrings --kobjsens 9 --limitcontextforcomplex --multipassfb --noarrayindex --noclinitcontext --precision 3 --preciseinfoflow --pta paddle --trackallflows'
