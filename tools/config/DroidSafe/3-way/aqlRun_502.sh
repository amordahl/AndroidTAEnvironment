...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 6 --implicitflow --imprecisestrings --kobjsens 9 --limitcontextforcomplex --limitcontextforstrings --noclinitcontext --noclonestatics --noscalaropts --nova --precision 4 --pta paddle'
