...
printf 'DSARGS ?= --apicalldepth 6 --filetransforms --implicitflow --kobjsens 9 --limitcontextforgui --limitcontextforstrings --noclinitcontext --nofallback --noscalaropts --nova --precision 5 --pta geo'
