...
printf 'DSARGS ?= --apicalldepth 6 --filetransforms --implicitflow --kobjsens 10 --limitcontextforcomplex --noarrayindex --nofallback --noscalaropts --precision 2 --preciseinfoflow --pta spark'
