...
printf 'DSARGS ?= --apicalldepth 6 --ignorenocontextflows --imprecisestrings --kobjsens 10 --limitcontextforstrings --noclonestatics --nojsa --noscalaropts --nova --precision 3 --preciseinfoflow --pta spark --trackallflows --typesforcontext'
