...
printf 'DSARGS ?= --apicalldepth 6 --implicitflow --kobjsens 10 --limitcontextforcomplex --limitcontextforstrings --multipassfb --nofallback --nojsa --noscalaropts --precision 4 --preciseinfoflow --pta geo --trackallflows --transfertaintfield'
