...
printf 'DSARGS ?= --apicalldepth 6 --implicitflow --kobjsens 10 --limitcontextforcomplex --noarrayindex --nofallback --noscalaropts --precision 5 --pta paddle --trackallflows'
