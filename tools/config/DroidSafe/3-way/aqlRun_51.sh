...
printf 'DSARGS ?= --apicalldepth 1 --filetransforms --ignoreexceptionflows --ignorenocontextflows --implicitflow --imprecisestrings --kobjsens 9 --limitcontextforgui --multipassfb --noclinitcontext --noclonestatics --precision 3 --preciseinfoflow --pta spark --trackallflows'
