...
printf 'DSARGS ?= --apicalldepth 6 --ignoreexceptionflows --ignorenocontextflows --kobjsens 20 --limitcontextforgui --limitcontextforstrings --multipassfb --noclinitcontext --nofallback --noscalaropts --nova --precision 1 --pta paddle --trackallflows --transfertaintfield'
