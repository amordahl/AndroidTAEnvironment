...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 6 --ignoreexceptionflows --kobjsens 20 --noarrayindex --noclonestatics --noscalaropts --nova --precision 2 --preciseinfoflow --pta spark --trackallflows'
