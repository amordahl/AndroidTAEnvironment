...
printf 'DSARGS ?= --apicalldepth 6 --ignoreexceptionflows --implicitflow --kobjsens 20 --limitcontextforcomplex --noclinitcontext --nofallback --precision 4 --pta geo --trackallflows --typesforcontext'
