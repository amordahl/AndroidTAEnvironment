...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 6 --imprecisestrings --kobjsens 20 --limitcontextforgui --limitcontextforstrings --multipassfb --noarrayindex --noclinitcontext --nofallback --nova --precision 5 --pta paddle --trackallflows --typesforcontext'
