...
printf 'DSARGS ?= --apicalldepth 6 --imprecisestrings --kobjsens 30 --limitcontextforcomplex --limitcontextforgui --multipassfb --noclinitcontext --noclonestatics --nojsa --noscalaropts --nova --precision 2 --preciseinfoflow --pta spark --trackallflows'
