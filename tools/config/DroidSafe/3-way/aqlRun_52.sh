...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 1 --filetransforms --ignorenocontextflows --kobjsens 9 --limitcontextforgui --noarrayindex --nojsa --precision 4 --preciseinfoflow --pta paddle'
