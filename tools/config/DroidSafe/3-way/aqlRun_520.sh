...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 6 --ignorenocontextflows --kobjsens 30 --noarrayindex --noclinitcontext --nova --precision 4 --preciseinfoflow --pta paddle --trackallflows'
