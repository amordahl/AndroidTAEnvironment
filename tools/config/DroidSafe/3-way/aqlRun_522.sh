...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 6 --filetransforms --implicitflow --imprecisestrings --kobjsens 40 --limitcontextforcomplex --noarrayindex --noclonestatics --nojsa --precision 0 --preciseinfoflow --pta geo --typesforcontext'
