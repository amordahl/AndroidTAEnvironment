...
printf 'DSARGS ?= --apicalldepth 6 --filetransforms --ignorenocontextflows --implicitflow --imprecisestrings --kobjsens 40 --limitcontextforcomplex --multipassfb --nova --precision 2 --pta spark --transfertaintfield'
