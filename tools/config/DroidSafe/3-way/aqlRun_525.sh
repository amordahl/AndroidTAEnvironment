...
printf 'DSARGS ?= --apicalldepth 6 --ignorenocontextflows --imprecisestrings --kobjsens 40 --limitcontextforstrings --multipassfb --noarrayindex --precision 3 --pta paddle --trackallflows --transfertaintfield --typesforcontext'
