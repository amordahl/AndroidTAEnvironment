...
printf 'DSARGS ?= --apicalldepth 6 --ignorenocontextflows --implicitflow --kobjsens 40 --limitcontextforcomplex --limitcontextforgui --nojsa --noscalaropts --nova --precision 4 --preciseinfoflow --pta geo'
