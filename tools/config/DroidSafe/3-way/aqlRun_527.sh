...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 6 --filetransforms --imprecisestrings --kobjsens 40 --limitcontextforgui --noarrayindex --nofallback --nojsa --noscalaropts --nova --precision 5 --pta paddle --trackallflows --typesforcontext'
