...
printf 'DSARGS ?= --apicalldepth 1 --filetransforms --implicitflow --imprecisestrings --kobjsens 9 --limitcontextforcomplex --multipassfb --noclonestatics --nofallback --noscalaropts --nova --precision 5 --pta geo --transfertaintfield --typesforcontext'
