...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 6 --ignoreexceptionflows --ignorenocontextflows --imprecisestrings --kobjsens 50 --limitcontextforcomplex --noclinitcontext --noclonestatics --noscalaropts --precision 2 --preciseinfoflow --pta spark'
