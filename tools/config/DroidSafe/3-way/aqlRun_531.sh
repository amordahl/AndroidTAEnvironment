...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 6 --ignoreexceptionflows --implicitflow --kobjsens 50 --multipassfb --noarrayindex --noclinitcontext --noclonestatics --precision 3 --pta spark --trackallflows --transfertaintfield --typesforcontext'
