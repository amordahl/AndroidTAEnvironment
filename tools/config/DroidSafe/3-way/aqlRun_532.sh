...
printf 'DSARGS ?= --apicalldepth 6 --kobjsens 50 --limitcontextforgui --limitcontextforstrings --multipassfb --noclonestatics --nojsa --nova --precision 4 --pta spark --transfertaintfield'
