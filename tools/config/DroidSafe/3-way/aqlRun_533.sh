...
printf 'DSARGS ?= --apicalldepth 6 --implicitflow --imprecisestrings --kobjsens 50 --limitcontextforcomplex --limitcontextforgui --noclinitcontext --nojsa --nova --precision 5 --pta paddle --trackallflows --transfertaintfield --typesforcontext'
