...
printf 'DSARGS ?= --apicalldepth 6 --filetransforms --ignoreexceptionflows --implicitflow --imprecisestrings --kobjsens 100 --limitcontextforgui --noclinitcontext --noscalaropts --precision 4 --pta spark --trackallflows --typesforcontext'
