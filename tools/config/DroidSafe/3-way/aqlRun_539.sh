...
printf 'DSARGS ?= --apicalldepth 6 --ignoreexceptionflows --ignorenocontextflows --implicitflow --kobjsens 100 --limitcontextforcomplex --limitcontextforgui --limitcontextforstrings --noclonestatics --nojsa --noscalaropts --precision 5 --preciseinfoflow --pta geo --transfertaintfield --typesforcontext'
