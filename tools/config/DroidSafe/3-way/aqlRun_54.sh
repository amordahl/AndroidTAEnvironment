...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 1 --ignoreexceptionflows --ignorenocontextflows --imprecisestrings --kobjsens 10 --limitcontextforcomplex --limitcontextforgui --limitcontextforstrings --multipassfb --noarrayindex --nofallback --nojsa --nova --precision 0 --preciseinfoflow --pta spark --trackallflows --transfertaintfield --typesforcontext'
