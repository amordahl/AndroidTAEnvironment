...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 7 --ignorenocontextflows --implicitflow --kobjsens 1 --limitcontextforcomplex --limitcontextforgui --multipassfb --noarrayindex --noclinitcontext --noclonestatics --nofallback --nojsa --noscalaropts --precision 2 --pta spark --transfertaintfield --typesforcontext'
