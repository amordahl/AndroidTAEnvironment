...
printf 'DSARGS ?= --apicalldepth 7 --filetransforms --ignoreexceptionflows --imprecisestrings --kobjsens 1 --limitcontextforstrings --nova --precision 3 --preciseinfoflow --pta geo --trackallflows'
