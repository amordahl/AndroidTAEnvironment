...
printf 'DSARGS ?= --apicalldepth 7 --filetransforms --ignoreexceptionflows --implicitflow --imprecisestrings --kobjsens 2 --noarrayindex --noclonestatics --nojsa --noscalaropts --nova --precision 2 --preciseinfoflow --pta paddle --transfertaintfield'
