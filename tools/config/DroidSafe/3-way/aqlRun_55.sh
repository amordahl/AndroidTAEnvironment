...
printf 'DSARGS ?= --apicalldepth 1 --filetransforms --implicitflow --kobjsens 10 --limitcontextforstrings --noclinitcontext --noclonestatics --noscalaropts --precision 1 --pta paddle'
