...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 7 --filetransforms --ignoreexceptionflows --kobjsens 2 --limitcontextforcomplex --limitcontextforgui --limitcontextforstrings --multipassfb --noarrayindex --noclinitcontext --nofallback --nojsa --precision 5 --pta paddle --trackallflows --typesforcontext'
