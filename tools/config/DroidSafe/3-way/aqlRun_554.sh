...
printf 'DSARGS ?= --apicalldepth 7 --filetransforms --ignoreexceptionflows --ignorenocontextflows --kobjsens 3 --limitcontextforgui --limitcontextforstrings --multipassfb --nofallback --nova --precision 2 --pta geo --trackallflows --typesforcontext'
