...
printf 'DSARGS ?= --apicalldepth 7 --filetransforms --ignoreexceptionflows --implicitflow --kobjsens 3 --limitcontextforgui --limitcontextforstrings --noarrayindex --nova --precision 4 --preciseinfoflow --pta spark --transfertaintfield --typesforcontext'
