...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 7 --imprecisestrings --kobjsens 3 --limitcontextforcomplex --limitcontextforstrings --multipassfb --noarrayindex --nofallback --nojsa --noscalaropts --nova --precision 5 --preciseinfoflow --pta spark'
