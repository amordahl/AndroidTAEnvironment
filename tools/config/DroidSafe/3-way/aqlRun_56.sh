...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 1 --filetransforms --ignoreexceptionflows --kobjsens 10 --limitcontextforcomplex --multipassfb --noarrayindex --noclinitcontext --noclonestatics --nofallback --nojsa --noscalaropts --precision 2 --preciseinfoflow --pta geo --typesforcontext'
