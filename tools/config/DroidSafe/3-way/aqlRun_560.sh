...
printf 'DSARGS ?= --apicalldepth 7 --filetransforms --ignoreexceptionflows --ignorenocontextflows --implicitflow --imprecisestrings --kobjsens 4 --limitcontextforcomplex --limitcontextforgui --limitcontextforstrings --multipassfb --nofallback --nojsa --noscalaropts --precision 2 --preciseinfoflow --pta spark --trackallflows'
