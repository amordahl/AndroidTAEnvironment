...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 7 --filetransforms --implicitflow --imprecisestrings --kobjsens 4 --limitcontextforcomplex --limitcontextforgui --multipassfb --noarrayindex --nofallback --nojsa --noscalaropts --precision 3 --pta geo --transfertaintfield --typesforcontext'
