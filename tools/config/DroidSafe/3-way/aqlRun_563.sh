...
printf 'DSARGS ?= --apicalldepth 7 --filetransforms --ignoreexceptionflows --implicitflow --imprecisestrings --kobjsens 4 --limitcontextforgui --multipassfb --nofallback --nojsa --nova --precision 5 --preciseinfoflow --pta spark --typesforcontext'
