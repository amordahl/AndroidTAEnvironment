...
printf 'DSARGS ?= --apicalldepth 7 --ignoreexceptionflows --implicitflow --kobjsens 5 --limitcontextforgui --limitcontextforstrings --multipassfb --noclinitcontext --nofallback --noscalaropts --nova --precision 1 --pta paddle --trackallflows --typesforcontext'
