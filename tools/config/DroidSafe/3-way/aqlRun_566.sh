...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 7 --filetransforms --ignorenocontextflows --imprecisestrings --kobjsens 5 --limitcontextforstrings --multipassfb --noclinitcontext --nojsa --noscalaropts --precision 2 --pta spark --trackallflows --transfertaintfield'
