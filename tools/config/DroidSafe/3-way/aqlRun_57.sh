...
printf 'DSARGS ?= --apicalldepth 1 --ignorenocontextflows --implicitflow --imprecisestrings --kobjsens 10 --limitcontextforgui --nova --precision 3 --pta spark --trackallflows --transfertaintfield'
