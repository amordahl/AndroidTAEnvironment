...
printf 'DSARGS ?= --apicalldepth 7 --imprecisestrings --kobjsens 6 --limitcontextforcomplex --multipassfb --noarrayindex --noclinitcontext --nofallback --nova --precision 3 --pta paddle --transfertaintfield --typesforcontext'
