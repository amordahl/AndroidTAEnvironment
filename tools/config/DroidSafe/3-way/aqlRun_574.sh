...
printf 'DSARGS ?= --apicalldepth 7 --ignoreexceptionflows --implicitflow --imprecisestrings --kobjsens 6 --limitcontextforcomplex --limitcontextforgui --multipassfb --noarrayindex --nojsa --noscalaropts --precision 4 --pta spark'
