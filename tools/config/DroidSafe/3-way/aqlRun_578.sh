...
printf 'DSARGS ?= --apicalldepth 7 --ignorenocontextflows --implicitflow --kobjsens 7 --limitcontextforstrings --noclinitcontext --noclonestatics --precision 2 --preciseinfoflow --pta spark --trackallflows --transfertaintfield'
