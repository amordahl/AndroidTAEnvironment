...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 7 --ignoreexceptionflows --implicitflow --imprecisestrings --kobjsens 7 --limitcontextforcomplex --nofallback --precision 4 --preciseinfoflow --pta geo --typesforcontext'
