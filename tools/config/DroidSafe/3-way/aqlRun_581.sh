...
printf 'DSARGS ?= --apicalldepth 7 --ignorenocontextflows --kobjsens 7 --limitcontextforgui --limitcontextforstrings --noarrayindex --noclinitcontext --nofallback --nova --precision 5 --pta spark'
