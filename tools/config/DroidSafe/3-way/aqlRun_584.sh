...
printf 'DSARGS ?= --apicalldepth 7 --ignoreexceptionflows --implicitflow --kobjsens 8 --limitcontextforstrings --noclinitcontext --noclonestatics --nojsa --precision 2 --pta spark --trackallflows --transfertaintfield --typesforcontext'
