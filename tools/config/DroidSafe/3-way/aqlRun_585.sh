...
printf 'DSARGS ?= --apicalldepth 7 --filetransforms --ignorenocontextflows --kobjsens 8 --limitcontextforcomplex --multipassfb --noclinitcontext --noclonestatics --nojsa --noscalaropts --precision 3 --preciseinfoflow --pta paddle --trackallflows'
