...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 7 --ignoreexceptionflows --ignorenocontextflows --imprecisestrings --kobjsens 8 --limitcontextforgui --limitcontextforstrings --multipassfb --noarrayindex --noclinitcontext --nofallback --nova --precision 4 --preciseinfoflow --pta geo --typesforcontext'
