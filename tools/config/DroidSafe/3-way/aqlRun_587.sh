...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 7 --filetransforms --ignoreexceptionflows --kobjsens 8 --limitcontextforgui --limitcontextforstrings --nojsa --noscalaropts --nova --precision 5 --preciseinfoflow --pta spark'
