...
printf 'DSARGS ?= --apicalldepth 1 --imprecisestrings --kobjsens 10 --limitcontextforstrings --multipassfb --noarrayindex --nofallback --nojsa --precision 5 --pta geo --trackallflows'
