...
printf 'DSARGS ?= --apicalldepth 7 --filetransforms --ignoreexceptionflows --ignorenocontextflows --kobjsens 9 --limitcontextforstrings --multipassfb --noclonestatics --nofallback --precision 2 --pta spark --trackallflows'
