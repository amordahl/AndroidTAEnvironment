...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 7 --kobjsens 9 --limitcontextforgui --noclinitcontext --nojsa --precision 3 --preciseinfoflow --pta spark --typesforcontext'
