...
printf 'DSARGS ?= --apicalldepth 7 --ignoreexceptionflows --imprecisestrings --kobjsens 9 --limitcontextforgui --noclinitcontext --nofallback --nojsa --nova --precision 4 --pta paddle --trackallflows'
