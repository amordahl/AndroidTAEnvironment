...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 7 --kobjsens 9 --limitcontextforcomplex --noclinitcontext --noclonestatics --nofallback --nojsa --precision 5 --preciseinfoflow --pta geo --trackallflows --transfertaintfield'
