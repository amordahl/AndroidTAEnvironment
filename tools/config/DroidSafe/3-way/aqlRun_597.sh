...
printf 'DSARGS ?= --apicalldepth 7 --kobjsens 10 --limitcontextforcomplex --limitcontextforgui --limitcontextforstrings --noclonestatics --nofallback --nojsa --noscalaropts --nova --precision 3 --pta spark --trackallflows --transfertaintfield'
