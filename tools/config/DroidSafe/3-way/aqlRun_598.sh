...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 7 --ignoreexceptionflows --ignorenocontextflows --implicitflow --imprecisestrings --kobjsens 10 --limitcontextforgui --limitcontextforstrings --multipassfb --noarrayindex --noclonestatics --nofallback --nojsa --precision 4 --pta geo --typesforcontext'
