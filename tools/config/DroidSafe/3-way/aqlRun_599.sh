...
printf 'DSARGS ?= --apicalldepth 7 --filetransforms --ignoreexceptionflows --kobjsens 10 --limitcontextforstrings --nova --precision 5 --preciseinfoflow --pta geo --trackallflows --typesforcontext'
