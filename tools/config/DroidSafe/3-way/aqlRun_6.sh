...
printf 'DSARGS ?= --apicalldepth 1 --ignoreexceptionflows --ignorenocontextflows --implicitflow --imprecisestrings --kobjsens 2 --noarrayindex --noclinitcontext --noclonestatics --noscalaropts --precision 0 --preciseinfoflow --pta paddle --trackallflows'
