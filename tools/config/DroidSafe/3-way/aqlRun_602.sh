...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 7 --filetransforms --ignoreexceptionflows --ignorenocontextflows --kobjsens 20 --limitcontextforgui --noarrayindex --noclinitcontext --noclonestatics --noscalaropts --precision 2 --preciseinfoflow --pta spark --trackallflows'
