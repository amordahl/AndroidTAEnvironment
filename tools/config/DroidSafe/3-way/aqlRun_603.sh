...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 7 --ignorenocontextflows --kobjsens 20 --noarrayindex --noclinitcontext --nofallback --precision 3 --pta spark --trackallflows --transfertaintfield --typesforcontext'
