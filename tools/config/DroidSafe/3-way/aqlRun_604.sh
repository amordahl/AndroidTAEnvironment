...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 7 --implicitflow --kobjsens 20 --limitcontextforgui --noclinitcontext --noclonestatics --nofallback --precision 4 --pta geo --trackallflows --transfertaintfield --typesforcontext'
