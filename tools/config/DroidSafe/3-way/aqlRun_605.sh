...
printf 'DSARGS ?= --apicalldepth 7 --filetransforms --ignorenocontextflows --kobjsens 20 --limitcontextforgui --limitcontextforstrings --nofallback --noscalaropts --nova --precision 5 --preciseinfoflow --pta geo --trackallflows --transfertaintfield --typesforcontext'
