...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 7 --filetransforms --implicitflow --kobjsens 30 --limitcontextforcomplex --limitcontextforgui --multipassfb --noarrayindex --noclonestatics --nojsa --nova --precision 4 --pta geo --trackallflows --typesforcontext'
