...
printf 'DSARGS ?= --apicalldepth 7 --kobjsens 30 --limitcontextforcomplex --noarrayindex --noclonestatics --noscalaropts --precision 5 --pta geo --trackallflows --transfertaintfield'
