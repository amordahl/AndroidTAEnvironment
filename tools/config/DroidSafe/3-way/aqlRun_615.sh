...
printf 'DSARGS ?= --apicalldepth 7 --ignoreexceptionflows --ignorenocontextflows --implicitflow --imprecisestrings --kobjsens 40 --limitcontextforstrings --noclonestatics --nojsa --nova --precision 3 --pta paddle --trackallflows --transfertaintfield --typesforcontext'
