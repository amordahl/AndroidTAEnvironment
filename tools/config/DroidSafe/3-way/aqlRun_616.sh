...
printf 'DSARGS ?= --apicalldepth 7 --kobjsens 40 --limitcontextforcomplex --limitcontextforgui --multipassfb --noclinitcontext --precision 4 --preciseinfoflow --pta spark --trackallflows --transfertaintfield --typesforcontext'
