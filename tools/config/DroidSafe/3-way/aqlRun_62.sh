...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 1 --ignoreexceptionflows --kobjsens 20 --limitcontextforcomplex --limitcontextforstrings --noarrayindex --noclinitcontext --nojsa --noscalaropts --nova --precision 2 --pta geo --trackallflows --typesforcontext'
