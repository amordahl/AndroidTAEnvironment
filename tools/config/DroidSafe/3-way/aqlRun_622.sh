...
printf 'DSARGS ?= --apicalldepth 7 --filetransforms --ignorenocontextflows --implicitflow --kobjsens 50 --limitcontextforstrings --multipassfb --noclinitcontext --noclonestatics --nofallback --precision 4 --preciseinfoflow --pta spark --trackallflows --typesforcontext'
