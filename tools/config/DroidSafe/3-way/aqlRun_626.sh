...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 7 --filetransforms --ignoreexceptionflows --ignorenocontextflows --implicitflow --imprecisestrings --kobjsens 100 --limitcontextforstrings --multipassfb --noclinitcontext --nofallback --precision 2 --preciseinfoflow --pta spark'
