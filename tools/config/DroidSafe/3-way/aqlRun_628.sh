...
printf 'DSARGS ?= --apicalldepth 7 --ignoreexceptionflows --ignorenocontextflows --imprecisestrings --kobjsens 100 --limitcontextforcomplex --limitcontextforstrings --noarrayindex --noclinitcontext --nofallback --nojsa --noscalaropts --precision 4 --pta spark --trackallflows --typesforcontext'
