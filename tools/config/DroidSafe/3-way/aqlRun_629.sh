...
printf 'DSARGS ?= --apicalldepth 7 --imprecisestrings --kobjsens 100 --limitcontextforgui --limitcontextforstrings --multipassfb --noarrayindex --noclinitcontext --noclonestatics --noscalaropts --precision 5 --preciseinfoflow --pta paddle'
