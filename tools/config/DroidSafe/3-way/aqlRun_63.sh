...
printf 'DSARGS ?= --apicalldepth 1 --filetransforms --ignorenocontextflows --implicitflow --imprecisestrings --kobjsens 20 --limitcontextforgui --multipassfb --noclonestatics --nofallback --precision 3 --preciseinfoflow --pta spark --transfertaintfield'
