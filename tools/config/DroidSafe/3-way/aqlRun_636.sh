...
printf 'DSARGS ?= --apicalldepth 8 --filetransforms --ignoreexceptionflows --implicitflow --imprecisestrings --kobjsens 2 --limitcontextforcomplex --multipassfb --noclinitcontext --nojsa --precision 0 --pta spark --trackallflows --typesforcontext'
