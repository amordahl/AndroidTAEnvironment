...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 1 --filetransforms --ignoreexceptionflows --ignorenocontextflows --implicitflow --kobjsens 20 --limitcontextforcomplex --limitcontextforgui --noarrayindex --noclonestatics --nojsa --precision 4 --pta paddle --trackallflows --transfertaintfield'
