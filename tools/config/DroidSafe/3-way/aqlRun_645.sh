...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 8 --ignoreexceptionflows --implicitflow --kobjsens 3 --limitcontextforgui --multipassfb --noarrayindex --noclinitcontext --noclonestatics --nofallback --nojsa --noscalaropts --precision 3 --pta paddle --trackallflows --typesforcontext'
