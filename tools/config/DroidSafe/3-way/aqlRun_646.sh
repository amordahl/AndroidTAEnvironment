...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 8 --ignoreexceptionflows --ignorenocontextflows --implicitflow --kobjsens 3 --limitcontextforgui --limitcontextforstrings --noclinitcontext --noscalaropts --nova --precision 4 --preciseinfoflow --pta spark --typesforcontext'
