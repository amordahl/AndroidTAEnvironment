...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 8 --filetransforms --implicitflow --imprecisestrings --kobjsens 3 --multipassfb --noarrayindex --nojsa --nova --precision 5 --pta spark --transfertaintfield --typesforcontext'
