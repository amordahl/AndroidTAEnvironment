...
printf 'DSARGS ?= --apicalldepth 1 --filetransforms --imprecisestrings --kobjsens 20 --limitcontextforstrings --multipassfb --nofallback --noscalaropts --nova --precision 5 --preciseinfoflow --pta geo --typesforcontext'
