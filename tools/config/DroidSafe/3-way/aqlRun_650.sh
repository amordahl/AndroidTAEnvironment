...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 8 --ignorenocontextflows --implicitflow --imprecisestrings --kobjsens 4 --noclinitcontext --nojsa --nova --precision 2 --preciseinfoflow --pta spark --trackallflows'
