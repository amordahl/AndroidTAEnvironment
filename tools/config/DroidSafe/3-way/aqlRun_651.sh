...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 8 --filetransforms --ignoreexceptionflows --ignorenocontextflows --kobjsens 4 --limitcontextforcomplex --limitcontextforgui --noclinitcontext --precision 3 --pta spark'
