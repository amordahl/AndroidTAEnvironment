...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 8 --filetransforms --ignorenocontextflows --implicitflow --kobjsens 4 --limitcontextforcomplex --multipassfb --noarrayindex --noclonestatics --nofallback --nojsa --noscalaropts --precision 4 --pta spark --trackallflows --typesforcontext'
