...
printf 'DSARGS ?= --apicalldepth 8 --implicitflow --imprecisestrings --kobjsens 5 --limitcontextforcomplex --multipassfb --noclinitcontext --nofallback --precision 2 --pta spark --trackallflows'
