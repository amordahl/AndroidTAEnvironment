...
printf 'DSARGS ?= --apicalldepth 8 --filetransforms --implicitflow --kobjsens 5 --limitcontextforcomplex --noclinitcontext --nofallback --noscalaropts --nova --precision 3 --preciseinfoflow --pta spark --trackallflows'
