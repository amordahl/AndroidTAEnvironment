...
printf 'DSARGS ?= --apicalldepth 8 --ignorenocontextflows --imprecisestrings --kobjsens 5 --limitcontextforcomplex --limitcontextforstrings --noclonestatics --nojsa --noscalaropts --precision 4 --preciseinfoflow --pta spark --trackallflows --transfertaintfield --typesforcontext'
