...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 8 --filetransforms --ignorenocontextflows --kobjsens 5 --limitcontextforcomplex --limitcontextforgui --multipassfb --noarrayindex --nova --precision 5 --pta spark --trackallflows'
