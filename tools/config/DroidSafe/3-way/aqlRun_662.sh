...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 8 --filetransforms --implicitflow --kobjsens 6 --limitcontextforstrings --noclinitcontext --nofallback --nojsa --noscalaropts --precision 2 --preciseinfoflow --pta spark --typesforcontext'
