...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 8 --filetransforms --ignoreexceptionflows --implicitflow --kobjsens 6 --limitcontextforcomplex --limitcontextforgui --multipassfb --noclinitcontext --nofallback --noscalaropts --nova --precision 3 --preciseinfoflow --pta paddle'
