...
printf 'DSARGS ?= --apicalldepth 8 --filetransforms --implicitflow --kobjsens 6 --limitcontextforgui --multipassfb --noclonestatics --nojsa --precision 4 --pta spark --trackallflows --transfertaintfield --typesforcontext'
