...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 8 --kobjsens 6 --limitcontextforcomplex --limitcontextforgui --noclinitcontext --noclonestatics --noscalaropts --precision 5 --pta geo'
