...
printf 'DSARGS ?= --apicalldepth 8 --filetransforms --ignoreexceptionflows --imprecisestrings --kobjsens 7 --limitcontextforgui --noclonestatics --nofallback --nojsa --precision 2 --preciseinfoflow --pta spark --trackallflows --typesforcontext'
