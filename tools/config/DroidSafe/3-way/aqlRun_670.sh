...
printf 'DSARGS ?= --apicalldepth 8 --kobjsens 7 --limitcontextforstrings --multipassfb --noclinitcontext --nofallback --nojsa --nova --precision 4 --pta paddle --transfertaintfield'
