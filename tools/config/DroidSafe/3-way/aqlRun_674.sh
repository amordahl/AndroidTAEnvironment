...
printf 'DSARGS ?= --apicalldepth 8 --ignorenocontextflows --implicitflow --imprecisestrings --kobjsens 8 --limitcontextforcomplex --limitcontextforgui --multipassfb --noarrayindex --nojsa --noscalaropts --precision 2 --pta spark --transfertaintfield'
