...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 8 --ignorenocontextflows --implicitflow --imprecisestrings --kobjsens 8 --limitcontextforstrings --noclinitcontext --nofallback --nova --precision 3 --pta geo'
