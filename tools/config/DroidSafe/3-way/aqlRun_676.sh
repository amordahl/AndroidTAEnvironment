...
printf 'DSARGS ?= --apicalldepth 8 --ignoreexceptionflows --ignorenocontextflows --implicitflow --imprecisestrings --kobjsens 8 --limitcontextforcomplex --limitcontextforstrings --multipassfb --noclinitcontext --precision 4 --pta paddle --trackallflows --typesforcontext'
