...
printf 'DSARGS ?= --apicalldepth 8 --imprecisestrings --kobjsens 8 --limitcontextforgui --limitcontextforstrings --noclinitcontext --precision 5 --preciseinfoflow --pta geo --trackallflows --transfertaintfield'
