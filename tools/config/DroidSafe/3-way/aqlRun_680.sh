...
printf 'DSARGS ?= --apicalldepth 8 --filetransforms --imprecisestrings --kobjsens 9 --limitcontextforcomplex --limitcontextforgui --limitcontextforstrings --nofallback --noscalaropts --precision 2 --preciseinfoflow --pta spark'
