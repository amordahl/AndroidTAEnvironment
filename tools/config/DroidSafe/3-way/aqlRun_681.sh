...
printf 'DSARGS ?= --apicalldepth 8 --filetransforms --implicitflow --kobjsens 9 --limitcontextforstrings --multipassfb --nofallback --noscalaropts --precision 3 --preciseinfoflow --pta paddle --trackallflows --transfertaintfield'
