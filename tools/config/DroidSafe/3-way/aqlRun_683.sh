...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 8 --filetransforms --ignoreexceptionflows --ignorenocontextflows --kobjsens 9 --limitcontextforcomplex --limitcontextforgui --limitcontextforstrings --noarrayindex --noclonestatics --nofallback --nojsa --precision 5 --pta geo --typesforcontext'
