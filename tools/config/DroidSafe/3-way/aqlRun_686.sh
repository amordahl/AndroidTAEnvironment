...
printf 'DSARGS ?= --apicalldepth 8 --ignoreexceptionflows --implicitflow --kobjsens 10 --limitcontextforcomplex --limitcontextforgui --limitcontextforstrings --multipassfb --noclinitcontext --noscalaropts --precision 2 --preciseinfoflow --pta spark --typesforcontext'
