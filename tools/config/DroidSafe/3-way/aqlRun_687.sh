...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 8 --filetransforms --ignoreexceptionflows --kobjsens 10 --limitcontextforcomplex --limitcontextforstrings --noarrayindex --nofallback --nojsa --noscalaropts --nova --precision 3 --pta geo --typesforcontext'
