...
printf 'DSARGS ?= --apicalldepth 8 --ignorenocontextflows --imprecisestrings --kobjsens 10 --multipassfb --noarrayindex --precision 4 --preciseinfoflow --pta geo --typesforcontext'
