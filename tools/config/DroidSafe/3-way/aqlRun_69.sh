...
printf 'DSARGS ?= --apicalldepth 1 --ignorenocontextflows --implicitflow --imprecisestrings --kobjsens 30 --limitcontextforgui --multipassfb --noclinitcontext --noclonestatics --nofallback --precision 3 --pta spark --trackallflows --typesforcontext'
