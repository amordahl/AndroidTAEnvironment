...
printf 'DSARGS ?= --apicalldepth 8 --ignoreexceptionflows --ignorenocontextflows --implicitflow --imprecisestrings --kobjsens 20 --limitcontextforcomplex --limitcontextforgui --limitcontextforstrings --noarrayindex --nofallback --noscalaropts --nova --precision 4 --preciseinfoflow --pta paddle --transfertaintfield'
