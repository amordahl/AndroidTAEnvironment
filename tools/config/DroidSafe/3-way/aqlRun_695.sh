...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 8 --ignoreexceptionflows --kobjsens 20 --limitcontextforcomplex --noarrayindex --nofallback --precision 5 --preciseinfoflow --pta geo --trackallflows --typesforcontext'
