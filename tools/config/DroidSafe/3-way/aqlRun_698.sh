...
printf 'DSARGS ?= --apicalldepth 8 --filetransforms --imprecisestrings --kobjsens 30 --limitcontextforcomplex --limitcontextforgui --limitcontextforstrings --multipassfb --nofallback --nojsa --noscalaropts --precision 2 --pta spark'
