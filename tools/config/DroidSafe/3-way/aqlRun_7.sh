...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 1 --ignorenocontextflows --kobjsens 2 --limitcontextforcomplex --limitcontextforgui --limitcontextforstrings --multipassfb --noclinitcontext --nojsa --nova --precision 1 --pta spark --transfertaintfield --typesforcontext'
