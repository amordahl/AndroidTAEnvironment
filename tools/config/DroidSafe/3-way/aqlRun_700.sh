...
printf 'DSARGS ?= --apicalldepth 8 --filetransforms --kobjsens 30 --limitcontextforcomplex --limitcontextforgui --limitcontextforstrings --multipassfb --noarrayindex --nofallback --nojsa --nova --precision 4 --pta paddle --trackallflows'
