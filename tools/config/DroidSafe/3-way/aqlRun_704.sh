...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 8 --ignorenocontextflows --kobjsens 40 --limitcontextforstrings --noarrayindex --noclinitcontext --noclonestatics --noscalaropts --precision 2 --preciseinfoflow --pta spark'
