...
printf 'DSARGS ?= --apicalldepth 8 --ignorenocontextflows --imprecisestrings --kobjsens 40 --multipassfb --noarrayindex --noclinitcontext --noclonestatics --nova --precision 3 --preciseinfoflow --pta paddle --transfertaintfield'
