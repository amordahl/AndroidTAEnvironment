...
printf 'DSARGS ?= --apicalldepth 8 --filetransforms --ignoreexceptionflows --ignorenocontextflows --kobjsens 40 --limitcontextforcomplex --limitcontextforstrings --noclinitcontext --precision 4 --preciseinfoflow --pta paddle --trackallflows'
