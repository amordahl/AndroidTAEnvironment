...
printf 'DSARGS ?= --apicalldepth 1 --imprecisestrings --kobjsens 30 --limitcontextforstrings --multipassfb --nofallback --nova --precision 5 --pta geo --transfertaintfield --typesforcontext'
