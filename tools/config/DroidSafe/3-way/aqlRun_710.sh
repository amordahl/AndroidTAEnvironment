...
printf 'DSARGS ?= --apicalldepth 8 --filetransforms --ignorenocontextflows --implicitflow --kobjsens 50 --limitcontextforgui --multipassfb --nofallback --nojsa --noscalaropts --nova --precision 2 --preciseinfoflow --pta spark --trackallflows --typesforcontext'
