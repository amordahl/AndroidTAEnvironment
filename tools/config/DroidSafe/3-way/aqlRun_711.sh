...
printf 'DSARGS ?= --apicalldepth 8 --kobjsens 50 --limitcontextforcomplex --limitcontextforgui --multipassfb --noclinitcontext --noclonestatics --nofallback --nova --precision 3 --preciseinfoflow --pta paddle'
