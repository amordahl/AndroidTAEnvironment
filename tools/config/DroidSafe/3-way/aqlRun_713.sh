...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 8 --ignoreexceptionflows --ignorenocontextflows --implicitflow --imprecisestrings --kobjsens 50 --limitcontextforcomplex --multipassfb --noclonestatics --nofallback --nojsa --precision 5 --pta geo --trackallflows --transfertaintfield --typesforcontext'
