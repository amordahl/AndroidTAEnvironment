...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 8 --ignoreexceptionflows --kobjsens 100 --limitcontextforcomplex --limitcontextforgui --limitcontextforstrings --multipassfb --noscalaropts --precision 4 --pta spark'
