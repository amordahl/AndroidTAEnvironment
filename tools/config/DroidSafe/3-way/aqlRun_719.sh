...
printf 'DSARGS ?= --apicalldepth 8 --ignoreexceptionflows --implicitflow --imprecisestrings --kobjsens 100 --limitcontextforgui --multipassfb --noarrayindex --noclinitcontext --noclonestatics --nojsa --noscalaropts --precision 5 --pta geo --trackallflows --transfertaintfield'
