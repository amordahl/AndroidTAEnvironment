...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 9 --kobjsens 3 --limitcontextforgui --limitcontextforstrings --noarrayindex --noclonestatics --nofallback --noscalaropts --nova --precision 0 --preciseinfoflow --pta paddle --transfertaintfield'
