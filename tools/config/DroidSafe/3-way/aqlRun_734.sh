...
printf 'DSARGS ?= --apicalldepth 9 --ignoreexceptionflows --kobjsens 3 --limitcontextforcomplex --limitcontextforstrings --multipassfb --noclinitcontext --nofallback --precision 2 --preciseinfoflow --pta geo --trackallflows --typesforcontext'
