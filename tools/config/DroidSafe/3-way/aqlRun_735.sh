...
printf 'DSARGS ?= --apicalldepth 9 --ignoreexceptionflows --ignorenocontextflows --imprecisestrings --kobjsens 3 --limitcontextforcomplex --limitcontextforstrings --noarrayindex --noclinitcontext --noclonestatics --nofallback --nojsa --noscalaropts --nova --precision 3 --pta paddle --transfertaintfield'
