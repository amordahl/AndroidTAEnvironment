...
printf 'DSARGS ?= --apicalldepth 9 --kobjsens 3 --limitcontextforgui --limitcontextforstrings --noarrayindex --noclinitcontext --noclonestatics --nojsa --nova --precision 4 --preciseinfoflow --pta spark --trackallflows --transfertaintfield --typesforcontext'
