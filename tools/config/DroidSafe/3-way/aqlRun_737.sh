...
printf 'DSARGS ?= --apicalldepth 9 --ignoreexceptionflows --implicitflow --imprecisestrings --kobjsens 3 --limitcontextforcomplex --limitcontextforstrings --nojsa --noscalaropts --nova --precision 5 --preciseinfoflow --pta spark --transfertaintfield'
