...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 9 --ignorenocontextflows --implicitflow --kobjsens 4 --limitcontextforcomplex --noclinitcontext --noclonestatics --nova --precision 2 --pta spark --transfertaintfield'
