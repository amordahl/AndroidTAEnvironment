...
printf 'DSARGS ?= --apicalldepth 9 --ignoreexceptionflows --ignorenocontextflows --implicitflow --imprecisestrings --kobjsens 4 --limitcontextforgui --limitcontextforstrings --noclinitcontext --nojsa --nova --precision 4 --preciseinfoflow --pta paddle --trackallflows --typesforcontext'
