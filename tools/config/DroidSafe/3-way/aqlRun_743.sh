...
printf 'DSARGS ?= --apicalldepth 9 --filetransforms --ignoreexceptionflows --kobjsens 4 --limitcontextforcomplex --limitcontextforgui --limitcontextforstrings --multipassfb --noclinitcontext --noscalaropts --nova --precision 5 --pta geo --trackallflows --transfertaintfield'
