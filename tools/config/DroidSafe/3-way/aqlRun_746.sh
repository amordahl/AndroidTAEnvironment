...
printf 'DSARGS ?= --apicalldepth 9 --implicitflow --imprecisestrings --kobjsens 5 --limitcontextforcomplex --limitcontextforgui --nojsa --noscalaropts --precision 2 --preciseinfoflow --pta spark --trackallflows --typesforcontext'
