...
printf 'DSARGS ?= --apicalldepth 9 --ignoreexceptionflows --ignorenocontextflows --kobjsens 5 --limitcontextforgui --multipassfb --precision 4 --pta paddle --trackallflows --transfertaintfield --typesforcontext'
