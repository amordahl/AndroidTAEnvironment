...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 9 --filetransforms --ignoreexceptionflows --ignorenocontextflows --kobjsens 5 --limitcontextforgui --limitcontextforstrings --multipassfb --nofallback --nova --precision 5 --preciseinfoflow --pta paddle --trackallflows --typesforcontext'
