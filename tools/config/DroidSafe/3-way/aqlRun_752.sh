...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 9 --ignoreexceptionflows --implicitflow --imprecisestrings --kobjsens 6 --noarrayindex --nofallback --nojsa --noscalaropts --nova --precision 2 --preciseinfoflow --pta spark --trackallflows'
