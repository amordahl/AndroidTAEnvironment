...
printf 'DSARGS ?= --apicalldepth 9 --ignoreexceptionflows --ignorenocontextflows --kobjsens 6 --limitcontextforcomplex --multipassfb --noclinitcontext --nofallback --nojsa --nova --precision 3 --pta geo --trackallflows --typesforcontext'
