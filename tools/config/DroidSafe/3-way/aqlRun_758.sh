...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 9 --ignorenocontextflows --implicitflow --imprecisestrings --kobjsens 7 --limitcontextforcomplex --limitcontextforstrings --noarrayindex --noclinitcontext --noclonestatics --nofallback --nova --precision 2 --pta spark --trackallflows --transfertaintfield --typesforcontext'
