...
printf 'DSARGS ?= --apicalldepth 9 --filetransforms --ignoreexceptionflows --ignorenocontextflows --imprecisestrings --kobjsens 7 --limitcontextforcomplex --limitcontextforstrings --noclinitcontext --noclonestatics --nojsa --precision 4 --pta spark --trackallflows --typesforcontext'
