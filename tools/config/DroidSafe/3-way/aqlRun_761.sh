...
printf 'DSARGS ?= --apicalldepth 9 --ignoreexceptionflows --ignorenocontextflows --implicitflow --imprecisestrings --kobjsens 7 --limitcontextforcomplex --limitcontextforgui --multipassfb --noclinitcontext --noclonestatics --nojsa --precision 5 --preciseinfoflow --pta paddle --transfertaintfield --typesforcontext'
