...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 9 --filetransforms --imprecisestrings --kobjsens 8 --limitcontextforgui --noclinitcontext --noclonestatics --noscalaropts --nova --precision 2 --preciseinfoflow --pta spark --typesforcontext'
