...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 9 --ignoreexceptionflows --imprecisestrings --kobjsens 8 --limitcontextforgui --noarrayindex --noclinitcontext --nofallback --precision 4 --pta geo --trackallflows'
