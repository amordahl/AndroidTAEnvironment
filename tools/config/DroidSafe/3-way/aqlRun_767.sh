...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 9 --ignoreexceptionflows --kobjsens 8 --multipassfb --noarrayindex --noclonestatics --nojsa --nova --precision 5 --pta spark'
