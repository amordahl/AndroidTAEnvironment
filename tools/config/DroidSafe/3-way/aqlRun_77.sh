...
printf 'DSARGS ?= --apicalldepth 1 --filetransforms --imprecisestrings --kobjsens 40 --limitcontextforstrings --multipassfb --nofallback --nova --precision 5 --preciseinfoflow --pta geo --transfertaintfield --typesforcontext'
