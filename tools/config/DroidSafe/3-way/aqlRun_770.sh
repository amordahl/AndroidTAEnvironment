...
printf 'DSARGS ?= --apicalldepth 9 --filetransforms --ignoreexceptionflows --ignorenocontextflows --kobjsens 9 --limitcontextforstrings --multipassfb --noarrayindex --noclinitcontext --nofallback --precision 2 --pta spark --transfertaintfield --typesforcontext'
