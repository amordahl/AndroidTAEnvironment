...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 9 --ignoreexceptionflows --imprecisestrings --kobjsens 9 --limitcontextforcomplex --limitcontextforgui --noarrayindex --noclinitcontext --nojsa --nova --precision 3 --pta spark --transfertaintfield'
