...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 9 --ignoreexceptionflows --ignorenocontextflows --implicitflow --imprecisestrings --kobjsens 9 --multipassfb --noarrayindex --noscalaropts --nova --precision 5 --preciseinfoflow --pta paddle'
