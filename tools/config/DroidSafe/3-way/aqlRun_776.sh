...
printf 'DSARGS ?= --apicalldepth 9 --filetransforms --implicitflow --kobjsens 10 --limitcontextforcomplex --limitcontextforstrings --multipassfb --noclinitcontext --noclonestatics --nofallback --nojsa --nova --precision 2 --preciseinfoflow --pta spark'
