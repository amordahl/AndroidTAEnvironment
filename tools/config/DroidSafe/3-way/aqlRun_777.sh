...
printf 'DSARGS ?= --apicalldepth 9 --filetransforms --implicitflow --imprecisestrings --kobjsens 10 --limitcontextforcomplex --limitcontextforstrings --multipassfb --noarrayindex --noscalaropts --nova --precision 3 --pta geo --typesforcontext'
