...
printf 'DSARGS ?= --apicalldepth 9 --ignoreexceptionflows --implicitflow --imprecisestrings --kobjsens 10 --limitcontextforcomplex --limitcontextforstrings --noarrayindex --noscalaropts --nova --precision 4 --preciseinfoflow --pta geo --trackallflows'
