...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 9 --filetransforms --ignoreexceptionflows --implicitflow --imprecisestrings --kobjsens 10 --limitcontextforgui --limitcontextforstrings --noclinitcontext --nojsa --noscalaropts --nova --precision 5 --preciseinfoflow --pta spark --typesforcontext'
