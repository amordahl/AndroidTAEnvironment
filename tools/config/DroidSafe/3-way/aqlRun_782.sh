...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 9 --filetransforms --ignorenocontextflows --imprecisestrings --kobjsens 20 --limitcontextforcomplex --multipassfb --noclonestatics --precision 2 --preciseinfoflow --pta spark --trackallflows --typesforcontext'
