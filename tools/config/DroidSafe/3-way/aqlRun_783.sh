...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 9 --ignoreexceptionflows --implicitflow --kobjsens 20 --limitcontextforcomplex --limitcontextforgui --noarrayindex --nofallback --noscalaropts --precision 3 --preciseinfoflow --pta geo --transfertaintfield'
