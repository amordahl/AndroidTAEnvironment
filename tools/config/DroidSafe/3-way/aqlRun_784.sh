...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 9 --ignorenocontextflows --imprecisestrings --kobjsens 20 --limitcontextforgui --multipassfb --noarrayindex --nojsa --noscalaropts --nova --precision 4 --preciseinfoflow --pta paddle'
