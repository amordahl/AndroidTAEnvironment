...
printf 'DSARGS ?= --apicalldepth 9 --filetransforms --kobjsens 20 --limitcontextforcomplex --multipassfb --noclonestatics --nofallback --precision 5 --preciseinfoflow --pta paddle --typesforcontext'
