...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 9 --ignorenocontextflows --kobjsens 30 --limitcontextforcomplex --multipassfb --noarrayindex --noclinitcontext --nofallback --noscalaropts --precision 2 --preciseinfoflow --pta spark'
