...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 9 --filetransforms --ignorenocontextflows --implicitflow --imprecisestrings --kobjsens 30 --limitcontextforcomplex --limitcontextforgui --limitcontextforstrings --noscalaropts --precision 3 --preciseinfoflow --pta paddle --transfertaintfield --typesforcontext'
