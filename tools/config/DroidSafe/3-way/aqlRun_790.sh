...
printf 'DSARGS ?= --apicalldepth 9 --implicitflow --kobjsens 30 --limitcontextforstrings --multipassfb --noclinitcontext --nofallback --nojsa --noscalaropts --precision 4 --preciseinfoflow --pta spark'
