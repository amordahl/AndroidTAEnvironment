...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 9 --filetransforms --ignoreexceptionflows --imprecisestrings --kobjsens 30 --limitcontextforcomplex --limitcontextforstrings --multipassfb --noarrayindex --nofallback --nojsa --noscalaropts --nova --precision 5 --pta geo --typesforcontext'
