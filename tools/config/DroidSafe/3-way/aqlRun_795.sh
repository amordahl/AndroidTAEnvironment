...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 9 --ignoreexceptionflows --implicitflow --kobjsens 40 --limitcontextforcomplex --limitcontextforstrings --multipassfb --noarrayindex --noclonestatics --nojsa --precision 3 --pta paddle'
