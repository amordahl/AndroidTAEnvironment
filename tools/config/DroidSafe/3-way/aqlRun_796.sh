...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 9 --filetransforms --ignorenocontextflows --kobjsens 40 --limitcontextforcomplex --limitcontextforgui --multipassfb --nofallback --noscalaropts --nova --precision 4 --pta spark --typesforcontext'
