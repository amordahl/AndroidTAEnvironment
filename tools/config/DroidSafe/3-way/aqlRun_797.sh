...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 9 --ignorenocontextflows --implicitflow --kobjsens 40 --limitcontextforstrings --multipassfb --noclonestatics --nojsa --noscalaropts --precision 5 --preciseinfoflow --pta paddle --typesforcontext'
