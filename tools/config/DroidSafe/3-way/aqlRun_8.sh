...
printf 'DSARGS ?= --apicalldepth 1 --filetransforms --implicitflow --imprecisestrings --kobjsens 2 --limitcontextforcomplex --limitcontextforgui --multipassfb --noclinitcontext --noclonestatics --noscalaropts --nova --precision 2 --pta geo --trackallflows --transfertaintfield'
