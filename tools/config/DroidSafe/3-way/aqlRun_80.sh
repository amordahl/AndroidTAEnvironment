...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 1 --filetransforms --ignoreexceptionflows --kobjsens 50 --limitcontextforcomplex --limitcontextforstrings --noarrayindex --nojsa --nova --precision 2 --pta geo --trackallflows --typesforcontext'
