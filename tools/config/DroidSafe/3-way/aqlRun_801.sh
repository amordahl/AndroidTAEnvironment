...
printf 'DSARGS ?= --apicalldepth 9 --ignorenocontextflows --implicitflow --imprecisestrings --kobjsens 50 --limitcontextforcomplex --noclonestatics --noscalaropts --nova --precision 3 --preciseinfoflow --pta paddle --transfertaintfield'
