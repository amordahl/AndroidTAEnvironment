...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 9 --filetransforms --ignoreexceptionflows --ignorenocontextflows --imprecisestrings --kobjsens 50 --limitcontextforcomplex --limitcontextforstrings --noclinitcontext --noclonestatics --nofallback --nojsa --nova --precision 4 --preciseinfoflow --pta paddle --transfertaintfield'
