...
printf 'DSARGS ?= --apicalldepth 9 --ignoreexceptionflows --implicitflow --kobjsens 50 --limitcontextforcomplex --limitcontextforgui --limitcontextforstrings --noclinitcontext --noscalaropts --nova --precision 5 --preciseinfoflow --pta geo --trackallflows --transfertaintfield'
