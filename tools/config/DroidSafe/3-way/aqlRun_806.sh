...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 9 --ignorenocontextflows --implicitflow --kobjsens 100 --multipassfb --noclinitcontext --noscalaropts --precision 2 --pta spark --typesforcontext'
