...
printf 'DSARGS ?= --apicalldepth 9 --filetransforms --ignorenocontextflows --implicitflow --kobjsens 100 --limitcontextforcomplex --limitcontextforgui --multipassfb --noclonestatics --nofallback --precision 3 --preciseinfoflow --pta geo --transfertaintfield'
