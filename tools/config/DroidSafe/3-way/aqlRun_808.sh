...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 9 --ignorenocontextflows --implicitflow --kobjsens 100 --limitcontextforstrings --multipassfb --noarrayindex --nova --precision 4 --preciseinfoflow --pta spark --trackallflows --typesforcontext'
