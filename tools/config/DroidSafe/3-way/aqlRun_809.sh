...
printf 'DSARGS ?= --apicalldepth 9 --filetransforms --ignoreexceptionflows --imprecisestrings --kobjsens 100 --noclinitcontext --noclonestatics --nofallback --noscalaropts --nova --precision 5 --pta paddle --trackallflows --typesforcontext'
