...
printf 'DSARGS ?= --apicalldepth 1 --ignorenocontextflows --implicitflow --imprecisestrings --kobjsens 50 --limitcontextforgui --multipassfb --noclinitcontext --noclonestatics --nofallback --noscalaropts --precision 3 --preciseinfoflow --pta spark --transfertaintfield'
