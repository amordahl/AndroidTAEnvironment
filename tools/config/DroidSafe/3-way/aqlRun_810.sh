...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 10 --filetransforms --ignorenocontextflows --imprecisestrings --kobjsens 1 --limitcontextforcomplex --noarrayindex --noclonestatics --nojsa --precision 0 --preciseinfoflow --pta geo --transfertaintfield'
