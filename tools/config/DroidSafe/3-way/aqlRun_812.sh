...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 10 --kobjsens 1 --limitcontextforcomplex --limitcontextforgui --multipassfb --noarrayindex --noclinitcontext --noclonestatics --nofallback --nojsa --noscalaropts --precision 2 --pta spark'
