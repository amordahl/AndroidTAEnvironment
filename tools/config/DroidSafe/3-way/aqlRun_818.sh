...
printf 'DSARGS ?= --apicalldepth 10 --filetransforms --ignoreexceptionflows --ignorenocontextflows --imprecisestrings --kobjsens 2 --noarrayindex --noclonestatics --nojsa --noscalaropts --nova --precision 2 --preciseinfoflow --pta paddle --typesforcontext'
