...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 1 --ignoreexceptionflows --ignorenocontextflows --implicitflow --kobjsens 50 --limitcontextforcomplex --limitcontextforgui --noarrayindex --noclinitcontext --noclonestatics --nojsa --noscalaropts --precision 4 --pta paddle --trackallflows --transfertaintfield'
