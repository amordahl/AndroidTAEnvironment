...
printf 'DSARGS ?= --apicalldepth 10 --ignoreexceptionflows --ignorenocontextflows --implicitflow --kobjsens 3 --limitcontextforcomplex --limitcontextforgui --limitcontextforstrings --multipassfb --nofallback --precision 2 --preciseinfoflow --pta geo --trackallflows --transfertaintfield --typesforcontext'
