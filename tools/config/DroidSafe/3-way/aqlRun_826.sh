...
printf 'DSARGS ?= --apicalldepth 10 --ignorenocontextflows --kobjsens 3 --limitcontextforgui --limitcontextforstrings --noarrayindex --noclinitcontext --nova --precision 4 --preciseinfoflow --pta spark --typesforcontext'
