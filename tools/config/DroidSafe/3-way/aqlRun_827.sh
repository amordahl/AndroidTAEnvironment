...
printf 'DSARGS ?= --apicalldepth 10 --filetransforms --implicitflow --imprecisestrings --kobjsens 3 --limitcontextforcomplex --limitcontextforstrings --noarrayindex --nova --precision 5 --pta spark --transfertaintfield --typesforcontext'
