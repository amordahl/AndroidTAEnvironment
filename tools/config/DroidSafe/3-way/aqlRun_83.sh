...
printf 'DSARGS ?= --apicalldepth 1 --imprecisestrings --kobjsens 50 --limitcontextforstrings --multipassfb --nofallback --nova --precision 5 --preciseinfoflow --pta geo --typesforcontext'
