...
printf 'DSARGS ?= --apicalldepth 10 --ignoreexceptionflows --implicitflow --imprecisestrings --kobjsens 4 --limitcontextforcomplex --limitcontextforgui --multipassfb --nojsa --noscalaropts --nova --precision 2 --pta spark --transfertaintfield'
