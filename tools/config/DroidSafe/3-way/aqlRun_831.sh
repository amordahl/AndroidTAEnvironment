...
printf 'DSARGS ?= --apicalldepth 10 --filetransforms --implicitflow --imprecisestrings --kobjsens 4 --limitcontextforgui --limitcontextforstrings --multipassfb --noclinitcontext --nofallback --nova --precision 3 --pta geo --trackallflows'
