...
printf 'DSARGS ?= --apicalldepth 10 --filetransforms --ignorenocontextflows --implicitflow --kobjsens 4 --limitcontextforcomplex --limitcontextforgui --multipassfb --noarrayindex --nofallback --nojsa --precision 4 --preciseinfoflow --pta paddle --trackallflows'
