...
printf 'DSARGS ?= --apicalldepth 10 --filetransforms --ignorenocontextflows --kobjsens 4 --limitcontextforstrings --nofallback --noscalaropts --precision 5 --preciseinfoflow --pta geo --trackallflows --transfertaintfield --typesforcontext'
