...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 10 --filetransforms --kobjsens 5 --limitcontextforcomplex --limitcontextforgui --limitcontextforstrings --multipassfb --noarrayindex --noscalaropts --nova --precision 3 --pta geo --trackallflows --typesforcontext'
