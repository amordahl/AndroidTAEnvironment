...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 10 --ignorenocontextflows --implicitflow --imprecisestrings --kobjsens 5 --limitcontextforcomplex --multipassfb --noarrayindex --nofallback --precision 4 --preciseinfoflow --pta geo'
