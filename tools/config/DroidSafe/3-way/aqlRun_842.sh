...
printf 'DSARGS ?= --apicalldepth 10 --ignorenocontextflows --implicitflow --imprecisestrings --kobjsens 6 --limitcontextforcomplex --limitcontextforgui --limitcontextforstrings --multipassfb --noarrayindex --nojsa --noscalaropts --nova --precision 2 --pta spark --trackallflows --typesforcontext'
