...
printf 'DSARGS ?= --apicalldepth 10 --filetransforms --implicitflow --imprecisestrings --kobjsens 6 --limitcontextforcomplex --limitcontextforstrings --nofallback --nojsa --nova --precision 3 --pta spark --trackallflows'
