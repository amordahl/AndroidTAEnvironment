...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 10 --filetransforms --ignorenocontextflows --implicitflow --kobjsens 6 --limitcontextforcomplex --limitcontextforgui --noclinitcontext --nofallback --nova --precision 4 --preciseinfoflow --pta geo --trackallflows --typesforcontext'
