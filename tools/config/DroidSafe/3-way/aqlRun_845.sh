...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 10 --implicitflow --kobjsens 6 --limitcontextforgui --multipassfb --noclinitcontext --noscalaropts --nova --precision 5 --preciseinfoflow --pta geo --trackallflows --transfertaintfield'
