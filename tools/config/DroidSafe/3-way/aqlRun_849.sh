...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 10 --filetransforms --ignoreexceptionflows --ignorenocontextflows --kobjsens 7 --limitcontextforgui --multipassfb --noarrayindex --noclinitcontext --nojsa --noscalaropts --nova --precision 3 --pta spark --trackallflows --typesforcontext'
