...
printf 'DSARGS ?= --apicalldepth 10 --ignoreexceptionflows --ignorenocontextflows --imprecisestrings --kobjsens 7 --noarrayindex --noclonestatics --nofallback --noscalaropts --precision 4 --preciseinfoflow --pta geo --trackallflows'
