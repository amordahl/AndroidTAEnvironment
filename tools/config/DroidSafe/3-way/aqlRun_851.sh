...
printf 'DSARGS ?= --apicalldepth 10 --ignoreexceptionflows --ignorenocontextflows --implicitflow --imprecisestrings --kobjsens 7 --limitcontextforgui --limitcontextforstrings --multipassfb --noarrayindex --noclonestatics --nova --precision 5 --preciseinfoflow --pta spark --trackallflows'
