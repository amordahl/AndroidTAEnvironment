...
printf 'DSARGS ?= --apicalldepth 10 --filetransforms --ignoreexceptionflows --implicitflow --kobjsens 8 --limitcontextforcomplex --limitcontextforgui --multipassfb --noarrayindex --noclinitcontext --noscalaropts --nova --precision 2 --preciseinfoflow --pta spark --typesforcontext'
