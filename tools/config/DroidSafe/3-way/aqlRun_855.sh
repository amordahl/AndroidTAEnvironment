...
printf 'DSARGS ?= --apicalldepth 10 --ignoreexceptionflows --ignorenocontextflows --imprecisestrings --kobjsens 8 --limitcontextforstrings --noarrayindex --noclonestatics --nova --precision 3 --pta spark'
