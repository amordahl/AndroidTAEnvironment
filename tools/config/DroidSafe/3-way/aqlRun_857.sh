...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 10 --ignoreexceptionflows --imprecisestrings --kobjsens 8 --limitcontextforgui --multipassfb --noarrayindex --noclinitcontext --noclonestatics --nofallback --noscalaropts --nova --precision 5 --pta spark --trackallflows --transfertaintfield'
