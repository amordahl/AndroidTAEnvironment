...
printf 'DSARGS ?= --apicalldepth 10 --ignoreexceptionflows --ignorenocontextflows --kobjsens 9 --limitcontextforgui --limitcontextforstrings --multipassfb --noclinitcontext --nofallback --noscalaropts --nova --precision 1 --pta paddle --trackallflows --transfertaintfield'
