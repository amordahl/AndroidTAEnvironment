...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 1 --ignoreexceptionflows --kobjsens 100 --limitcontextforcomplex --limitcontextforstrings --noarrayindex --nojsa --nova --precision 2 --pta geo --trackallflows --typesforcontext'
