...
printf 'DSARGS ?= --apicalldepth 10 --filetransforms --ignorenocontextflows --implicitflow --kobjsens 9 --limitcontextforcomplex --limitcontextforstrings --multipassfb --noclinitcontext --noclonestatics --nofallback --nojsa --precision 3 --pta spark --typesforcontext'
