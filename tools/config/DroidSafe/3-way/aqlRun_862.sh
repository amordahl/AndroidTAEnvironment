...
printf 'DSARGS ?= --apicalldepth 10 --ignoreexceptionflows --implicitflow --imprecisestrings --kobjsens 9 --limitcontextforcomplex --multipassfb --noarrayindex --noclonestatics --precision 4 --preciseinfoflow --pta spark --typesforcontext'
