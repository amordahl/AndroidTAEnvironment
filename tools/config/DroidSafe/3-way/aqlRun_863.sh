...
printf 'DSARGS ?= --apicalldepth 10 --filetransforms --ignoreexceptionflows --imprecisestrings --kobjsens 9 --limitcontextforcomplex --limitcontextforstrings --multipassfb --noclinitcontext --noclonestatics --nojsa --noscalaropts --precision 5 --pta geo --trackallflows --transfertaintfield'
