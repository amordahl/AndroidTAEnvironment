...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 10 --filetransforms --ignoreexceptionflows --imprecisestrings --kobjsens 10 --limitcontextforstrings --multipassfb --noclinitcontext --nofallback --nojsa --noscalaropts --nova --precision 3 --pta spark --typesforcontext'
