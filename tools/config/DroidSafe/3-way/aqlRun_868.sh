...
printf 'DSARGS ?= --apicalldepth 10 --filetransforms --ignorenocontextflows --imprecisestrings --kobjsens 10 --limitcontextforgui --limitcontextforstrings --noarrayindex --noclonestatics --nojsa --noscalaropts --precision 4 --pta geo --transfertaintfield --typesforcontext'
