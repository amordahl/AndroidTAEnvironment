...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 10 --ignoreexceptionflows --imprecisestrings --kobjsens 10 --limitcontextforcomplex --limitcontextforgui --limitcontextforstrings --noscalaropts --precision 5 --pta paddle --transfertaintfield --typesforcontext'
