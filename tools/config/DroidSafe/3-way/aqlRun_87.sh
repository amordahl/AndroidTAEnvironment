...
printf 'DSARGS ?= --apicalldepth 1 --filetransforms --ignorenocontextflows --implicitflow --imprecisestrings --kobjsens 100 --limitcontextforgui --multipassfb --noclinitcontext --noclonestatics --nofallback --noscalaropts --precision 3 --preciseinfoflow --pta spark --transfertaintfield'
