...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 10 --filetransforms --ignorenocontextflows --imprecisestrings --kobjsens 20 --limitcontextforcomplex --multipassfb --noarrayindex --noclinitcontext --noclonestatics --nojsa --precision 3 --preciseinfoflow --pta geo --trackallflows --transfertaintfield'
