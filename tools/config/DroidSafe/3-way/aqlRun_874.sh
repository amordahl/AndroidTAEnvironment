...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 10 --implicitflow --kobjsens 20 --limitcontextforcomplex --limitcontextforgui --limitcontextforstrings --multipassfb --noclonestatics --nofallback --noscalaropts --precision 4 --preciseinfoflow --pta paddle --trackallflows'
