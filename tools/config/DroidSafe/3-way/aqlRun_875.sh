...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 10 --filetransforms --ignoreexceptionflows --imprecisestrings --kobjsens 20 --limitcontextforcomplex --noclinitcontext --noclonestatics --nofallback --nova --precision 5 --pta paddle --transfertaintfield --typesforcontext'
