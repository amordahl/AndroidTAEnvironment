...
printf 'DSARGS ?= --apicalldepth 10 --filetransforms --ignorenocontextflows --implicitflow --imprecisestrings --kobjsens 30 --limitcontextforcomplex --nofallback --nojsa --precision 3 --pta spark --trackallflows'
