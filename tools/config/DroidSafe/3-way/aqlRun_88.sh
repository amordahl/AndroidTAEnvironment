...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 1 --filetransforms --ignoreexceptionflows --ignorenocontextflows --implicitflow --kobjsens 100 --limitcontextforcomplex --limitcontextforgui --noarrayindex --noclinitcontext --noclonestatics --nojsa --noscalaropts --precision 4 --pta paddle --trackallflows --transfertaintfield'
