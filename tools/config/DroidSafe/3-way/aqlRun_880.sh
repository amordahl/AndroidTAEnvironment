...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 10 --filetransforms --imprecisestrings --kobjsens 30 --limitcontextforcomplex --multipassfb --nojsa --noscalaropts --nova --precision 4 --pta geo --transfertaintfield --typesforcontext'
