...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 10 --ignoreexceptionflows --ignorenocontextflows --implicitflow --imprecisestrings --kobjsens 30 --limitcontextforstrings --noclinitcontext --nofallback --noscalaropts --nova --precision 5 --preciseinfoflow --pta paddle'
