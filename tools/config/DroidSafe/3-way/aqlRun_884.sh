...
printf 'DSARGS ?= --apicalldepth 10 --filetransforms --ignorenocontextflows --imprecisestrings --kobjsens 40 --limitcontextforcomplex --limitcontextforgui --noarrayindex --noclinitcontext --noclonestatics --nojsa --precision 2 --preciseinfoflow --pta spark --transfertaintfield --typesforcontext'
