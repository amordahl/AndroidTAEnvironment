...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 10 --filetransforms --ignorenocontextflows --imprecisestrings --kobjsens 40 --limitcontextforgui --multipassfb --noclinitcontext --noclonestatics --noscalaropts --nova --precision 3 --preciseinfoflow --pta geo --trackallflows --transfertaintfield --typesforcontext'
