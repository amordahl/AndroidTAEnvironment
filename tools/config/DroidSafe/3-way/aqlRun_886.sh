...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 10 --implicitflow --imprecisestrings --kobjsens 40 --multipassfb --nojsa --precision 4 --preciseinfoflow --pta paddle --trackallflows'
