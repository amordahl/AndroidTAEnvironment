...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 10 --ignoreexceptionflows --implicitflow --kobjsens 40 --limitcontextforgui --multipassfb --nofallback --nojsa --noscalaropts --nova --precision 5 --pta geo --trackallflows --transfertaintfield'
