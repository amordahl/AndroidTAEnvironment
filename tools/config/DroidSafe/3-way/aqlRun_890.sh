...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 10 --filetransforms --kobjsens 50 --limitcontextforcomplex --limitcontextforgui --noarrayindex --noclinitcontext --noclonestatics --precision 2 --preciseinfoflow --pta spark --typesforcontext'
