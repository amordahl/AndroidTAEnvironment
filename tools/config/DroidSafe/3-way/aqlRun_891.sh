...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 10 --filetransforms --ignoreexceptionflows --ignorenocontextflows --implicitflow --imprecisestrings --kobjsens 50 --limitcontextforgui --limitcontextforstrings --nofallback --nojsa --noscalaropts --precision 3 --pta geo'
