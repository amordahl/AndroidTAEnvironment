...
printf 'DSARGS ?= --apicalldepth 10 --filetransforms --ignoreexceptionflows --ignorenocontextflows --imprecisestrings --kobjsens 50 --limitcontextforcomplex --limitcontextforgui --multipassfb --noarrayindex --noclinitcontext --nojsa --nova --precision 4 --pta paddle --transfertaintfield'
