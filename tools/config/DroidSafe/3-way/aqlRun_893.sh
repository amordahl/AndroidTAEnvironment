...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 10 --implicitflow --kobjsens 50 --limitcontextforgui --multipassfb --nojsa --noscalaropts --nova --precision 5 --preciseinfoflow --pta geo --trackallflows --transfertaintfield'
