...
printf 'DSARGS ?= --apicalldepth 10 --ignorenocontextflows --imprecisestrings --kobjsens 100 --limitcontextforcomplex --limitcontextforgui --limitcontextforstrings --noarrayindex --noclonestatics --nofallback --nojsa --nova --precision 3 --preciseinfoflow --pta geo'
