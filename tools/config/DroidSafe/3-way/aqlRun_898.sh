...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 10 --ignoreexceptionflows --ignorenocontextflows --kobjsens 100 --limitcontextforgui --noscalaropts --precision 4 --preciseinfoflow --pta spark --trackallflows --transfertaintfield --typesforcontext'
