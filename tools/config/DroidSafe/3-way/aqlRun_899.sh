...
printf 'DSARGS ?= --apicalldepth 10 --filetransforms --ignoreexceptionflows --ignorenocontextflows --kobjsens 100 --limitcontextforcomplex --noclinitcontext --nojsa --precision 5 --preciseinfoflow --pta spark --trackallflows --transfertaintfield --typesforcontext'
