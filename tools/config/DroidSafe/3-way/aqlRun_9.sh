...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 1 --ignoreexceptionflows --imprecisestrings --kobjsens 2 --limitcontextforcomplex --limitcontextforgui --limitcontextforstrings --noarrayindex --nofallback --precision 3 --preciseinfoflow --pta paddle --transfertaintfield --typesforcontext'
