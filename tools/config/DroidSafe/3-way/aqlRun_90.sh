...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 2 --ignorenocontextflows --kobjsens 1 --limitcontextforcomplex --limitcontextforgui --limitcontextforstrings --multipassfb --noclinitcontext --nojsa --noscalaropts --nova --precision 0 --pta paddle'
