...
printf 'DSARGS ?= --apicalldepth 20 --ignoreexceptionflows --ignorenocontextflows --kobjsens 1 --limitcontextforgui --limitcontextforstrings --multipassfb --noclinitcontext --nofallback --noscalaropts --nova --precision 1 --pta paddle --trackallflows --transfertaintfield'
