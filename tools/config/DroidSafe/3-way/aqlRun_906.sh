...
printf 'DSARGS ?= --apicalldepth 20 --filetransforms --ignoreexceptionflows --ignorenocontextflows --imprecisestrings --kobjsens 2 --limitcontextforcomplex --multipassfb --noclinitcontext --nojsa --precision 0 --pta spark --trackallflows --transfertaintfield'
