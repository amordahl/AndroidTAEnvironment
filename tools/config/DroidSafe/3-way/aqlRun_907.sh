...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 20 --implicitflow --kobjsens 2 --limitcontextforgui --limitcontextforstrings --noarrayindex --noclonestatics --nofallback --noscalaropts --nova --precision 1 --preciseinfoflow --pta geo --typesforcontext'
