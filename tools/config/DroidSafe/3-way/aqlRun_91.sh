...
printf 'DSARGS ?= --apicalldepth 2 --filetransforms --ignoreexceptionflows --implicitflow --imprecisestrings --kobjsens 1 --noarrayindex --noclinitcontext --noclonestatics --nofallback --precision 1 --preciseinfoflow --pta spark --trackallflows --transfertaintfield --typesforcontext'
