...
printf 'DSARGS ?= --apicalldepth 20 --ignoreexceptionflows --ignorenocontextflows --implicitflow --imprecisestrings --kobjsens 2 --noclinitcontext --noclonestatics --nofallback --noscalaropts --precision 4 --pta geo --trackallflows --typesforcontext'
