...
printf 'DSARGS ?= --apicalldepth 20 --ignoreexceptionflows --ignorenocontextflows --imprecisestrings --kobjsens 3 --limitcontextforstrings --multipassfb --nova --precision 2 --preciseinfoflow --pta geo --trackallflows'
