...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 20 --imprecisestrings --kobjsens 3 --limitcontextforgui --limitcontextforstrings --noclonestatics --nojsa --nova --precision 4 --preciseinfoflow --pta spark --trackallflows --transfertaintfield --typesforcontext'
