...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 20 --filetransforms --ignoreexceptionflows --implicitflow --kobjsens 3 --limitcontextforcomplex --nofallback --noscalaropts --nova --precision 5 --pta spark'
