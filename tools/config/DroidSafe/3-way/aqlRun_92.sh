...
printf 'DSARGS ?= --apicalldepth 2 --ignorenocontextflows --implicitflow --imprecisestrings --kobjsens 1 --limitcontextforgui --limitcontextforstrings --multipassfb --noarrayindex --nofallback --nova --precision 2 --preciseinfoflow --pta geo --transfertaintfield'
