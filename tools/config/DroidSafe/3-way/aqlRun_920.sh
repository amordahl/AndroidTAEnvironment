...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 20 --implicitflow --kobjsens 4 --noclinitcontext --nofallback --precision 2 --preciseinfoflow --pta spark --trackallflows'
