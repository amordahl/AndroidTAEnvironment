...
printf 'DSARGS ?= --apicalldepth 20 --filetransforms --ignoreexceptionflows --implicitflow --kobjsens 4 --limitcontextforstrings --noscalaropts --nova --precision 3 --pta geo --transfertaintfield'
