...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 20 --filetransforms --ignoreexceptionflows --ignorenocontextflows --imprecisestrings --kobjsens 4 --limitcontextforcomplex --noarrayindex --noclinitcontext --noclonestatics --noscalaropts --nova --precision 4 --preciseinfoflow --pta geo --transfertaintfield'
