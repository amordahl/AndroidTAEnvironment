...
printf 'DSARGS ?= --apicalldepth 20 --filetransforms --ignorenocontextflows --kobjsens 4 --limitcontextforgui --multipassfb --noarrayindex --noclinitcontext --noclonestatics --noscalaropts --precision 5 --pta spark --trackallflows'
