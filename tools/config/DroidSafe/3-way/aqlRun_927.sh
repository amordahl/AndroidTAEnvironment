...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 20 --filetransforms --ignoreexceptionflows --ignorenocontextflows --implicitflow --imprecisestrings --kobjsens 5 --limitcontextforcomplex --noclinitcontext --noclonestatics --nojsa --nova --precision 3 --pta paddle --trackallflows'
