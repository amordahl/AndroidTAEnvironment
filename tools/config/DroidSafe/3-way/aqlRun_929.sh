...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 20 --filetransforms --imprecisestrings --kobjsens 5 --noarrayindex --noclinitcontext --noclonestatics --nojsa --noscalaropts --nova --precision 5 --preciseinfoflow --pta geo --trackallflows --typesforcontext'
