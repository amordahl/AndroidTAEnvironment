...
printf 'DSARGS ?= --apicalldepth 2 --filetransforms --ignoreexceptionflows --ignorenocontextflows --kobjsens 1 --limitcontextforcomplex --noclonestatics --nojsa --noscalaropts --precision 3 --pta paddle --trackallflows --typesforcontext'
