...
printf 'DSARGS ?= --apicalldepth 20 --ignorenocontextflows --implicitflow --imprecisestrings --kobjsens 6 --multipassfb --noarrayindex --nofallback --nojsa --noscalaropts --nova --precision 3 --preciseinfoflow --pta paddle'
