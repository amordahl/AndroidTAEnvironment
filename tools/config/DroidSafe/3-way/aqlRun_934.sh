...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 20 --ignoreexceptionflows --implicitflow --kobjsens 6 --limitcontextforstrings --noarrayindex --nofallback --nojsa --nova --precision 4 --preciseinfoflow --pta geo --trackallflows'
