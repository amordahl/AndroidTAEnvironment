...
printf 'DSARGS ?= --apicalldepth 20 --filetransforms --implicitflow --kobjsens 6 --limitcontextforcomplex --limitcontextforstrings --noclinitcontext --nofallback --noscalaropts --precision 5 --pta paddle --trackallflows'
