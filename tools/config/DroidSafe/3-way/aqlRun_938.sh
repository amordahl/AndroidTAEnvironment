...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 20 --ignorenocontextflows --kobjsens 7 --limitcontextforcomplex --noclonestatics --nofallback --noscalaropts --nova --precision 2 --pta spark'
