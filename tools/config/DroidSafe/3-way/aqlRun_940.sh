...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 20 --ignorenocontextflows --implicitflow --kobjsens 7 --limitcontextforcomplex --limitcontextforgui --multipassfb --nofallback --nojsa --nova --precision 4 --preciseinfoflow --pta geo'
