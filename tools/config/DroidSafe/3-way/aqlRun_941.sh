...
printf 'DSARGS ?= --apicalldepth 20 --filetransforms --ignoreexceptionflows --ignorenocontextflows --implicitflow --kobjsens 7 --limitcontextforcomplex --limitcontextforgui --limitcontextforstrings --noarrayindex --noscalaropts --nova --precision 5 --pta geo --typesforcontext'
