...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 20 --ignoreexceptionflows --ignorenocontextflows --kobjsens 8 --limitcontextforcomplex --limitcontextforgui --multipassfb --noclinitcontext --noclonestatics --noscalaropts --precision 3 --preciseinfoflow --pta spark --transfertaintfield --typesforcontext'
