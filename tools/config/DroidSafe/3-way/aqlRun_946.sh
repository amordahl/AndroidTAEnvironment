...
printf 'DSARGS ?= --apicalldepth 20 --ignoreexceptionflows --ignorenocontextflows --implicitflow --imprecisestrings --kobjsens 8 --limitcontextforcomplex --limitcontextforgui --noarrayindex --noclinitcontext --nojsa --nova --precision 4 --pta geo'
