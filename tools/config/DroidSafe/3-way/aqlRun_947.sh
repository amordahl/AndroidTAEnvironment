...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 20 --ignorenocontextflows --kobjsens 8 --limitcontextforcomplex --limitcontextforstrings --multipassfb --noclonestatics --nojsa --nova --precision 5 --preciseinfoflow --pta geo'
