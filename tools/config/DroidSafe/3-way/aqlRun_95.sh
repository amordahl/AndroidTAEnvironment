...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 2 --kobjsens 1 --limitcontextforstrings --multipassfb --noclinitcontext --noclonestatics --nofallback --nojsa --precision 5 --pta spark'
