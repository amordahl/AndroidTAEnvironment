...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 20 --ignoreexceptionflows --ignorenocontextflows --implicitflow --kobjsens 9 --limitcontextforstrings --noarrayindex --nofallback --nojsa --noscalaropts --precision 2 --preciseinfoflow --pta spark --trackallflows --typesforcontext'
