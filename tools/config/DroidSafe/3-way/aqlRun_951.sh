...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 20 --filetransforms --implicitflow --imprecisestrings --kobjsens 9 --limitcontextforcomplex --limitcontextforgui --limitcontextforstrings --noarrayindex --noclinitcontext --noclonestatics --nofallback --nojsa --precision 3 --pta spark --trackallflows --typesforcontext'
