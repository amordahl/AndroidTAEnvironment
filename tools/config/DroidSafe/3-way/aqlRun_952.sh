...
printf 'DSARGS ?= --apicalldepth 20 --filetransforms --ignoreexceptionflows --implicitflow --imprecisestrings --kobjsens 9 --limitcontextforcomplex --limitcontextforgui --multipassfb --noarrayindex --noclonestatics --noscalaropts --precision 4 --preciseinfoflow --pta paddle --trackallflows --transfertaintfield --typesforcontext'
