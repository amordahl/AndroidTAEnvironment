...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 20 --implicitflow --kobjsens 9 --limitcontextforcomplex --limitcontextforgui --limitcontextforstrings --multipassfb --noarrayindex --noclonestatics --noscalaropts --nova --precision 5 --pta spark'
