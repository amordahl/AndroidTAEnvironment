...
printf 'DSARGS ?= --apicalldepth 20 --imprecisestrings --kobjsens 10 --limitcontextforgui --multipassfb --noclinitcontext --nofallback --noscalaropts --precision 2 --pta spark'
