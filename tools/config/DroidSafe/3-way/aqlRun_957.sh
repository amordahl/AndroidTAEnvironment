...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 20 --ignoreexceptionflows --imprecisestrings --kobjsens 10 --limitcontextforcomplex --limitcontextforgui --limitcontextforstrings --noarrayindex --noclonestatics --nofallback --nojsa --noscalaropts --precision 3 --preciseinfoflow --pta geo --transfertaintfield --typesforcontext'
