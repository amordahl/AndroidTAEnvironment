...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 20 --filetransforms --ignoreexceptionflows --ignorenocontextflows --implicitflow --imprecisestrings --kobjsens 10 --limitcontextforgui --multipassfb --noarrayindex --noclinitcontext --nojsa --nova --precision 4 --pta geo --trackallflows --typesforcontext'
