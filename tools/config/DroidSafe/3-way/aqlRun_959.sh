...
printf 'DSARGS ?= --apicalldepth 20 --filetransforms --ignoreexceptionflows --ignorenocontextflows --implicitflow --imprecisestrings --kobjsens 10 --limitcontextforcomplex --limitcontextforstrings --multipassfb --noclinitcontext --nofallback --nojsa --noscalaropts --precision 5 --preciseinfoflow --pta spark --transfertaintfield --typesforcontext'
