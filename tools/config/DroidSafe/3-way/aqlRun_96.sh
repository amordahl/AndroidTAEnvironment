...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 2 --filetransforms --ignoreexceptionflows --kobjsens 2 --limitcontextforcomplex --limitcontextforgui --limitcontextforstrings --noarrayindex --noclonestatics --nofallback --nojsa --noscalaropts --nova --precision 0 --pta geo --typesforcontext'
