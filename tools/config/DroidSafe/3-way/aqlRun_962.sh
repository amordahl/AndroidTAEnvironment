...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 20 --filetransforms --ignoreexceptionflows --ignorenocontextflows --kobjsens 20 --limitcontextforcomplex --limitcontextforstrings --noclinitcontext --noscalaropts --nova --precision 2 --pta spark --trackallflows'
