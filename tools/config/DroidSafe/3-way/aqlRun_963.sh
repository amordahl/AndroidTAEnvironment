...
printf 'DSARGS ?= --apicalldepth 20 --ignorenocontextflows --implicitflow --kobjsens 20 --limitcontextforcomplex --limitcontextforgui --noclinitcontext --noclonestatics --nojsa --nova --precision 3 --pta spark --trackallflows --transfertaintfield --typesforcontext'
