...
printf 'DSARGS ?= --apicalldepth 20 --ignorenocontextflows --imprecisestrings --kobjsens 20 --limitcontextforgui --multipassfb --noclinitcontext --nofallback --noscalaropts --precision 4 --preciseinfoflow --pta spark --typesforcontext'
