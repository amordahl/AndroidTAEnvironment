...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 20 --imprecisestrings --kobjsens 20 --limitcontextforcomplex --limitcontextforgui --limitcontextforstrings --multipassfb --nofallback --nojsa --noscalaropts --nova --precision 5 --pta geo --typesforcontext'
