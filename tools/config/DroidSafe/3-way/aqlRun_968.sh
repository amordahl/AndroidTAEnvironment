...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 20 --kobjsens 30 --limitcontextforgui --multipassfb --noarrayindex --nova --precision 2 --preciseinfoflow --pta spark --transfertaintfield'
