...
printf 'DSARGS ?= --apicalldepth 20 --filetransforms --ignorenocontextflows --implicitflow --kobjsens 30 --limitcontextforcomplex --limitcontextforstrings --noclonestatics --nofallback --nojsa --noscalaropts --nova --precision 3 --preciseinfoflow --pta spark'
