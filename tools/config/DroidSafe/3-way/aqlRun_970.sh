...
printf 'DSARGS ?= --apicalldepth 20 --ignoreexceptionflows --implicitflow --kobjsens 30 --limitcontextforgui --limitcontextforstrings --multipassfb --noclonestatics --noscalaropts --nova --precision 4 --pta geo --transfertaintfield --typesforcontext'
