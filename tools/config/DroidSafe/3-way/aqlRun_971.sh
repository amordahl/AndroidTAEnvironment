...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 20 --ignorenocontextflows --kobjsens 30 --limitcontextforgui --noclinitcontext --precision 5 --preciseinfoflow --pta geo --transfertaintfield'
