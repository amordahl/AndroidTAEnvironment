...
printf 'DSARGS ?= --apicalldepth 20 --ignoreexceptionflows --ignorenocontextflows --imprecisestrings --kobjsens 40 --limitcontextforgui --limitcontextforstrings --multipassfb --noclonestatics --nojsa --precision 3 --pta geo --trackallflows'
