...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 20 --ignoreexceptionflows --ignorenocontextflows --implicitflow --kobjsens 40 --limitcontextforcomplex --limitcontextforgui --multipassfb --noclonestatics --noscalaropts --nova --precision 4 --preciseinfoflow --pta spark --trackallflows --transfertaintfield --typesforcontext'
