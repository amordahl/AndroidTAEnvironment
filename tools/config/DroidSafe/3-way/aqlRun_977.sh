...
printf 'DSARGS ?= --apicalldepth 20 --ignoreexceptionflows --imprecisestrings --kobjsens 40 --multipassfb --noclinitcontext --noclonestatics --nojsa --nova --precision 5 --preciseinfoflow --pta spark --trackallflows --transfertaintfield --typesforcontext'
