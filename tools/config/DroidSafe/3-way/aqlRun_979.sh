...
printf 'DSARGS ?= --apicalldepth 20 --ignoreexceptionflows --implicitflow --kobjsens 50 --limitcontextforgui --limitcontextforstrings --multipassfb --noclinitcontext --nofallback --noscalaropts --nova --precision 1 --pta paddle --trackallflows --typesforcontext'
