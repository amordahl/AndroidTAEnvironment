...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 2 --filetransforms --ignoreexceptionflows --ignorenocontextflows --kobjsens 2 --limitcontextforcomplex --limitcontextforstrings --multipassfb --noclinitcontext --precision 2 --preciseinfoflow --pta spark --trackallflows --transfertaintfield'
