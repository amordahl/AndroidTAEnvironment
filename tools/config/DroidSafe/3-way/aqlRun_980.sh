...
printf 'DSARGS ?= --apicalldepth 20 --ignoreexceptionflows --implicitflow --kobjsens 50 --noarrayindex --noclinitcontext --noclonestatics --nofallback --noscalaropts --nova --precision 2 --preciseinfoflow --pta spark --trackallflows --transfertaintfield'
