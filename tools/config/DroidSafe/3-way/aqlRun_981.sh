...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 20 --ignoreexceptionflows --ignorenocontextflows --imprecisestrings --kobjsens 50 --limitcontextforcomplex --limitcontextforstrings --noarrayindex --noclinitcontext --noclonestatics --nojsa --nova --precision 3 --preciseinfoflow --pta paddle --trackallflows --typesforcontext'
