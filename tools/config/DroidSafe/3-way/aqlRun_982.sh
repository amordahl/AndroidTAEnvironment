...
printf 'DSARGS ?= --apicalldepth 20 --filetransforms --ignorenocontextflows --kobjsens 50 --limitcontextforcomplex --limitcontextforgui --limitcontextforstrings --noclinitcontext --nojsa --nova --precision 4 --preciseinfoflow --pta paddle --transfertaintfield --typesforcontext'
