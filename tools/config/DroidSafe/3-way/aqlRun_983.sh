...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 20 --filetransforms --ignoreexceptionflows --imprecisestrings --kobjsens 50 --limitcontextforcomplex --noarrayindex --noclinitcontext --noclonestatics --nojsa --noscalaropts --nova --precision 5 --pta spark --trackallflows'
