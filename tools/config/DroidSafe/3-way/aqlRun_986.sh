...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 20 --ignoreexceptionflows --implicitflow --kobjsens 100 --limitcontextforcomplex --multipassfb --noclinitcontext --nojsa --nova --precision 2 --pta spark --transfertaintfield --typesforcontext'
