...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 20 --ignorenocontextflows --implicitflow --imprecisestrings --kobjsens 100 --limitcontextforcomplex --limitcontextforgui --multipassfb --noclinitcontext --nofallback --nojsa --nova --precision 3 --pta spark --trackallflows --typesforcontext'
