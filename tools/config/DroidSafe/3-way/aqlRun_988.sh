...
printf 'DSARGS ?= --apicalldepth 20 --filetransforms --ignoreexceptionflows --ignorenocontextflows --implicitflow --kobjsens 100 --limitcontextforcomplex --limitcontextforstrings --noarrayindex --noclonestatics --noscalaropts --nova --precision 4 --pta spark'
