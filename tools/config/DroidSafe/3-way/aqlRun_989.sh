...
printf 'DSARGS ?= --apicalldepth 20 --ignoreexceptionflows --ignorenocontextflows --implicitflow --kobjsens 100 --limitcontextforstrings --noclinitcontext --nofallback --nojsa --noscalaropts --nova --precision 5 --preciseinfoflow --pta spark --trackallflows --transfertaintfield'
