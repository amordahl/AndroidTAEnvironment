...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 2 --filetransforms --implicitflow --kobjsens 2 --multipassfb --noclinitcontext --nova --precision 3 --pta geo --typesforcontext'
