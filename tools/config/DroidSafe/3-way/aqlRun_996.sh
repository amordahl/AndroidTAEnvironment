...
printf 'DSARGS ?= --apicalldepth 30 --filetransforms --ignoreexceptionflows --implicitflow --imprecisestrings --kobjsens 2 --limitcontextforcomplex --multipassfb --noclinitcontext --nojsa --precision 0 --pta spark --trackallflows --typesforcontext'
