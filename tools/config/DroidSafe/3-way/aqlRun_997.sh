...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 30 --ignorenocontextflows --kobjsens 2 --limitcontextforgui --limitcontextforstrings --noarrayindex --noclonestatics --nofallback --noscalaropts --nova --precision 1 --preciseinfoflow --pta geo --transfertaintfield'
