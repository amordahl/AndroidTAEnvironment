...
printf 'DSARGS ?= --analyzestrings_unfiltered --apicalldepth 30 --kobjsens 2 --limitcontextforcomplex --limitcontextforgui --multipassfb --precision 3 --preciseinfoflow --pta spark --transfertaintfield'
